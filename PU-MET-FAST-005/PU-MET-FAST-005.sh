#!/bin/bash
# Job name:
#SBATCH --job-name=PU-MET-FAST-005
#
#SBATCH --output=outputPU-MET-FAST-005
#
#SBATCH --error=ERRORS
#
# Account:
...
cd /global/home/users/christforsyth/ML_neutronics/PU-MET-FAST-005
sss2 PU-MET-FAST-005 -omp 20