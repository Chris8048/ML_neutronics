PU-SOL-THERM-018.7, rev0, 9/30/2006, 42.9w% 240Pu, 56.34 g Pu/l
c
c  The benchmark keff is 1.0000 for all cases.
c  The benchmark keff uncertainty varies from +/-0.0030 to +/-0.0034.
c
c  Note:  The model used for endf/b-vi.8 and endf/b-viibeta testing was
c         derived from a preliminary specification; this model is derived
c         from the published evaluation.
c
c  This deck is case 7.
c
c  cell cards
c
    1  1  9.97946561e-2   -5 +4  -1                   $solution
c
...
c
c    For m1 (9.97946561e-2):
c    Note:  These solution number density data are slightly different from
c           those defined in the preliminary model and used in data testing
c           with endf/b-vi.8 and endf/b-viibeta_ cross sections.
c     - natN  may be converted to isoN  (1.8050e-3)
c     - natO  may be converted to isoO  (3.5814e-2)  (16+18O = 16O)
c     - natGd may be converted to isoGd (1.9203e-8)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
   m1 94238.80c 2.8921e-7  94239.80c 5.8681e-5  94240.80c 6.0590e-5  $238,39,40Pu
      94241.80c 1.5313e-5  94242.80c 6.5922e-6                       $241,42Pu
      95241.80c 1.5201e-6                                            $241Am
       1001.80c 6.2033e-2                                            $1H
       7014.80c 1.7984e-3   7015.80c 6.6424e-6                       $14,15N
       8016.80c 3.5800e-2   8017.80c 1.3609e-5                       $(16+18),17O
      64152.80c 3.8406e-11 64154.80c 4.1863e-10 64155.80c 2.8420e-9
      64156.80c 3.9309e-9  64157.80c 3.0053e-9  64158.80c 4.7700e-9
      64160.80c 4.1978e-9                                            $isoGd
  mt1  lwtr.20t
c
