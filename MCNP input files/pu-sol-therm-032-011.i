PU-SOL-THERM-032.11, rev0, 9/30/2005, 9.95a% Pu240, 25.0 g Pu/l
c
c  Annular volume is air (cases 1-12) or water (cases 13-17).
c
c  Benchmark keff is 1.0000(19) for all cases.
c
c  This deck is case 11 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00315540e-1  -3 +2  -14 +13                  $Solution
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   65.61               $  End solution (ICSBEP Hc - 0.1)
...
c
c
c    For m1 (1.00315540e-1): solution
c     - natN  may be converted to isoN  (1.4216e-3)
c     - natO  may be converted to isoO  (3.5397e-2)  (16+18O = 16O)
...
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94238.80c 3.1622e-8  94239.80c 5.5812e-5  94240.80c 6.2465e-6
        94241.80c 7.9943e-7  94242.80c 5.5977e-8                       $Pu
         1001.80c 6.3433e-2                                            $H
         7014.80c 1.4164e-3   7015.80c 5.2315e-6                       $isoN
         8016.80c 3.5384e-2   8017.80c 1.3451e-5                       $isoO
