Leu-Comp-Therm-007.3, rev3, 9/30/2006.
c
...
c   - This deck created using lct27.1, then lct7.2 as a template.
c
c
c Cell cards:
c
    1  0                 -105 +104  -155 +154  -209 +203  
                         fill=11(-15.75 -15.75 +20.00)   $core
c
c - Universe 11 is a unit cell.  The pitch is case dependent.
c
   11  0                  -2 +1  -12 +11
...
c
   ...
   2   px    2.10  $ fuel rod unit cell
  11   py    0.00  $ local y-origin
  12   py    2.10  $ fuel rod unit cell
c 21   pz    0.00  $ local z-origin/start conical bottom plug
  ...
  30   pz   79.78  $ (s25+Hc),    water height
...
c cone centered in the unit cell, starting at z=s21 and is 0.8 cm tall.
  48   trc   1.05 1.05 0.00  0.00 0.00 0.80  0.00 0.47  $conical bottom plug
c
c cylinders within the unit cell:
c
  51   c/z  1.050 1.050 0.3946 $fuel OR
  52   c/z  1.050 1.050 0.410  $clad IR
  53   c/z  1.050 1.050 0.470  $clad OR
  54   c/z  1.050 1.050 0.500  $grid hole radius
c
c
c - global x coordinates:
 ...
 104   px  -15.75  $left  array boundary
 105   px   15.75  $right array boundary
...
c - global y coordinates:
 ...
 154   py  -15.75  $left  array boundary
 155   py   15.75  $right array boundary
...
c   (Water height, s206, is 20.00 cm greater than specified on s30).
 ...
 206   pz   99.78  $water height           (s203+1.8+Hc)
