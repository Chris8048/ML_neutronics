Leu-Sol-Therm-004.5 (run 46), rev1, 9/30/2000.
c
c  Benchmark model keff is 0.9999(10).
c
c  This deck is case 5 (run 46).
c
c  Cell specifications:
c
 1   1 9.88084991e-2   -7 +6  -1        $solution
...
c
c    For m1:
c     - natN may be converted to 14,15N                    (2.5925e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.7414e-2)
c     - lwtr.20t is ENDF71SaB kernel
 m1  92234.80c 4.9795e-7  92235.80c 6.1792e-5  92236.80c 6.1715e-8  $234,235,236U
     92238.80c 5.5039e-4                                            $238U
      7014.80c 2.5830e-3   7015.80c 9.5404e-6                       $14,15N
      8016.80c 3.7400e-2   8017.80c 1.4217e-5                       $16,17O
      1001.80c 5.8189e-2                                            $H
 mt1  lwtr.20t                                                      $kernel
c
c    For m2:
