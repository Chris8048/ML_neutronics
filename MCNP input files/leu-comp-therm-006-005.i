Leu-Comp-Therm-006.5, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 5, N=18, pitch=1.956):
 101   px  -47.604   $(s102-30.0), model boundary
 102   px  -17.604   $(-N*pitch/2), start lattice
 103   px   17.604   $( N*pitch/2),   end lattice
 104   px   47.604   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -47.604   $(s152-30.0), model boundary
 152   py  -17.604   $(-N*pitch/2), start lattice
 153   py   17.604   $( N*pitch/2),   end latticeh)
 154   py   47.604   $(s153+30.0), model boundary
c
