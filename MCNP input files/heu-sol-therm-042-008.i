HST042.8, 9/30/2004 (Rev. 1)
c
c  Heu-Sol-Therm-042 case 8 (cylindrical, bare homogenous solution).
c  Benchmark model keff is 1.0000(35).
c
c   Cell cards
c
 1   1 1.00157692e-1   -5 +4  -1           $solution
...
c   Surface cards
c
 1   cz  136.7790  $solution radius
 2   cz  138.6840  $container outer radius
 3   pz   -1.9050  $container bottom
 4   pz    0.0000  $solution bottom
 5   pz  241.0460  $solution height
 6   pz  274.32    $tank height
...
c
c
c    For m1 (1.00157692e-1):
c     - natN may be converted to 14,15N                    (1.3387e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.3620e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - hh2o.20t is rem continuous kernel 
   m1 92234.80c 3.6771e-7   92235.80c 3.2367e-5   92236.80c 2.1875e-7  $
      92238.80c 1.8936e-6                                              $U
       7014.80c 1.33377e-4   7015.80c 4.92642e-7                       $14,15N
       8016.80c 3.36072e-2   8017.80c 1.27756e-5                       $16,17O
       1001.80c 6.6369e-2                                              $H
  mt1  lwtr.20t
c
