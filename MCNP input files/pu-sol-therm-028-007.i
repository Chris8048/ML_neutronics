PU-SOL-THERM-028.7, rev0, 9/30/2004, 3.22a% Pu240, 80.6 g Pu/l
c
c  Annular volume is air (cases 1-6), water (cases 7, 8 & 9) or
c  combinations of water, air and cadmium (cases 10-13).
c  Cases 7/1  = same solution, with & w/o annular water.
c  Cases 8/2  = same solution, with & w/o annular water.
c  Cases 9/3  = same solution, with & w/o annular water.
c
c  Benchmark keff is 1.0000(12) for all cases.
c
c  This deck is case 7 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00929148e-1  -3 +2  -14 +13                  $Solution
c
...
c
 12     4  5.44376401e-5  (-1       -15 +14) :            $Central Air
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   55.37               $  End solution (ICSBEP Hc)
...
c
c
c    For m1 (1.00929148e-1): solution
c     - natN  may be converted to isoN  (2.0703e-3)
c     - natO  may be converted to isoO  (3.6612e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (7.9041e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.9622e-4  94240.80c 6.5107e-6  94241.80c 2.8180e-7  $239,40,41Pu
         1001.80c 6.2036e-2                                            $H
         7014.80c 2.0627e-3   7015.80c 7.6187e-6                       $isoN
         8016.80c 3.6598e-2   8017.80c 1.3913e-5                       $isoO
        26054.80c 4.6199e-7  26056.80c 7.2523e-6  26057.80c 1.6749e-7
        26058.80c 2.2290e-8                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
