Pu-Sol-Therm-010.2 (9-2), rev1, 9/30/2004, 2.9a% 240Pu, 73.92 g Pu/l
c
...
c
  1     1  1.01679143e-1   -14 +13  -5                      $Solution
c
...
c
 ...
 14     pz   35.4076    $  End solution/Start tamper tank
 15     pz   35.5651    $Start tamper water (s14 + 0.1575)
 16     pz   66.0451    $  End tamper water (s15 + 30.48)
 17     pz   66.2026    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01679143e-1):
c     - natN  may be converted to isoN  (1.2199e-3)
c     - natO  may be converted to isoO  (3.5705e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (2.4909e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.8091e-4  94240.80c 5.2850e-6                       $239,240Pu
         1001.80c 6.4566e-2                                            $H
         7014.80c 1.2154e-3   7015.80c 4.4892e-6                       $N
         8016.80c 3.5691e-2   8017.80c 1.3568e-5                       $O
        26054.80c 1.4559e-7  26056.80c 2.2855e-6  26057.80c 5.2782e-8
        26058.80c 7.0243e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
