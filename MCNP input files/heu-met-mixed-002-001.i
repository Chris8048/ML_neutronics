HMM002, 9/30/1998, revision 0.
c
c ICSBEP HMM002 Benchmark model eigenvalue is 1.0000(37).
c
c   Cell cards
  1    0                  -1     $central cavity
  2    4  1.16054000e-1   -2 +1  $central poly
  3    1  4.74524571e-2   -3 +2  $HEU sphere 1 of 3
  4    2  4.77280271e-2   -4 +3  $HEU sphere 2 of 3
  5    3  4.88292374e-2   -5 +4  $HEU sphere 3 of 3
  6    5  1.13917000e-1   -6 +5  $poly reflector, sphere 1 of 2
  7    6  1.16845000e-1   -7 +6  $poly reflector, sphere 2 of 2
 99    0                  +7
...
c
c    For m2: (HEU, 4.77280271e-2, sphere 2 of 3)
c     - natFe may be converted to isoFe (1.5752e-4)
c     - natW  may be converted to isoW  (4.1868e-5)
 m2   92234.80c 5.1683e-4  92235.80c 4.1768e-2  92238.80c 4.3283e-3  $U
       6000.80c 9.1551e-4                                            $C
      26054.80c 9.2070e-6  26056.80c 1.4453e-4  26057.80c 3.3378e-6
      26058.80c 4.4421e-7                                            $isoFe
      74180.80c 5.02416e-8
      74182.80c 1.10950e-5 74183.80c 5.99131e-6 74184.80c 1.28284e-5
      74186.80c 1.19031e-5                                           $isoW
c
...
c
c    For m4: (central poly, 1.16054000e-1)
c     - poly.20t is ENDF71SaB kernel
 m4    6000.80c 3.8685e-02  1001.80c 7.7369e-02                      $C, H
 mt4   poly.20t
c
...
c     - poly.20t is ENDF71SaB kernel
 ...
 mt5   poly.20t
c
c    For m6: (reflector poly, 2 of 2, 1.16845000e-1)
c     - poly.20t is ENDF71SaB kernel
 m6    6000.80c 3.8948e-02  1001.80c 7.7897e-02                      $C, H
 mt6   poly.20t
c
c
print -175
