U233-SOL-INTER-001.20, rev. 1, 9/30/2001.
c
c
...
c
 11   4  1.18491000e-1  -4 +2  $CH2 reflector
c
 99   0                    +4  $outside world

c Surface cards
c
  1   so  10.1625  $Solution radius
  2   so  10.2107  $Container OR
  4   so  13.2807  $CH2 reflector radius
