Leu-Comp-Therm-010.8, rev0, 8/31/1996.
c
...
c   Note, for case 6 the lattice is 12 x 8, not 13 x 8.
  101   px  -92.395  $left   model boundary (s102 - 30.5)
  102   px  -61.895  $left   cluster, left  boundary (s103 - 13*2.54)
  103   px  -28.875  $left   cluster, right boundary (s104 - 12.365)
  104   px  -16.51   $center cluster, left  boundary (-0.5*13*2.54)
  105   px   16.51   $center cluster, right boundary ( 0.5*13*2.54)
  106   px   28.875  $right  cluster, left  boundary (s105 + 12.365)
  107   px   61.895  $right  cluster, right boundary (s106 + 13*2.54)
  108   px   92.395  $right  model boundary (s107 + 30.5)
...
c   surfaces 152 and 153, respectively.
  161   py  -23.215  $(s162 - [10.2(lead), 7.65(deplU) or 17.85(steel)]
  162   py  -15.565  $5.405 cm separation
  163   py   15.565  $
  164   py   23.215  $
c
