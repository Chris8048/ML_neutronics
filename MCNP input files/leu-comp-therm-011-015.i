...
c   1    1  6.83929577e-2 -12 +11  -22 +21  -69 +61  $core envelope
    1    0                -12 +11  -22 +21  -69 +61  $
                          fill=1                     $lattice
c
c  -  u=1 == 50 x 50 array (14 rods/4 empty/14 rods/4 empty/14 rods,
c     repeat in x and y) of rods and empty cells.
   11    0                                 $
         -44 +41  -54 +51  u=1  lat=1      $unit cells
         fill=-25:24 -25:24 0:0            $
         2 13r  3 3r  2 13r  3 3r  2 13r
         2 13r  3 3r  2 13r  3 3r  2 13r
         2 13r  3 3r  2 13r  3 3r  2 13r
         2 13r  3 3r  2 13r  3 3r  2 13r
         2 13r  3 3r  2 13r  3 3r  2 13r
...
c  -  u=2 == fuel rodded cell:
   ...
   25    3  1.00109681e-1  +73  -43 +42  -53 +52  -36  u=2  $water
   26    5  5.122e-5       +73  -43 +42  -53 +52  +36  u=2  $air
   27    3  1.00109681e-1  +73 (+43:-42 : +53:-52) 
                                ((-36 +63):-62)        u=2  $water
...
c  -  u=3 == empty cell, just show water or air and grid:
   31    3  1.00109681e-1  -43 +42  -53 +52  -36  u=3  $water
   32    5  5.122e-5       -43 +42  -53 +52  +36  u=3  $air
   33    3  1.00109681e-1 (+43:-42 : +53:-52) 
                           ((-36 +63):-62)        u=3  $water
...
c  -  other structure:
  101    2  6.03983807e-2  -2     -38 +31
                          (+1:-32)          $Al tank
  102    4  1.00109681e-1  -1     -33 +32   $Lower axial water
  103    2  6.03983807e-2  -1     -34 +33   $Lower axial baseplate
  104    4  1.00109681e-1  -1     -36 +34
...
c - global x and y coordinates (will vary by case)
   11  px  -40.90  $-0.5*(14+4+14+4+14)*1.636
   12  px   40.90  $
   21  py  -40.90  $
   22  py   40.90  $
c
c - global z coordinates (per Figure 13)
   ...
   36  pz  129.65  $(s34+H), water height
...
c
c  m3 (1.00109681e-1, Case 15):
c  Unit cell H2O
c     - natO converted to 16,17O (where 16 = 16+18) (3.3370e-2, Case 15)
c     - lwtr.20t is ENDF71SaB kernel
  m3   1001.80c 6.6740e-2                                            $1H
       8016.80c 3.3357e-2   8017.80c 1.2681e-5                       $(16+18),17O
  mt3 lwtr.20t
c
c  m4 (1.00109681e-1, Case 15):
c  other H2O
c     - natO converted to 16,17O (where 16 = 16+18) (3.3370e-2, Case 15)
c     - lwtr.20t is ENDF71SaB kernel
  m4   1001.80c 6.6740e-2                                            $1H
       8016.80c 3.3357e-2   8017.80c 1.2681e-5                       $(16+18),17O
  mt4 lwtr.20t
c
c  m5 (5.122e-5):
