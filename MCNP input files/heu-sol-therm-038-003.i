...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 3 is void between Tank #1 and Tank #2
  71   0                 -12 +11 -14 +13  -83 +6  $bottom E,F to top of Tank #2
  72   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
c
c     - case 3 is POLY-2 above Tank #1
  91  10 1.18817000e-1                    -99 +74  -98 $poly-2
...
c     the relative spacings do not change.
  71  pz   64.14389  $(s6+16.4719), bottom of Tank #1
  72  pz   65.11188  $(s71+0.96799), Tank #1 bottom plate
  73  pz   74.01255  $(s72+8.90067), Tank #1 internal height
  74  pz   74.97394  $(s73+0.96139), top of Tank #1
  81  pz   64.81394  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   72.43394  $(s81+7.62),      top of side plates  A,B,C,D
  83  pz   62.27394  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for POLY-2 (above Tank #1)
  98  cz   34.29508  $(68.59016/2), poly-2 radius
  99  pz   79.68310  $(s74+4.70916), top of poly-2
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   79.68310  $extra z-plane for possible upper reflector/top of model
