...
c - the reflector material is Ti.
c - the benchmark eigenvalue is 0.9994(20).
c
c Cell cards
c      1: HEU metal
c      2: Reflector
...
c
  2    2  5.64058734e-2  -2  -22 +21  (+1:+12:-11)  $reflector
c
...
c
 ...
 12    pz  18.41848  $  end axial HEU
 21    pz  -2.54     $start axial reflector (s11-2.54)
 22    pz  20.95848  $  end axial reflector (s12+2.54)
...
c
c    For m2:
c     Case 12 = Ti, 5.64058734e-2:
c      - natTi may be converted to isoTi (5.4618e-2)
c      - natCr may be converted to isoCr (1.3030e-3)
c      - natFe may be converted to isoFe (4.8524e-4)
  m2  22046.80c 4.5060e-3  22047.80c 4.0636e-3  22048.80c 4.0264e-2  $
      22049.80c 2.9548e-3  22050.80c 2.8292e-3                       $isoTi
      24050.80c 5.6615e-5  24052.80c 1.0918e-3  24053.80c 1.2380e-4  $
      24054.80c 3.0816e-5                                            $isoCr
      26054.80c 2.8362e-5  26056.80c 4.4523e-4  26057.80c 1.0282e-5  $
      26058.80c 1.3684e-6                                            $isoFe
c
c
print -175

C    k(bmk) = 0.9994 +- 0.0020
