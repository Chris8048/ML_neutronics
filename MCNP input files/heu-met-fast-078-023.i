Heu-Met-Fast-078.23, rev.0, 9/30/2006.
c
...
c
 11    2  8.9747e-2      -11 +2  -3  $upper reflector
c
...
c
  ...
  2    pz    7.1165  $   top of core plane
  3    cz   19.05    $core radius
c
 11    pz    9.6565  $   top of upper axial reflector (s2 + 2.54)
...
c      if graphite density = 1.79 c/cm3, then 8.9747e-2 a/bn-cm.
   m2  6000.80c 8.9747e-2                                            $graphite
  mt2  grph.20t
c
c
print -175

C    k(bmk) = 0.9992 +- 0.0022
