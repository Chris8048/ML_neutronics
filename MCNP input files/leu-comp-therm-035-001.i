...
c
  ...
  114  4  9.99875543e-2    +53      -203 +202  u=11          $unit cell water
  115  5  9.99875543e-2    +53      -202 +211  u=11          $axial, water
  116  3  6.02240000e-2    +53      -211 +212  u=11          $lower grid
  117  5  9.99875543e-2    +53      -212       u=11          $axial, water
...
c
c
c - global x coordinates (Case 1, N=21, pitch=1.956):
...
c
c - global y coordinates (Case 1, N=21, pitch=1.956):
...
c
c  m4 (9.99875543e-2):
c  Unit cell H2O (borated, case 1)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3332e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab 
c     - hh2o.20t is rem continuous kernel 
  m4   1001.80c 6.6652e-2                                            $1H
       8016.80c 3.3319e-2   8017.80c 1.2666e-5                       $(16+18),17O
       5010.80c 7.7376e-7   5011.80c 3.1145e-6                       $boron
  mt4 lwtr.20t
c
c  m5 (9.99875543e-2):
c  other H2O (borated, case 1)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3332e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab 
c     - hh2o.20t is rem continuous kernel 
  m5   1001.80c 6.6652e-2                                            $1H
       8016.80c 3.3319e-2   8017.80c 1.2666e-5                       $(16+18),17O
       5010.80c 7.7376e-7   5011.80c 3.1145e-6                       $boron
  mt5 lwtr.20t
c
