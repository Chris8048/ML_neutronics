...
c - the reflector material is Al2O3.
c - the benchmark eigenvalue is 0.9994(21).
c
c Cell cards
c      1: HEU metal
c      2: Reflector
...
c
  2    2  8.10994900e-2  -2  -22 +21  (+1:+12:-11)  $reflector
c
...
c
 ...
 12    pz  15.22594  $  end axial HEU
 21    pz  -2.54     $start axial reflector (s11-2.54)
 22    pz  17.76594  $  end axial reflector (s12+2.54)
...
c
c    For m2:
c     Case 2 & 15 = aluminum oxide (Al2O3), 8.10994900e-2:
c      - natO  may be converted to isoO  (4.8659e-2)
  m2  13027.80c 3.2440e-2                                            $Al
       8016.80c 4.8641e-2   8017.80c 1.8490e-5                       $isoO
c
c
print -175

C    k(bmk) = 0.9994 +- 0.0021
