Pu-Sol-THERM-011, 18-inch sphere, case 5, rev 0, 8/31/1996
c
c Benchmark model keff is 1.0000(52) for all cases.
c
c This deck is for an 18-inch sphere, case 5.
c
c Cell cards:
c
 1    1  1.01732157e-1    -1  $Solution
...
c
c
c    For m1 (1.01732157e-1):
c     - natN  may be converted to isoN  (1.9343e-3)
c     - natO  may be converted to isoO  (3.6553e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.4773e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
   m1  94239.80c 6.0816e-5  94240.80c 2.6552e-6                       $239,240Pu
        1001.80c 6.3180e-2                                            $H
        7014.80c 1.9272e-3   7015.80c 7.1182e-6                       $N
        8016.80c 3.6539e-2   8017.80c 1.3890e-5                       $O
       26054.80c 8.6348e-8  26056.80c 1.3555e-6  26057.80c 3.1304e-8
       26058.80c 4.1660e-9                                            $isoFe
  mt1   lwtr.20t                                                      $S(a,b) 
c
