full LWBR SB-1 benchmark (generic materials defined by xsdir, H(H2O) ADS-Lib)
c  uct001, case 1, original deck from Andre Trkov
c  rectangular array
c  U235, 576 UO2-ZrO2 seed rods (24x24 array)
c  1120 ThO2 blanket rods (34x34 - 6x6 array)
c
c  Cells
c  surface order:  pz1 ... cz1 ... (axial, then radial)
c  seed rod, infinitely long
11   5   4.3036-2    1     -21               u=1  imp:n=1  $ top zircaloy plug + cap
12   2   8.2231-2    2  -1 -21               u=1  imp:n=1  $ 235UO2-ZrO2 seed
13   5   4.3036-2   -2 -21                   u=1  imp:n=1  $ bottom zircaloy plug + cap
...
61   0     -51 52 -53 54   lat=1            u=10  imp:n=1
              fill=-18:18 -18:18 0:0
                5 5 5 10R 5 11R 5 10R 5
                5 5 5 10R 5 11R 5 10R 5
                5 5 9 10R 9 11R 9 10R 5
                5 5 9 10R 9 11R 9 10R 5
                5 5 9 10R 9 11R 9 10R 5
                5 5 9 10R 9 11R 9 10R 5
                5 5 9 10R 9 11R 9 10R 5
...
c  rest of rod array (without control blade bank)
...
51  px     0.91948  $ 2*seed pitch= 0.724in. = 1.83896cm            
52  px    -0.91948        
53  py     0.91948            
54  py    -0.91948           
c  core window (square cell) surfaces
66  px    32.0825   $ 17.5*pitch     
67  px   -32.0825 
68  py    32.0825
69  py   -32.0825
c  control blades 
...
c  model boundaries
91  cz    75.86     $ core + 1ft 
99  cz   259.08     $ 17ft diameter containment tank (neglected)

c
c  Materials, Avogadro's number = 6.0221+23 particles/g-mole
...
*tr2        -0.91948   -0.91948     0.0     0 90 90     90 0 90    90 90 0   1
 mode n 
 kcode 10000 1.0 25 5025       $10,000 x 5,000 = 50M histories per job
 rand gen=2 hist=1             $use default for other random # generator entries
print -175
c print
ksrc      0.5    -0.5     0          0.5   -10.6     0
          0.5    -0.5    19          0.5   -10.6    19
          0.5    -0.5   -19          0.5   -10.6   -19
          0.5    -2.2     0          0.5   -30       0
          0.5    -5       0          0.5   -30      19
          0.5    -7       0          0.5   -30     -19
          ...
          5      -7       0          7      -7       0
          5     -10.6     0          7     -10.6     0
         10.6    -0.5     0         10.6   -10.6     0
         10.6    -0.5    19         10.6   -10.6    19
         10.6    -0.5   -19         10.6   -10.6   -19
         10.6    -2.2     0
         10.6    -5       0
         10.6    -7       0                  
