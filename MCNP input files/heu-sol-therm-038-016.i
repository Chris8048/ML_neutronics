...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 15 is four boraflex plates above Tank #2, then void to Tank #1
  81   0                 -61 +60 -14 +13  -96 +83   +95 $top boraflex to bottom E,F
  82   0                 -61 +60 -14 +13  -71 +96       $bottom tank #1 to top boraflex
  83  15 1.05309867e-1                    -96  +6   -95 $boraflex, 4-plates
  84   0                 -12 +11 -14 +13  -83  +6   +95 $void
c
...
c     the relative spacings do not change.
  71  pz   50.11801  $(s96+1.61290), bottom of Tank #1
  72  pz   51.08600  $(s71+0.96799), Tank #1 bottom plate
  73  pz   59.98667  $(s72+8.90067), Tank #1 internal height
  74  pz   60.94806  $(s73+0.96139), top of Tank #1
  81  pz   50.78806  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   58.40806  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   48.24806  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for four boraflex plates (above Tank #2)
  95  cz   35.13836  $(70.27672/2), boraflex plate radius
  96  pz   48.50511  $(s6+4*0.20828), top of four boraflex plates
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   60.94806  $extra z-plane for possible upper reflector/top of model
