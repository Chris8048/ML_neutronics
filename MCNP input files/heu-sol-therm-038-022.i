...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 22 is a poly-1, hot-rolled steel and poly-6 plate above Tank #2,
c       then void to Tank #1
  ...
  83  11 1.17864000e-1                    -96 +94  -95 $poly-6 plate
...
c     the relative spacings do not change.
  71  pz   54.78653  $(s96+3.24866), bottom of Tank #1
  72  pz   55.75452  $(s71+0.96799), Tank #1 bottom plate
  73  pz   64.65519  $(s72+8.90067), Tank #1 internal height
  74  pz   65.61658  $(s73+0.96139), top of Tank #1
  81  pz   55.45658  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   63.07658  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   52.91658  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for POLY-1, Hot-Rolled Steel and POLY-6 plates
c     (above Tank #2)
  ...
  95  cz   34.30270  $(68.60540/2), poly-6 plate radius
  96  pz   51.53787  $(s94+1.97104), top of poly-6 plate
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   65.61658  $extra z-plane for possible upper reflector/top of model
