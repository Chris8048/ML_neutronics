...
c
c  This deck is case 4 (detailed).
c
c Cell cards:
c
  1   1 9.98358093e-2  (-1 -3) :              $partially filled sphere
                       (+1 -4 -3 +14)         $solution in fill pipe
  2   2 9.99719631e-2  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
...
c
  1   so  11.1768  $sphere (solution) inner radius [B]
  2   so  11.3038  $sphere outer radius (s1 + 0.127)
  3   pz  10.4395  $solution height ([A] - s1)
 ...
 16   pz  39.1962  $reflector water height (s13 + [C])
...
c
c
c    For m1 (9.98358093e-2):
c     - natN may be converted to 14,15N                    (7.8588e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4897e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 2.2081e-9   92233.80c 3.3146e-4   92234.80c 3.5427e-6
      92235.80c 8.7599e-8   92236.80c 3.3549e-9   92238.80c 4.6107e-6  $U
       1001.80c 6.3809e-2                                              $H
       7014.80c 7.82988e-4   7015.80c 2.89204e-6                       $N
       8016.80c 3.48837e-2   8017.80c 1.32609e-5                       $O
      90232.80c 4.2618e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (9.99719631e-2)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3324e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6648e-2                                              $H
       8016.80c 3.33113e-2   8017.80c 1.26631e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
