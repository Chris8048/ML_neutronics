...
c
c  This deck is case 3 (detailed).
c
c Cell cards:
c
  1   1 9.83972618e-2  (-1 -3) :              $partially filled sphere
                       (+1 -4 -3 +14)         $solution in fill pipe
  2   2 9.98919529e-2  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
...
c
  ...
  3   pz   8.3862  $solution height ([A] - s1)
 ...
 16   pz  38.1962  $reflector water height (s13 + [C])
...
c
c
c    For m1 (9.83972618e-2):
c     - natN may be converted to 14,15N                    (1.0373e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4935e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 2.9144e-9   92233.80c 4.3748e-4   92234.80c 4.6758e-6
      92235.80c 1.1562e-7   92236.80c 4.4280e-9   92238.80c 6.0855e-6  $U
       1001.80c 6.1971e-2                                              $H
       7014.80c 1.03348e-3   7015.80c 3.81726e-6                       $N
       8016.80c 3.49217e-2   8017.80c 1.32753e-5                       $O
      90232.80c 5.6250e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (9.98919529e-2)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3297e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6595e-2                                              $H
       8016.80c 3.32843e-2   8017.80c 1.26529e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
