...
c - water filled and reflected sleeves.
  ...
  73   0          -62 +61  -64 +63  -81 +74 fill=6 $ void-filled sleeves (case 1)
c  73   0          -62 +61  -64 +63 -75 +74 fill=6 $water-filled sleeves, 2-6
c  74   0          -62 +61  -64 +63 -81 +76 fill=6 $water-filled sleeves, 2-6
c
c - voided sleeves, above the water line.
c   cell 82 is only used in case 1.
c   cell 81 z bounds are -96 +81 for cases 2 through 6
c  81   0          -62 +61  -64 +63  -96 +81 fill=8 $cases 2 - 6
  81   0          -62 +61  -64 +63  -96 +76 fill=8 $case 1 only
  82   0          -62 +61  -64 +63  -75 +81 fill=8 $case 1 only
c
...
c
c                           Case  1       2       3       4       5       6
  21   px  -6.00  $              6.00,   6.35,   6.45,   6.50,   6.525,  6.40
  22   px   6.00  $               "
  23   py  -6.00  $               "
  24   py   6.00  $               "
c
...
c                           Case  1       2       3       4       5       6
  61   px  -18.0  $             18.0    19.05,  19.35,  19.50,  19.575, 19.2
  62   px   18.0  $
  63   py  -18.0  $
  64   py   18.0  $
...
c   - water height
c                          Case   1       2       3       4       5       6
  81   pz  48.30  $             48.30,  58.40,  60.60,  62.78,  65.80,  65.60
c
