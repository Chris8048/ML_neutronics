Leu-Comp-Therm-017.14, rev1, 9/30/1998.
c
...
c   center of center cluster is x=0.
  101   px  -97.160  $left   model boundary (s102 - 30.5)
  102   px  -66.660  $left   cluster, left  boundary (s103 - 19*2.032)
  103   px  -28.052  $left   cluster, right boundary (s104 - 8.748)
  104   px  -19.304  $center cluster, left  boundary (-0.5*19*2.032)
  105   px   19.304  $center cluster, right boundary ( 0.5*19*2.032)
  106   px   28.052  $right  cluster, left  boundary (s105 + 8.748)
  107   px   66.660  $right  cluster, right boundary (s106 + 19*2.032)
  108   px   97.160  $right  model boundary (s107 + 30.5)
...
c   surfaces 152 and 153, respectively.
  161   py  -38.018  $s162 - [10.2(lead), 7.65(deplU) or 17.85(steel)]
  162   py  -20.168  $s152 - 3.912 cm separation
  163   py   20.168  $
  164   py   38.018  $
c
