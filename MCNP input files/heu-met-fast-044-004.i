...
c
  1    1  4.76772490e-2  -4    ((-26 +25):
                                ...
                                (-52 +53 +1):
                                (-53 +54))            $HEU (two zones)
  2    3  6.01151676e-2  -4    ((-27 +26):(-54 +55))  $axial reflector
c
...
c
 ...
 27    pz  14.955  $(s26+9.98),      top upper zone axial reflector (case 4)
c
 51    pz  -0.60   $(s21-0.6), top support ring thickness
 52    pz  -0.68   $(s21-0.68), Hcr
 53    pz  -1.680  $(s52-1.000),  first lower zone HEU
 54    pz  -5.655  $(s52-4.975), bottom lower zone HEU
 55    pz -15.635  $(s54-9.98),  bottom lower zone axial reflector (case 4)
c
...
c
c    For m2: (AMC Al, case 3, 6.02325029e-2) -- NOT USED in Case 4
