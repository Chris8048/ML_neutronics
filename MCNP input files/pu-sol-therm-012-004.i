PU-SOL-THERM-012.4, rev2, 9/30/2000, 18.88a% Pu240, 14.7 g Pu/l
c
c 2015-05-07 - fbb, new/revised benchmark from LANL NCS
c               mt cards (without fe56), remove spectrum tallies
c
c
...
c
    1    1  1.00349612e-1  (+3 -4   +13 -14   +23 -24)           $Solution
c
...
c
 ...
 24     pz     45.68   $  end solution
 25     pz     65.68   $+z limit for reflector (s24 + 20.0, or s36 + 1.0)
...
c
 ...
 35     pz     46.68   $+z limit for bottom of lucoflex box (s24 + 1.0)
 36     pz     64.68   $-z limit for    top of lucoflex box (s35 + 18.0)
c ______________________________________________________________________________
...
c
c
c    For m1 (1.00349612e-1): (solution)
c     - natN  may be converted to isoN  (1.37017e-3)
c     - natO  may be converted to isoO  (3.53176e-2)  (16+18O = 16O)
c     - natCr may be converted to isoCr (1.24834e-6)
c     - natFe may be converted to isoFe (3.88196e-6)
c     - natNi may be converted to isoNi (8.84769e-7)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 2.75215e-5  94240.80c 6.97353e-6  94241.80c 2.06717e-6
        94242.80c 4.17575e-7  95241.80c 2.24014e-7                      $Pu, Am
         1001.80c 6.36186e-2                                            $H
         7014.80c 1.36513e-3   7015.80c 5.04223e-6                      $isoN
         8016.80c 3.53042e-2   8017.80c 1.34207e-5                      $isoO
        24050.80c 5.42404e-8  24052.80c 1.04597e-6  24053.80c 1.18605e-7
        24054.80c 2.95232e-8                                            $isoCr
        26054.80c 2.26901e-7  26056.80c 3.56185e-6  26057.80c 8.22587e-8
        26058.80c 1.09471e-8                                            $isoFe
        28058.80c 6.02323e-7  28060.80c 2.32014e-7  28061.80c 1.00855e-8
        28062.80c 3.21569e-8  28064.80c 8.18942e-9                      $isoNi
 mt1     lwtr.20t                                                       $S(a,b)
c
