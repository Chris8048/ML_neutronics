...
c   Cell cards
c
    1   5 9.90899908e-2    -21       -7 +6           $inner solution
    2   0                  -21      -10 +7           $void above inner solution
    3   2 8.70195394e-2    -22      -10 +5  (-6:+21) $inner tank
    4   1 1.00112981e-1    -23       -8 +4  (-5:+22) $middle tank water (cases 1-3)
c   4   1 1.00112981e-1    -23 +22   -8 +4           $middle tank water (cases 4-5)
c   4   3 9.93150622e-2    -23 +22   -8 +4           $middle tank solution (cases 6-13)
...
c   7   1 1.00112981e-1    -25 +24   -9 +3           $radial water (cases 1,6-18)
    7   0                  -25 +24   -9 +3           $void (cases 2-5)
    8   0                  -25 +24  -10 +9           $void above radial water
    9   2 8.70195394e-2    -24       -3 +2           $bottom of outer tank, <R4
c  10   2 8.70195394e-2    -26 +24  -10 +2  (-3:+25) $outer tank, >R4 (cases 1,6-18)
   10   0                  -26 +24  -10 +2  (-3:+25) $voided outer tank, >R4 (cases 2-5)
c
c - cells 21 and 22 are lower axial void (cases 1, 2 and 3) or water (cases 4 to 18).
c   Outer radial limit is case dependent.
   21   0                  -24      -2 +1            $cases 1-3
c  21   1 1.00112981e-1    -24      -2 +1            $cases 4-18
   22   0                  -26 +24  -2 +1            $cases 1-5
c  22   1 1.00112981e-1    -26 +24  -2 +1            $cases 6-18
c
...
c
    ...
    5 pz  56.7  $H5, bottom of inner tank (case dependent)
    6 pz  57.3  $H6, interior bottom of inner tank (case dependent)
    7 pz  99.3  $H7, top of inner  tank solution (case dependent)
    8 pz 106.6  $H8, top of middle tank solution (case dependent)
    9 pz  86.9  $H9, top of outer  tank reflector (case dependent)
...
c     - hh2o.20t is rem continuous kernel 
   m5 92234.80c 1.1825e-6   92235.80c 1.1521e-4   92236.80c 2.8344e-7  $
      92238.80c 1.2558e-5                                              $HEU
       1001.80c 6.4869e-2                                              $H
       8016.80c 3.37172e-2   8017.80c 1.28174e-5                       $16,17O
       7014.80c 3.60000e-4   7015.80c 1.32969e-6                       $14,15N
      64152.80c 8.19540e-10 64154.80c 8.93299e-9  64155.80c 6.06460e-8 $
      64156.80c 8.38799e-8  64157.80c 6.41290e-8  64158.80c 1.01787e-7 $
      64160.80c 8.95757e-8                                             $isoGd
c
...
c     - hh2o.20t is rem continuous kernel 
c  m5 92234.80c 4.3365e-6   92235.80c 4.2250e-4   92236.80c 1.0395e-6  $
c     92238.80c 4.6055e-5                                              $HEU
c      1001.80c 6.1925e-2                                              $H
c      8016.80c 3.53146e-2   8017.80c 1.34246e-5                       $16,17O
c      7014.80c 1.16400e-3   7015.80c 4.29934e-6                       $14,15N
c     64152.80c 1.05314e-8  64154.80c 1.14792e-7  64155.80c 7.79324e-7 $
c     64156.80c 1.07789e-6  64157.80c 8.24082e-7  64158.80c 1.30800e-6 $
c     64160.80c 1.15108e-6                                             $isoGd
c
...
c
 fc01  Radial leakage
 f01:n +21           $ radial current (across solution radius) ...
 fs01  +7 +6         $ but restrict edit to solution axial limits
 e01   6.250e-7 150.
 c01   0.0 1.0
c
 fc11  Axial leakage
 f11:n +6 +7         $ axial current across top and bottom solution surfaces ...
 fs11  -21           $ but only within the solution radius
 e11   6.250e-7 150.
 c11   0.0 1.0
c
c
