Leu-Comp-Therm-002.2, rev0, 3/31/1995.
c
...
c
c - A 9 x 13 cluster plus 3 rods:
   22    0                 -105 +104  -153 +152  -204 +203
                           fill=11(-1.27 -1.27 +17.84)           $9x13 cluster
   23    0                 -105 +109  -155 +153  -204 +203
                           fill=11(-1.27 -1.27 +17.84)           $partial row
c
...
c   center of center cluster is x=0.
  101   px  -41.43  $left  model boundary (s104 - 30.0)
  104   px  -11.43  $left  boundary (-0.5*9*2.54)
  105   px   11.43  $right boundary ( 0.5*9*2.54)
  108   px   43.97  $right model boundary (s105 + 30.0)
  109   px    3.81  $boundary for partial row (s105-3*2.54)
c
c - global y coordinates:
c   center of center cluster is y=0.
  151   py  -46.51  $model   boundary (s152 - 30.0)
  152   py  -16.51  $cluster boundary (-0.5*13*2.54)
  153   py   16.51  $cluster boundary ( 0.5*13*2.54)
  154   py   49.05  $model   boundary (s155 + 30.0)
  155   py   19.05  $boundary for partial row (s153+2.54)
c
