...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 11 is void between Tank #1 and Tank #2
  71   0                 -12 +11 -14 +13  -83 +6  $bottom E,F to top of Tank #2
  72   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
c
c     - case 11 is BP-7 above Tank #1
  91  14 1.23240900e-1                    -99 +74  -98 $bp-7
...
c     the relative spacings do not change.
  71  pz   58.72607  $(s6+11.05408), bottom of Tank #1
  72  pz   59.69406  $(s71+0.96799), Tank #1 bottom plate
  73  pz   68.59473  $(s72+8.90067), Tank #1 internal height
  74  pz   69.55612  $(s73+0.96139), top of Tank #1
  81  pz   59.39612  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   67.01612  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   56.85612  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for bp-7 plate (above Tank #1)
  98  cz   35.86861  $(71.73722/2), bp-7 plate radius
  99  pz   70.77024  $(s74+1.21412), top of bp-7 plate
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   70.77024  $extra z-plane for possible upper reflector/top of model
