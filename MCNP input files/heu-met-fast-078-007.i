Heu-Met-Fast-078.7, rev.0, 9/30/2006.
c
...
c
 11    2  1.19139000e-1  ((-11 +2):(-1 +12))  -3  $upper reflector
c
...
c
  ...
  2    pz    3.8392  $   top of core plane
  3    cz   19.05    $core radius
c
 11    pz    8.9192  $   top of upper axial reflector (s2 + 5.08)
 12    pz   -5.0800  $bottom of lower axial reflector (s1 - 5.08)
