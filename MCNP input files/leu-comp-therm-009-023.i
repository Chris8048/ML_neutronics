...
c     - x-value is given by +/-(15*2.54 + Sc).
   51    0   -63 +62  -83 +82  -95 +93             $
             fill=11(-45.38 0.00 0.00)             $  left cluster
   52    0   -65 +64  -83 +82  -95 +93  fill=11    $center cluster
   53    0   -67 +66  -83 +82  -95 +93             $
             fill=11(+45.38 0.00 0.00)             $ right cluster
c
...
c   - these data are case 23:
   61   px  -94.43   $(s62-30.), left model boundary
   62   px  -64.43   $(s63-15*2.54),   left cluster, left boundary
   63   px  -26.33   $(s64-Sc),        left cluster, right boundary
   64   px  -19.05   $ -7.5*2.54,    center cluster, left  boundary
   65   px  +19.05   $  7.5*2.54,    center cluster, right boundary
   66   px  +26.33   $(s65+Sc),       right cluster, left  boundary
   67   px  +64.43   $(s66+15*2.54),  right cluster, right boundary
   68   px  +94.43   $(s67+30.), right model boundary
   71   px  -22.5276 $(s72-absorber plate thickness)
   72   px  -22.3270 $(s64-Sp)
   73   px  +22.3270 $(s65+Sp)
   74   px  +22.5276 $(s73+absorber plate thickness)
c
