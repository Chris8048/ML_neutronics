...
c -- primary solution & cylinder
  ...
  2    pz  257.2005  $Bottom of solution in primary cylinder (s24 + 48.26 + "e")
  3    pz  272.3515  $   Top of solution in primary cylinder (s2  + 15.151)
  4    cz   19.189   $Primary cylinder OR (s1 + 0.127)
  5    pz  255.9305  $Bottom of primary cylinder (s2 - 1.27 - "e")
  6    pz  438.8005  $   Top of primary cylinder (s2 + 181.60)
  7    pz  438.9275  $   Top of primary cylinder cap (s6 + 0.127)
