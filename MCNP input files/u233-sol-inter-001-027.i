U233-SOL-INTER-001.27, rev. 1, 9/30/2001.
c
c
...
c
  1   1  9.62283505e-2  -1     $Solution
  2   2  8.69523884e-2  -2 +1  $Container
c
 11   3  1.21610000e-1  -3 +2  $Be reflector
 12   4  1.18491000e-1  -4 +3  $Poly reflector
c
 99   0                    +4  $outside world

c Surface cards
c
  1   so   9.0079  $Solution radius
  2   so   9.0562  $Container OR
  3   so  10.1962  $Be reflector radius
  4   so  14.5362  $Poly reflector radius
...
c   m1 92232.80c 4.5608e-8   92233.80c 2.2379e-3   92234.80c 2.4316e-5
c      92235.80c 8.9598e-7   92238.80c 7.1284e-6                        $U
c       1001.80c 5.5183e-2                                              $H
c       8016.80c 3.20308e-2   8017.80c 1.21763e-5                       $O
c       9019.80c 4.7182e-3                                              $F
c
...
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.2474e-2)
   m1 92232.80c 2.9871e-8   92233.80c 1.4657e-3   92234.80c 1.5925e-5
      92235.80c 5.8682e-7   92238.80c 4.6687e-6                        $U
       1001.80c 5.9146e-2                                              $H
       8016.80c 3.24617e-2   8017.80c 1.23401e-5                       $O
       9019.80c 3.1214e-3                                              $F
 mt1   lwtr.20t                                                        $h-h2o
c
