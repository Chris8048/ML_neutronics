...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 17 is BP-7 above Tank #2
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top bp-7
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  14 1.23240900e-1                    -96 +6   -95 $bp-7 plate
  84   0                 -12 +11 -14 +13  -96 +6   +95 $void
c
c     - case 17 is POLY-3 above Tank #1
  91  10 1.18817000e-1                    -99 +74  -98 $poly-3
...
c     the relative spacings do not change.
  71  pz   51.73599  $(s96+2.84988), bottom of Tank #1
  72  pz   52.70398  $(s71+0.96799), Tank #1 bottom plate
  73  pz   61.60465  $(s72+8.90067), Tank #1 internal height
  74  pz   62.56604  $(s73+0.96139), top of Tank #1
  81  pz   52.40604  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   60.02604  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   49.86604  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for BP-7 (above Tank #2)
  95  cz   35.86861  $(71.73722/2), bp-7 plate radius
  96  pz   48.88611  $(s6+1.21412), top of bp-7 plate
c
c   - radius and height for POLY-3 (above Tank #1)
  98  cz   35.17392  $(70.34784/2), poly-3 radius
  99  pz   63.86398  $(s74+1.29794), top of poly-3
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   63.86398  $extra z-plane for possible upper reflector/top of model
