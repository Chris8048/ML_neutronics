Leu-Comp-Therm-006.17, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 17, N=18, pitch=2.293):
 101   px  -50.637   $(s102-30.0), model boundary
 102   px  -20.637   $(-N*pitch/2), start lattice
 103   px   20.637   $( N*pitch/2),   end lattice
 104   px   50.637   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -50.637   $(s152-30.0), model boundary
 152   py  -20.637   $(-N*pitch/2), start lattice
 153   py   20.637   $( N*pitch/2),   end latticeh)
 154   py   50.637   $(s153+30.0), model boundary
c
