Leu-Comp-Therm-024.1, case 1, rev0, 9/30/1997.
c
...
c
 1    0                -51 50  -56 55  -25 13  fill=1  $lattice
c
c  - Universe 1 is a 57 x 47 array made up of either a 0.62cm x 0.62cm unit
c    cell containing the u=2 fuel rod or just water.
 2    4 1.00103680e-1                                  $water in undefined cells
      -2 1  -4 3  u=1  lat=1                           $unit cells
      fill=-28:28 -23:23 0:0
      2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r
      2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r
      2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r
      2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  2 56r
      2 56r  2 56r  2 56r  2 56r  2 56r  2 56r  1 53r 2 2 2 
c
...
c
c x planes for 57 rods
 50   px  -17.67  $ start first rod cell (-0.62*28-0.31)
 51   px   17.67  $   end 57th  rod cell ( 0.62*28+0.31)
c
c y plane for 47 rods
 55   py  -14.57  $ start first rod cell (-0.62*23-0.31)
 56   py   14.57  $   end 47th  rod cell ( 0.62*23+0.31)
c
c 30 cm thick x- and y-planes radial reflector
 60   px  -47.67  $ s50-30.0
 61   px   47.67  $ s51+30.0
 65   py  -44.57  $ s55-30.0
 66   py   44.57  $ s55-30.0
c ------------------------------------------------------------------------------
