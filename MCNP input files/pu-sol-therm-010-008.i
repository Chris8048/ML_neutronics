Pu-Sol-Therm-010.8 (11-5), rev1, 9/30/2004, 2.9a% 240Pu, 36.90 g Pu/l
c
...
c
  1     1  1.00614760e-1  -14 +13  -5                       $Solution
c
...
c
 ...
 14     pz   43.0022    $  End solution/Start tamper tank
 15     pz   43.1597    $Start tamper water (s14 + 0.1575)
 16     pz   73.6397    $  End tamper water (s15 + 30.48)
 17     pz   73.7972    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.00614760e-1):
c     - natN  may be converted to isoN  (2.9137e-3)
c     - natO  may be converted to isoO  (3.7515e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (2.8360e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 9.0308e-5  94240.80c 2.6382e-6                       $239,240Pu
         1001.80c 6.0090e-2                                            $H
         7014.80c 2.9030e-3   7015.80c 1.0722e-5                       $N
         8016.80c 3.7501e-2   8017.80c 1.4256e-5                       $O
        26054.80c 1.6576e-7  26056.80c 2.6021e-6  26057.80c 6.0095e-8
        26058.80c 7.9975e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
