Leu-Comp-Therm-002.4, rev0, 3/31/1995.
c
c  pitch = 2.54cm, 3 clusters of 15 * 8 rods.
...
c   center of center cluster is x=0.
  101   px  -97.77  $left   model boundary (s102 - 30.0)
  102   px  -67.77  $left   cluster, left  boundary (s103 - 15*2.54)
  103   px  -29.67  $left   cluster, right boundary (s104 - 10.62)
  104   px  -19.05  $center cluster, left  boundary (-0.5*15*2.54)
  105   px   19.05  $center cluster, right boundary ( 0.5*15*2.54)
  106   px   29.67  $right  cluster, left  boundary (s105 + 10.62)
  107   px   67.77  $right  cluster, right boundary (s106 + 15*2.54)
  108   px   97.77  $right  model boundary (s107 + 30.0)
c
