...
c
  1    1  4.76752249e-2  -4    ((-26 +25):
                                ...
                                (-52 +53 +1):
                                (-53 +54))            $HEU (two zones)
  2    2  6.03154884e-2  -4    ((-27 +26):(-54 +55))  $axial reflector
c
...
c
 ...
 52    pz  -0.46   $(s21-0.46), Hcr
 53    pz  -1.460  $(s52-1.000),  first lower zone HEU
 54    pz  -6.430  $(s52-5.970), bottom lower zone HEU
 55    pz  -7.420  $(s54-0.99),  bottom lower zone axial reflector (case 1)
c
...
c
c    For m2: (AMC Al, case 1, 6.03154884e-2)
c     - natMg may be converted to isoMg (1.6898e-5)
c     - natSi may be converted to isoSi (1.7548e-4)
c     - natFe may be converted to isoFe (1.0296e-4)
c     - natCu may be converted to isoCu (2.5852e-5)
c     - natZn may be converted to isoZn (1.2558e-5)
 m2   13027.80c 5.9593e-2                                            $Al
      12024.80c 1.33477e-5 12025.80c 1.68980e-6 12026.80c 1.86047e-6 $isoMg
      14028.80c 1.61845e-4 14029.80c 8.21808e-6 14030.80c 5.41742e-6 $isoSi
      25055.80c 3.8874e-4                                            $Mn
      26054.80c 6.01801e-6 26056.80c 9.44699e-5 26057.80c 2.18172e-6
      26058.80c 2.90347e-7                                           $isoFe
      29063.80c 1.78818e-5 29065.80c 7.97017e-6                      $isoCu
      30064.80c 6.10696e-6 30066.80c 3.50368e-6 30067.80c 5.14878e-7
      30068.80c 2.35463e-6 30070.80c 7.78596e-8                      $Zn
c
