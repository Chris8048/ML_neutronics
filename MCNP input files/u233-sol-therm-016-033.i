...
c
c  This deck is case 33.
c
c Cell cards:
c
  1   1 9.98757419e-2  (-3  +2  -1) :                $soln in primary cylinder
...
c -- primary solution & cylinder
  1    cz   19.062   $Primary solution radius
  2    pz  257.35925 $Bottom of solution in primary cylinder (s24 + 48.26 + "e")
  3    pz  283.72425 $   Top of solution in primary cylinder (s2  + 26.365)
  4    cz   19.189   $Primary cylinder OR (s1 + 0.127)
  5    pz  255.9305  $Bottom of primary cylinder (s2 - 1.27 - "e")
  6    pz  438.95925 $   Top of primary cylinder (s2 + 181.60)
  7    pz  439.08625 $   Top of primary cylinder cap (s6 + 0.127)
  8    cz   22.225   $Primary cylinder top cap
c
c -- fill tube cylinder
 11   c/z   16.17275 0.00 2.62509  $Fill tube IR
 12   c/z   16.17275 0.00 3.01625  $Fill tube OR
c
...
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
c   m1                       92233.80c 3.2729e-4   92234.80c 3.4981e-6
c      92235.80c 8.6497e-8   92236.80c 3.3126e-9   92238.80c 4.5527e-6  $U
c       1001.80c 6.4193e-2                                              $H
c       7014.80c 7.17639e-4   7015.80c 2.65067e-6                       $N
c       8016.80c 3.48987e-2   8017.80c 1.32666e-5                       $O
c      90232.80c 4.2124e-6                                              $Th
c
...
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1                       92233.80c 1.1264e-4   92234.80c 1.2039e-6
      92235.80c 2.9769e-8   92236.80c 1.1401e-9   92238.80c 1.5669e-6  $U
       1001.80c 6.5695e-2                                              $H
       7014.80c 2.46988e-4   7015.80c 9.12272e-7                       $N
       8016.80c 3.38031e-2   8017.80c 1.28501e-5                       $O
      90232.80c 1.4498e-6                                              $Th
c
  mt1  lwtr.20t                                                        $h-h2o
c
