...
c
c - HEU and graphite:
  1    1  4.81578500e-2  ((-6 +3)  (-53 +52)):             $unit  1 HEU
                         ...
                         ( -7     ((-65 +64):              $unit  5 HEU
                                   ...
                                   (-77 +76)))             $unit  9 HEU
c
  2    2  8.64310000e-2  ((-7 +3) ((-52 +51):(-54 +53):    $unit  1 graphite
...
c  31  pz 117.32260   $configuration 2, top of upper reflector
   23  pz  19.61496   $configuration 3, bottom of platen
   24  pz  25.96496   $configuration 3, bottom of lower reflector
   25  pz  40.39216   $configuration 3, start lower HEU "unit cell"
   27  pz  57.70880   $configuration 3, end   lower HEU with alignment tube hole
   29  pz  79.35460   $configuration 3, end   upper HEU
   30  pz  79.59745   $configuration 3, start upper reflector
   31  pz  94.02445   $configuration 3, top of upper reflector
...
c     - configuration 3:
   51  pz  40.39216
   52  pz  42.40688  $(s51+4.02944)
   53  pz  42.70660  $(s52+0.29972)
   54  pz  44.72132  $(s53+4.02944), end unit 1
   55  pz  46.73604  $(s54+4.02944)
   56  pz  47.03576  $(s55+0.29972)
   57  pz  49.05048  $(s56+4.02944), end unit 2
   58  pz  51.06520  $(s57+4.02944)
   59  pz  51.36492  $(s58+0.29972)
   60  pz  53.37964  $(s59+4.02944), end unit 3
   61  pz  55.39436  $(s60+4.02944)
   62  pz  55.69408  $(s61+0.29972)
   63  pz  57.70880  $(s62+4.02944), end unit 4
   64  pz  59.72352  $(s63+4.02944)
   65  pz  60.02324  $(s64+0.29972)
   66  pz  62.03796  $(s65+4.02944), end unit 5
   67  pz  64.05268  $(s66+4.02944)
   68  pz  64.35240  $(s67+0.29972)
   69  pz  66.36712  $(s68+4.02944), end unit 6
   70  pz  68.38184  $(s69+4.02944)
   71  pz  68.68156  $(s70+0.29972)
   72  pz  70.69628  $(s71+4.02944), end unit 7
   73  pz  72.71100  $(s72+4.02944)
   74  pz  73.01072  $(s73+0.29972)
   75  pz  75.02544  $(s74+4.02944), end unit 8
   76  pz  77.04016  $(s75+4.02944)
   77  pz  77.33988  $(s76+0.29972)
   78  pz  79.35460  $(s77+4.02944), end unit 9
c
c     - configuration 4:
c  51  pz  50.76548
...
c    For m1 (configuration 3): (HEU, 4.81578500e-2)
   m1 92234.80c 4.9568e-4  92235.80c 4.4930e-2  92236.80c 1.5647e-4
      92238.80c 2.5757e-3                                            $HEU
c
