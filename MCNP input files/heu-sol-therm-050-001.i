HST050.1, 9/30/2005 (Rev. 0)
c
c  Heu-Sol-Therm-050 case 1 (cylindrical, bare homogenous solution).
c  Benchmark model keff is 0.9953(86).
c
c   Cell cards
c
 1   1 9.89127279e-2   -7 +6  -1           $solution
...
c   Surface cards
c
 1   cz   11.1252  $solution radius
 2   cz   11.2014  $heresite liner radius
 3   cz   11.36015 $container outer radius
 4   pz   -1.3462  $container bottom
 5   pz   -0.0762  $heresite liner
 6   pz    0.00    $solution bottom
 7   pz  218.5     $solution (and tank) height
...
c     m3   = 2S aluminum
c
c    For m1 (9.89127279e-2):
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.3463e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - hh2o.20t is rem continuous kernel 
   m1 92234.80c 1.6920e-5   92235.80c 1.3774e-3   92238.80c 8.2592e-5  $HEU
       1001.80c 6.1019e-2                                              $H
       8016.80c 3.34503e-2   8017.80c 1.27159e-5                       $16,17O
       9019.80c 2.9538e-3                                              $19F
  mt1  lwtr.20t
c
