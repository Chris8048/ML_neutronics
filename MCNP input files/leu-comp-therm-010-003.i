Leu-Comp-Therm-010.3, rev0, 8/31/1996.
c
...
c   Note, for case 6 the lattice is 12 x 8, not 13 x 8.
  101   px  -97.955  $left   model boundary (s102 - 30.5)
  102   px  -67.445  $left   cluster, left  boundary (s103 - 13*2.54)
  103   px  -34.425  $left   cluster, right boundary (s104 - 17.915)
  104   px  -16.51   $center cluster, left  boundary (-0.5*13*2.54)
  105   px   16.51   $center cluster, right boundary ( 0.5*13*2.54)
  106   px   34.425  $right  cluster, left  boundary (s105 + 17.915)
  107   px   67.445  $right  cluster, right boundary (s106 + 13*2.54)
  108   px   97.955  $right  model boundary (s107 + 30.5)
...
c   surfaces 152 and 153, respectively.
  161   py  -21.681  $(s162 - [10.2(lead), 7.65(deplU) or 17.85(steel)]
