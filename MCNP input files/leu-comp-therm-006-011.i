Leu-Comp-Therm-006.11, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 11, N=18, pitch=2.15):
 101   px  -49.350   $(s102-30.0), model boundary
 102   px  -19.350   $(-N*pitch/2), start lattice
 103   px   19.350   $( N*pitch/2),   end lattice
 104   px   49.350   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -49.350   $(s152-30.0), model boundary
 152   py  -19.350   $(-N*pitch/2), start lattice
 153   py   19.350   $( N*pitch/2),   end latticeh)
 154   py   49.350   $(s153+30.0), model boundary
c
