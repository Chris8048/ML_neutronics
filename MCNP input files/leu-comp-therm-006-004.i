Leu-Comp-Therm-006.4, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 4, N=17, pitch=1.956):
 101   px  -46.626   $(s102-30.0), model boundary
 102   px  -16.626   $(-N*pitch/2), start lattice
 103   px   16.626   $( N*pitch/2),   end lattice
 104   px   46.626   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -46.626   $(s152-30.0), model boundary
 152   py  -16.626   $(-N*pitch/2), start lattice
 153   py   16.626   $( N*pitch/2),   end latticeh)
 154   py   46.626   $(s153+30.0), model boundary
c
