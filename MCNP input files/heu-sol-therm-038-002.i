...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 2 is POLY-2 above Tank #2, then void to Tank #1
  81   0                 -61 +60 -14 +13  -96 +83   +95 $top poly-2 to bottom E,F
  82   0                 -61 +60 -14 +13  -71 +96       $bottom tank #1 to top poly-2
...
c     the relative spacings do not change.
  71  pz   53.93817  $(s96+1.55702), bottom of Tank #1
  72  pz   54.90616  $(s71+0.96799), Tank #1 bottom plate
  73  pz   63.80683  $(s72+8.90067), Tank #1 internal height
  74  pz   64.76822  $(s73+0.96139), top of Tank #1
  81  pz   54.60822  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   62.22822  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   52.06822  $(s82-10.16),                  bottom of support bars E & F
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   64.76822  $extra z-plane for possible upper reflector/top of model
