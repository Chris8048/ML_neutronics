...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 10 is BP-7 above Tank #2
...
c
c     - case 10 is POLY-2 above Tank #1
...
c     the relative spacings do not change.
  71  pz   56.66867  $(s96+7.78256), bottom of Tank #1
  72  pz   57.63666  $(s71+0.96799), Tank #1 bottom plate
  73  pz   66.53733  $(s72+8.90067), Tank #1 internal height
  74  pz   67.49872  $(s73+0.96139), top of Tank #1
  81  pz   57.33872  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   64.95872  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   54.79872  $(s82-10.16),                  bottom of support bars E & F
c
...
c   - radius and height for POLY-2 (above Tank #1)
  ...
  99  pz   72.20788  $(s74+4.70916), top of poly-2
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   72.20788  $extra z-plane for possible upper reflector/top of model
