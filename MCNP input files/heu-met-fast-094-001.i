...
c          99: outside world
c
  1    1  4.79569763e-2    -4  (    (-42 +41):   $HEU, u3
                                    (-38 +37):   $HEU, u2
                                    (-34 +33):   $HEU, u1
                                (+1  -51 +52):   $HEU, l1
                                    (-55 +56):   $HEU, l2
                                    ...
                                    (-63 +64))   $HEU, l4
c
  2    2  6.41409100e-2    -3      ((-40 +39):   $Mo, u3
                                    (-36 +35):   $Mo, u2
                                    (-32 +31):   $Mo, u1
                                    (-53 +54):   $Mo, l1
                                    (-57 +58):   $Mo, l2
                                    (-61 +62))   $Mo, l3
c
  3    3  5.05355991e-2    -4 +3   ((-40 +39):   $Mo ring, u3
                                    (-36 +35):   $Mo ring, u2
                                    (-32 +31):   $Mo ring, u1
                                    (-53 +54):   $Mo ring, l1
                                    (-57 +58):   $Mo ring, l2
                                    (-61 +62))   $Mo ring, l3
c
  4    7  1.20885003e-1    -4      ((-37 +36):   $Be, u4
                                    (-35 +34):   $Be, u3
                                    (-33 +32):   $Be, u2
                                    (-31 +21):   $Be, u1
                                    (-52 +53):   $Be, l1
                                    ...
                                    (-62 +63))   $Be, l6
c
  5    9  1.38169952e-1    -4      ((-39 +38):
                                    (-41 +40))   $BeO interstitial moderator
c
  6    8  1.22327298e-1    -4      ((-43 +42):
                                    (-64 +65))   $Be axial reflectors
c
 11    6  8.26244336e-2    -10 +9  -27 +28          $St3  support ring
 12    6  8.26244336e-2    -10 +6  -26 +27          $St3  platen
 13    4  8.48891786e-2     -4     -65 +66          $St30 plate
 14    5  8.78384466e-2     -7 +4  -24 +22 
                                     (+5:(-23 +21)) $Special steel diaphragm
 15   11  4.82730059e-2     -8 +5  -25 +24          $deplU radial reflector
 16   11  4.82730059e-2     -8 +7  -24 +22          $deplU radial reflector
 17   11  4.82730059e-2     -8 +5  -22 +26          $deplU radial reflector
c
 21    0                    -9     -27 +28  $support ring void
 22    0                    -6     -26 +27  $platen void
 23    0                    -5     -66 +26  $below plate, above platen
 24    0                    -5     -25 +43  $upper axial reflector void
 25    0                   -10 +8  -25 +26  $radial void
 26    0                    -5 +4  -43 +23  $radial void (upper fuel/reflector)
 27    0                    -5 +4  -51 +66  $radial void (lower fuel/reflector)
 28    0                    -5     -21 +51  $Hcr
 29    0                    -1     -51 +52  $source hole
c
...
c
  ...
  25    pz  25.8    $(s24+25),     Top of radial reflector (Case 1)
c 25    pz  35.8    $(s24+35),     Top of radial reflector (Case 2)
  26    pz -34.2    $(s24-35),  Bottom of radial reflector
  27    pz -36.8    $(s26-2.6), Bottom of platen
  28    pz -38.2    $(s27-1.4), Bottom of support ring
c
  31    pz   0.99   $(s21+0.99),  Be  (upper 1)
  32    pz   1.533  $(s31+0.543), Mo  (upper 1)
  33    pz   2.523  $(s32+0.99),  Be  (upper 2)
  34    pz   3.523  $(s33+1.000), HEU (upper 1)
  35    pz   4.513  $(s34+0.99),  Be  (upper 3)
  36    pz   5.050  $(s35+0.537), Mo  (upper 2)
  37    pz   6.040  $(s36+0.99),  Be  (upper 4)
  38    pz   7.040  $(s37+1.000), HEU (upper 2)
  39    pz   8.030  $(s38+0.99),  BeO (upper 1)
  40    pz   8.571  $(s39+0.541), Mo  (upper 3)
  41    pz   9.561  $(s40+0.99),  BeO (upper 2)
  42    pz  10.761  $(s41+1.200), HEU (upper 3)
  43    pz  20.721  $(s42+9.96),  Be upper reflector
c
  51    pz  -0.24   $Hcr (-0.24=case 1; -0.30=case 2)
  52    pz  -1.24   $(s51-1.000), HEU (lower 1)
  53    pz  -2.23   $(s52-0.99),  Be  (lower 1)
  54    pz  -2.765  $(s53-0.535), Mo  (lower 1)
  55    pz  -3.755  $(s54-0.99),  Be  (lower 2)
  56    pz  -4.755  $(s55-1.000), HEU (lower 2)
  57    pz  -5.745  $(s56-0.99),  Be  (lower 3)
  58    pz  -6.272  $(s57-0.527), Mo  (lower 2)
  59    pz  -7.262  $(s58-0.99),  Be  (lower 4)
  60    pz  -8.262  $(s59-1.000), HEU (lower 3)
  61    pz  -9.252  $(s60-0.99),  Be  (lower 5)
  62    pz  -9.800  $(s61-0.548), Mo  (lower 3)
  63    pz -10.790  $(s62-0.99),  Be  (lower 6)
  64    pz -11.790  $(s63-1.000), HEU (lower 4)
  65    pz -21.750  $(s64-9.96),  Be lower reflector
  66    pz -22.820  $(s65-1.07),  St30 plate
...
c     - natW  may be converted to isoW  (9.0231e-7)
  m1  92234.80c 5.5738e-4  92235.80c 4.5143e-2  92238.80c 1.3189e-3  $U
       6000.80c 7.3661e-5                                            $C
      13027.80c 2.8481e-4                                            $Al
      26054.80c 1.04175e-6 26056.80c 1.63533e-5 26057.80c 3.77669e-7
      26058.80c 5.02609e-8                                           $isoFe
      29063.80c 3.87698e-4 29065.80c 1.72802e-4                      $isoCu
      74180.80c 1.08277e-9
      74182.80c 2.39112e-7 74183.80c 1.29121e-7 74184.80c 2.76468e-7
      74186.80c 2.56527e-7                                           $isoW
...
c m1  92234.80c 5.5831e-4  92235.80c 4.5219e-2  92238.80c 1.3211e-3  $U
c      6000.80c 7.3784e-5                                            $C
c     13027.80c 3.7357e-4                                            $Al
c     26054.80c 1.04345e-6 26056.80c 1.63799e-5 26057.80c 3.78284e-7
c     26058.80c 5.03426e-8                                           $isoFe
c     29063.80c 1.88675e-4 29065.80c 8.40950e-5                      $isoCu
c     74180.80c 1.08457e-9
c     74182.80c 2.39510e-7 74183.80c 1.29335e-7 74184.80c 2.76927e-7
c     74186.80c 2.56953e-7                                           $isoW
c
c    For m2: (Case 1 Mo, 6.41409100e-2)
c     - natMo may be converted to isoMo (6.4141e-2)
  m2  42092.80c 9.51852e-3 42094.80c 5.93304e-3 42095.80c 1.02112e-2 $
      42096.80c 1.06987e-2 42097.80c 6.12547e-3 42098.80c 1.54772e-2 $
      42100.80c 6.17678e-3                                           $isoMo
c    For m2: (Case 2 Mo, 6.41480300e-2)
c     - natMo may be converted to isoMo (6.4148e-2)
c m2  42092.80c 9.51956e-3 42094.80c 5.93369e-3 42095.80c 1.02124e-2 $
c     42096.80c 1.06999e-2 42097.80c 6.12613e-3 42098.80c 1.54789e-2 $
c     42100.80c 6.17745e-3                                           $isoMo
c
...
c     - natZn may be converted to isoZn (2.0826e-5)
  m3  13027.80c 4.6692e-2                                            $Al
      12024.80c 2.78827e-3 12025.80c 3.52990e-4 12026.80c 3.88642e-4 $isoMg
      14028.80c 4.47213e-5 14029.80c 2.27084e-6 14030.80c 1.49695e-6 $isoSi
      22046.80c 9.38603e-7 22047.80c 8.46449e-7 22048.80c 8.38712e-6 $
      22049.80c 6.15496e-7 22050.80c 5.89329e-7                      $isoTi
      25055.80c 1.7352e-4                                            $Mn
      26054.80c 2.85061e-6 26056.80c 4.47484e-5 26057.80c 1.03344e-6 $
      26058.80c 1.37531e-7                                           $isoFe
      29063.80c 7.41157e-6 29065.80c 3.30343e-6                      $isoCu
      30064.80c 1.01277e-5 30066.80c 5.81045e-6 30067.80c 8.53866e-7 $
      30068.80c 3.90488e-6 30070.80c 1.29121e-7                      $isoZn
...
c m3  13027.80c 4.6616e-2                                            $Al
c     12024.80c 2.78377e-3 12025.80c 3.52420e-4 12026.80c 3.88014e-4 $isoMg
c     14028.80c 4.46484e-5 14029.80c 2.26714e-6 14030.80c 1.49451e-6 $isoSi
c     22046.80c 9.37035e-7 22047.80c 8.45035e-7 22048.80c 8.37312e-6 $
c     22049.80c 6.14468e-7 22050.80c 5.88344e-7                      $isoTi
c     25055.80c 1.7324e-4                                            $Mn
c     26054.80c 2.84599e-6 26056.80c 4.46759e-5 26057.80c 1.03176e-6 $
c     26058.80c 1.37309e-7                                           $isoFe
c     29063.80c 7.39981e-6 29065.80c 3.29819e-6                      $isoCu
c     30064.80c 1.01111e-5 30066.80c 5.80097e-6 30067.80c 8.52472e-7 $
c     30068.80c 3.89850e-6 30070.80c 1.28910e-7                      $isoZn
c
...
c     - natO may be converted to 16,17O (where 16 = 16+18) (1.0350e-3)
  m7   4009.80c 1.1985e-1                                            $Be
       8016.80c 1.03461e-3  8017.80c 3.93300e-7                      $isoO
c    For m7: (Case 2 Be moderator, 1.21651596e-1)
c     - be.20t is ENDF71SaB kernel
c     - natO may be converted to 16,17O (where 16 = 16+18) (1.0416e-3)
c m7   4009.80c 1.2061e-1                                            $Be
c      8016.80c 1.04120e-3  8017.80c 3.95808e-7                      $isoO
...
c     - natO may be converted to 16,17O (where 16 = 16+18) (1.0473e-3)
  m8   4009.80c 1.2128e-1                                            $Be
       8016.80c 1.04690e-3  8017.80c 3.97974e-7                      $isoO
c    For m8: (Case 2 Be end reflector, 1.22579499e-1)
c     - be.20t is ENDF71SaB kernel
c     - natO may be converted to 16,17O (where 16 = 16+18) (1.0495e-3)
c m8   4009.80c 1.2153e-1                                            $Be
c      8016.80c 1.04910e-3  8017.80c 3.98810e-7                      $isoO
...
c     - natO may be converted to 16,17O (where 16 = 16+18) (6.9085e-2)
  m9   4009.80c 6.9085e-2                                            $Be
       8016.80c 6.90587e-2  8017.80c 2.62523e-5                      $isoO
...
c m9   4009.80c 6.9554e-2                                            $Be
c      8016.80c 6.95276e-2  8017.80c 2.64305e-5                      $isoO
c
c    For m10 (Case 2 only, BeO end reflector, 1.38801972e-1)
c     - be-o.20t & o-be.20t are ENDF71SaB kernels
c     - natO may be converted to 16,17O (where 16 = 16+18) (6.9401e-2)
c m10  4009.80c 6.9401e-2                                            $Be
c      8016.80c 6.93746e-2  8017.80c 2.63724e-5                      $isoO
...
c     - natSi may be converted to isoSi (3.2477e-4)
  m11 92235.80c 2.4231e-4  92238.80c 4.7611e-2                       $deplU
       6000.80c 9.4926e-5                                            $C
      14028.80c 2.99534e-4 14029.80c 1.52096e-5 14030.80c 1.00263e-5 $isoSi
c    For m11 (Case 2 deplU radial reflector, 4.82060940e-2):
c     - natSi may be converted to isoSi (3.2432e-4)
c m11 92235.80c 2.4198e-4  92238.80c 4.7545e-2                       $deplU
c      6000.80c 9.4794e-5                                            $C
c     14028.80c 2.99119e-4 14029.80c 1.51886e-5 14030.80c 1.00124e-5 $isoSi
c
c
print -175

C    k(bmk) = 0.9994 +- 0.0012
