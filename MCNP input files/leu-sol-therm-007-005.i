Leu-Sol-Therm-007.5 (run 49), rev0, 9/30/1999.
c
c  Benchmark model keff is 0.9994(8).
c
c  This deck is case 5 (run 49).
c
c  Cell specifications:
c
1   1 9.88595061e-2   -7 +6  -1         $solution
...
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.7431e-2)
c     - lwtr.20t is ENDF71SaB kernel
 m1  92234.80c 4.9795e-7  92235.80c 6.1792e-5  92236.80c 6.1715e-8  $234,235,236U
     92238.80c 5.5039e-4                                            $238U
      ...
      8016.80c 3.7417e-2   8017.80c 1.4224e-5                       $16,17O
      1001.80c 5.8223e-2                                            $H
 mt1  lwtr.20t                                                      $kernel
c
c    For m2:
