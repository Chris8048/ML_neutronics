...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 23 is a poly-1, ss and poly-6 plate above Tank #2,
c       then void to Tank #1
  ...
  85  17 8.66362741e-2                    -94 +92  -93 $ss plate
...
c     the relative spacings do not change.
  71  pz   54.78653  $(s96+3.01244), bottom of Tank #1
...
c
c   - radius and height for POLY-1, SS and POLY-6 plates
c     (above Tank #2)
  91  cz   35.42605  $(70.36816/2), poly-1 plate radius
  92  pz   48.97247  $(s6+1.30048), top of poly-1 plate
  93  cz   38.09619  $(76.19238/2), ss radius
  94  pz   49.61001  $(s92+0.63754), top of ss
