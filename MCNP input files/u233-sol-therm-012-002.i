...
c
c  This deck is case 2 (detailed).
c
c Cell cards:
c
  1   1 9.77479005e-2  (-1 -3) :              $partially filled sphere
                       (+1 -4 -3 +14)         $solution in fill pipe
  2   2 9.99999665e-2  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
...
c
  ...
  3   pz   7.4292  $solution height ([A] - s1)
...
c
c
c    For m1 (9.77479005e-2):
c     - natN may be converted to 14,15N                    (1.1379e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4926e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 3.1972e-9   92233.80c 4.7992e-4   92234.80c 5.1295e-6
      92235.80c 1.2684e-7   92236.80c 4.8576e-9   92238.80c 6.6759e-6  $U
       1001.80c 6.1186e-2                                              $H
       7014.80c 1.13371e-3   7015.80c 4.18747e-6                       $N
       8016.80c 3.49127e-2   8017.80c 1.32719e-5                       $O
      90232.80c 6.1708e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (9.99999665e-2)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3333e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6667e-2                                              $H
       8016.80c 3.33203e-2   8017.80c 1.26665e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
