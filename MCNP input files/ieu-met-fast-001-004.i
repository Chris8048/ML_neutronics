...
c
c   Cell cards
c   - cells 1 through 17 define the lower fuel
   ...
   16    0                 -66 +51   -2     $Lower disk/filler void
   17    0                 -51 +81   -8     $Lower filler void (bottom)
c   - cells 33 through 47 plus 59 define the upper fuel
   ...
   44    6  4.79733500e-2  -79 +78  -12 +2  $Upper Oy6 disk
   45    1  4.80506128e-2  -80 +79  -12 +2
                         (-111:-112)        $Upper Tu12disk (270deg)
   46    0                 -80 +79  -12 +2
                          +111 +112         $Upper Tu12 non-fuel
   47    3  4.71621639e-2  -96 +66   -2     $thin permanent Tu filler
   59    0                 -80 +96   -2     $
c
...
c
  121    0   +12  -80 +41  -22 +21  -24 +23   $radial void above upper ring
...
c
  999    0  +80:-25:+22:-21:+24:-23           $model boundary
c
c
...
c   - z-planes to define the Oy and Tu disks ...
  ...
  79    pz  25.548   $Upper Oy6 disk
  80    pz  26.152   $Upper Tu12 segment
c
