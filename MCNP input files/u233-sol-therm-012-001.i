...
c
c  This deck is case 1 (detailed).
c
c Cell cards:
c
  1   1 9.90274717e-2  (-1 -3) :              $partially filled sphere
                       (+1 -4 -3 +14)         $solution in fill pipe
  2   2 1.00060975e-1  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
...
c
  ...
  3   pz   6.7877  $solution height ([A] - s1)
 ...
 16   pz  38.6962  $reflector water height (s13 + [C])
...
c
c
c    For m1 (9.90274717e-2):
c     - natN may be converted to 14,15N                    (1.1967e-3)
...
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 3.3625e-9   92233.80c 5.0474e-4   92234.80c 5.3948e-6
      92235.80c 1.3340e-7   92236.80c 5.1088e-9   92238.80c 7.0212e-6  $U
       1001.80c 6.1833e-2                                              $H
       7014.80c 1.19230e-3   7015.80c 4.40386e-6                       $N
       8016.80c 3.54605e-2   8017.80c 1.34801e-5                       $O
      90232.80c 6.4899e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (1.00060975e-1)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3354e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6707e-2                                              $H
       8016.80c 3.33413e-2   8017.80c 1.26745e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
