Heu-Met-Fast-057.5, rev0, 9/30/2004.
c
...
c
  ...
  2   2 4.813414e-2   (+13:-12 : +1) -14 +11  -2     $heu cylinder
  3   0                -14 +11  +2 -3                $air gap
  4   3 3.28784963e-2 (-14 +11  +3 -4) :             $radial &
                      (((+15 -11) : (+14 -16))  -4)  $axial reflector
  5   0                +16:-15 : +4                  $outside world
c ------------------------------------------------------------------------------

c  Surface cards
  1   cz    0.55     $source radius
  2   cz    4.9405   $HEU radius
  3   cz    4.95     $Pb inner radius
  4   cz   18.3      $Pb outer radius
 11   pz  -19.9082   $HEU (and radial Pb) bottom
 12   pz   -0.45     $source bottom
 13   pz    0.45     $source top
 14   pz   19.9082   $HEU (and radial Pb) top
 15   pz  -33.9082   $Pb axial bottom
 16   pz   33.9082   $Pb axial top
c ------------------------------------------------------------------------------
