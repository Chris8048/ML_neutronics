...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 26 is BP-2 above Tank #2
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top bp-2
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  12 1.06463444e-1                    -96 +6   -95 $bp-2 plate
  84   0                 -12 +11 -14 +13  -96 +6   +95 $void
c
c     - case 26 is Be plates above Tank #1
   91  20 1.23220000e-1  (((-103 +102) (-114 +113)):
                          ((-104 +101) (-113 +112)):
                          ((-103 +102) (-112 +111))) (-99 +74)  $be plate
  92   0                 -12 +11 -14 +13  -99 +74  #91          $void
c
...
c
c   - the following surfaces, when combined with surfaces 51 - 53
c     and 61 - 74 define the upper tank (Tank #1) and its support
c     structure.  The z-plane coordinates are case dependent, but
c     the relative spacings do not change.
  71  pz   55.31993  $(s96+6.42366), bottom of Tank #1
  72  pz   56.28792  $(s71+0.96799), Tank #1 bottom plate
  73  pz   65.18859  $(s72+8.90067), Tank #1 internal height
  74  pz   66.14998  $(s73+0.96139), top of Tank #1
  81  pz   55.98998  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   63.60998  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   53.44998  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for BP-2 (above Tank #2)
  95  cz   35.85210  $(71.70420/2), bp-2 plate radius
  96  pz   48.89627  $(s6+1.22428), top of bp-2 plate
c
c   - x,y,z planes for Be (above Tank #1)
  99  pz   66.79768  $(s74+0.64770), top of be
 101  px  -36.3855   $2.54*(-28.65/2)
 102  px  -20.33016  $2.54*(-16.008/2)
 103  px   20.33016  $2.54*(+16.008/2)
 104  px   36.3855   $2.54*(+28.65/2)
 111  py  -34.88436  $2.54*(-5.73-(16.008/2))
 112  py  -20.33016  $2.54*(-16.008/2)
 113  py   20.33016  $2.54*(+16.008/2)
 114  py   34.88436  $2.54*(5.73+(16.008/2))
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   66.79768  $extra z-plane for possible upper reflector/top of model
