Pu-Sol-THERM-011, 18-inch sphere, case 6, rev 0, 8/31/1996
c
c Benchmark model keff is 1.0000(52) for all cases.
c
c This deck is for an 18-inch sphere, case 6.
c
c Cell cards:
c
 1    1  1.00319212e-1    -1  $Solution
...
c
c
c    For m1 (1.00319212e-1):
c     - natN  may be converted to isoN  (2.7753e-3)
c     - natO  may be converted to isoO  (3.7209e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.5204e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
   m1  94239.80c 6.6343e-5  94240.80c 2.8964e-6                       $239,240Pu
        1001.80c 6.0264e-2                                            $H
        7014.80c 2.7651e-3   7015.80c 1.0213e-5                       $N
        8016.80c 3.7195e-2   8017.80c 1.4139e-5                       $O
       26054.80c 8.8867e-8  26056.80c 1.3950e-6  26057.80c 3.2217e-8
       26058.80c 4.2875e-9                                            $isoFe
  mt1   lwtr.20t                                                      $S(a,b) 
c
