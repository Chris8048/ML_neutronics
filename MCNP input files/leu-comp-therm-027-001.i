Leu-Comp-Therm-027.1, rev1, 9/30/2000.
c
...
c 901  4  1.00062675e-1 ((-204 +203) ((-112 +115  -164 +162)
c                                     (-102:+103 : -152:+153)))
c
c - Air gap between core and lead walls (not used in case 1)
c 902  0                ((-205 +204) ((-112 +115  -164 +162)
c                                     (-102:+103 : -152:+153)))
c
...
c 21   pz    0.00  $ local z-origin
  ...
  29   pz   78.33  $ (Hc + s25 = 78.33, 75.07, 76.19 or 84.43)
...
c   1, 2, 3 & 4.  Some surfaces (112 & 115, for case 1) are redundant.
 ...
 111   px  -48.80  $bottom, left  lead (s103+e-60.0)
 112   px   11.20  $                   (s111  +60.0)
 113   px   41.20  $bottom, right lead (s112  +30.0)
 114   px   48.80  $   top, right lead (s102-e+60.0)
 115   px  -11.20  $                   (s114  -60.0)
 116   px  -41.20  $   top,  left lead (s115  -30.0)
c
...
c   1, 2, 3 & 4.  Some surfaces (162 & 164, for case 1) are redundant.
 ...
 161   py  -41.20  $bottom, left  lead (s152-e-30.0)
 162   py  -11.20  $                   (s161  +30.0)
 163   py  -48.80  $bottom, right lead (s153+e-60.0)
 164   py   11.20  $                   (s163  +60.0)
 165   py   41.20  $   top, right lead (s164  +30.0)
 166   py   48.80  $   top,  left lead (s162  +60.0)
c
...
c   per Table 1:  Hc = 75.13, 71.87, 72.99 & 81.23 for cases 1, 2, 3 & 4.
 ...
 204   pz   97.33  $water height (Hc + 3.2 + s203 = 97.33, 94.07, 95.19, 103.43)
...
c
c - cylindrical hole in support (pedestal) plate
 301   cz    4.2   $
c ------------------------------------------------------------------------------
...
c
 mode n
 imp:n 1 70r 0             $case 1 is 1 70r 0; cases 2, 3 &4 are 1 72r 0
 totnu
