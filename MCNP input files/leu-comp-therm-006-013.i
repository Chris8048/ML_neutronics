Leu-Comp-Therm-006.13, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 13, N=20, pitch=2.15):
 101   px  -51.500   $(s102-30.0), model boundary
 102   px  -21.500   $(-N*pitch/2), start lattice
 103   px   21.500   $( N*pitch/2),   end lattice
 104   px   51.500   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -51.500   $(s152-30.0), model boundary
 152   py  -21.500   $(-N*pitch/2), start lattice
 153   py   21.500   $( N*pitch/2),   end latticeh)
 154   py   51.500   $(s153+30.0), model boundary
c
