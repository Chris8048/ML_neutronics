...
c   Cell cards
  ...
  2    2  1.18737900e-1  -12 +11 -13 (+2:-1 : +3)  $reflector
 99    0                 +12:-11 : +13

c   Surface cards
c
  1    pz   0.0000  $bottom of core plane
  2    pz  17.4551  $   top of core plane
  3    cz   6.6675  $core radius
c
 11    pz  -2.5400  $bottom of reflector plane (s1 - 2.54)
 12    pz  19.9951  $   top of reflector plane (s2 + 2.54)
...
c
c    For m2 (1.18737900e-1):
c     - lwtr.20t & whtr.20t are ENDF71SaB kernels
c       - virtually no thermal collisions so water kernel usage is ok!
 m2    3006.80c 5.6460e-2   3007.80c 2.9091e-3                       $6,7Li
       1001.80c 2.3680e-4   1002.80c 5.9132e-2                       $H, D
 mt2   lwtr.20t hwtr.20t
c
c
print -175

C    k(bmk) = 0.9993 +- 0.0049
