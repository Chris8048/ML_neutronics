...
c
c   Cell cards
c   - cells 1 through 13 are unchanged for all cases; they cover from the
c     bottom of the model to the top of Tank #2 (the axially lower tank).
c
...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 1 is void between Tank #1 and Tank #2
...
c     the relative spacings do not change.
  71  pz   57.04967  $(s6+9.37768), bottom of Tank #1
  72  pz   58.01766  $(s71+0.96799), Tank #1 bottom plate
  73  pz   66.91833  $(s72+8.90067), Tank #1 internal height
  74  pz   67.87972  $(s73+0.96139), top of Tank #1
  81  pz   57.71972  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   65.43972  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   55.17972  $(s82-10.16),                  bottom of support bars E & F
c
c   - surfaces 91 and above, if present, define the various reflector
c     materials and associated void regions.
c
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   67.87972  $extra z-plane for possible upper reflector/top of model
