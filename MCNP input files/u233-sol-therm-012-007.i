...
c
c  This deck is case 7 (detailed).
c
c Cell cards:
c
  1   1 9.98350791e-2  (-1 -3) :              $partially filled sphere
                       (+1 -4 -3 +14)         $solution in fill pipe
  2   2 9.99329582e-2  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
...
c
  ...
  3   pz  13.8398  $solution height ([A] - s1)
...
c
c
c    For m1 (9.98350791e-2):
c     - natN may be converted to 14,15N                    (2.8526e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.3866e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 8.0149e-10  92233.80c 1.2031e-4   92234.80c 1.2859e-6
      92235.80c 3.1796e-8   92236.80c 1.2177e-9   92238.80c 1.6736e-6  $U
       1001.80c 6.5559e-2                                              $H
       7014.80c 2.84210e-4   7015.80c 1.04976e-6                       $N
       8016.80c 3.38531e-2   8017.80c 1.28691e-5                       $O
      90232.80c 1.5469e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (9.99329582e-2)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3311e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6622e-2                                              $H
       8016.80c 3.32983e-2   8017.80c 1.26582e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
