...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 20 is BP-2 above Tank #2
...
c
c     - case 20 is ss plate above Tank #1
  91  17 8.66362741e-2                    -99 +74  -98 $ss plate
...
c     the relative spacings do not change.
  71  pz   55.01767  $(s96+6.12140), bottom of Tank #1
  72  pz   55.98566  $(s71+0.96799), Tank #1 bottom plate
  73  pz   64.88633  $(s72+8.90067), Tank #1 internal height
  74  pz   65.84772  $(s73+0.96139), top of Tank #1
  81  pz   55.68772  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   63.30772  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   53.14772  $(s82-10.16),                  bottom of support bars E & F
c
...
c
c   - radius and height for SS (above Tank #1)
  98  cz   38.09619  $(76.19238/2), ss radius
  99  pz   66.48526  $(s74+0.63754), top of ss
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   66.48526  $extra z-plane for possible upper reflector/top of model
