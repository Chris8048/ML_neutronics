Leu-Comp-Therm-017.6, rev1, 9/30/1998.
c
...
c   center of center cluster is x=0.
  101   px -101.782  $left   model boundary (s102 - 30.5)
  102   px  -71.282  $left   cluster, left  boundary (s103 - 19*2.032)
  103   px  -32.674  $left   cluster, right boundary (s104 - 13.37)
  104   px  -19.304  $center cluster, left  boundary (-0.5*19*2.032)
  105   px   19.304  $center cluster, right boundary ( 0.5*19*2.032)
  106   px   32.674  $right  cluster, left  boundary (s105 + 13.37)
  107   px   71.282  $right  cluster, right boundary (s106 + 19*2.032)
  108   px  101.782  $right  model boundary (s107 + 30.5)
...
c   surfaces 152 and 153, respectively.
  161   py  -25.862  $s162 - [10.2(lead), 7.65(deplU) or 17.85(steel)]
  162   py  -18.212  $s152 - 1.956 cm separation
  163   py   18.212  $
  164   py   25.862  $
c
