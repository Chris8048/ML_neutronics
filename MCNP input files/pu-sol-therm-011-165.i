Pu-Sol-THERM-011, 16-inch sphere, case 5, rev 0, 8/31/1996
c
c Benchmark model keff is 1.0000(52) for all cases.
c
c This deck is for an 16-inch sphere, case 5.
c
c Cell cards:
c
 1    1  1.00258312e-1    -1  $Solution
...
c
c
c    For m1 (1.00258312e-1):
c     - natN  may be converted to isoN  (2.7369e-3)
c     - natO  may be converted to isoO  (3.7177e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.9302e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
   m1  94239.80c 1.0484e-4  94240.80c 4.5432e-6                       $239,240Pu
        1001.80c 6.0233e-2                                            $H
        7014.80c 2.7268e-3   7015.80c 1.0072e-5                       $N
        8016.80c 3.7163e-2   8017.80c 1.4127e-5                       $O
       26054.80c 1.1282e-7  26056.80c 1.7710e-6  26057.80c 4.0901e-8
       26058.80c 5.4432e-9                                            $isoFe
  mt1   lwtr.20t                                                      $S(a,b) 
c
