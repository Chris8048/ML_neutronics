Heu-Met-Fast-078.37, rev.0, 9/30/2006.
c
...
c
c   This deck is case 37.
c
c   Cell cards:
c
  1    1  4.58309000e-2   -2 +1  -3  $core cylinder
c
 11    2  8.5235e-2      -11 +2  -3  $upper reflector
c
...
c
  ...
  2    pz    5.9558  $   top of core plane
  3    cz   19.05    $core radius
c
 11    pz   36.4358  $   top of upper axial reflector (s2 + 30.48)
