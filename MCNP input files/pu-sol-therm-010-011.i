Pu-Sol-Therm-010.11 (12-1), rev1, 9/30/2004, 2.9a% 240Pu, 48.75 g Pu/l
c
...
c
  ...
  3     cz   14.9545    $Tamper IR
  4     cz   15.1120    $Tamper OR
  5     cz   15.2390    $Solution OR/Tank IR
  6     cz   15.3965    $            Tank OR
...
c
 ...
 14     pz   22.3520    $  End solution/Start tamper tank
 15     pz   22.5095    $Start tamper water (s14 + 0.1575)
 16     pz   52.9895    $  End tamper water (s15 + 30.48)
 17     pz   53.1470    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01520136e-1):
c     - natN  may be converted to isoN  (1.1295e-3)
c     - natO  may be converted to isoO  (3.5468e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (2.4047e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.1925e-4  94240.80c 3.5466e-6                       $239,240Pu
         1001.80c 6.4797e-2                                            $H
         7014.80c 1.1253e-3   7015.80c 4.1566e-6                       $N
         8016.80c 3.5455e-2   8017.80c 1.3478e-5                       $O
        26054.80c 1.4055e-7  26056.80c 2.2064e-6  26057.80c 5.0956e-8
        26058.80c 6.7813e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
...
c
c    For m3 (9.98726510e-2):
c     - natO  may be converted to isoO  (3.3291e-2)  (16+18O = 16O)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m3      1001.80c 6.6582e-2                                            $H
         8016.80c 3.3278e-2   8017.80c 1.2651e-5                       $O
 mt3     lwtr.20t                                                      $S(a,b)
c
c
c ******************************************************************************
