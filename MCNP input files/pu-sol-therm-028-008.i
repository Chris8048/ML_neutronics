PU-SOL-THERM-028.8, rev0, 9/30/2004, 3.22a% Pu240, 70.3 g Pu/l
c
...
c
c  This deck is case 8 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00800732e-1  -3 +2  -14 +13                  $Solution
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   65.17               $  End solution (ICSBEP Hc)
...
c
c
c    For m1 (1.00800732e-1): solution
c     - natN  may be converted to isoN  (1.9558e-3)
c     - natO  may be converted to isoO  (3.6393e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (7.0307e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.7115e-4  94240.80c 5.6787e-6  94241.80c 2.4587e-7  $239,40,41Pu
         1001.80c 6.2268e-2                                            $H
         7014.80c 1.9486e-3   7015.80c 7.1973e-6                       $isoN
         8016.80c 3.6379e-2   8017.80c 1.3829e-5                       $isoO
        26054.80c 4.1094e-7  26056.80c 6.4509e-6  26057.80c 1.4898e-7
        26058.80c 1.9827e-8                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
