Leu-Sol-Therm-007.4 (run 36), rev0, 9/30/1999.
c
c  Benchmark model keff is 0.9994(8).
c
c  This deck is case 4 (run 36).
c
c  Cell specifications:
c
 1   1 9.89475829e-2   -7 +6  -1        $solution
...
c
c    For m1:
c     - natN may be converted to 14,15N                    (2.6292e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.7560e-2)
c     - lwtr.20t is ENDF71SaB kernel
 m1  92234.80c 5.2265e-7  92235.80c 6.4857e-5  92236.80c 6.4776e-8  $234,235,236U
     92238.80c 5.7769e-4                                            $238U
      7014.80c 2.6195e-3   7015.80c 9.6755e-6                       $14,15N
      8016.80c 3.7546e-2   8017.80c 1.4273e-5                       $16,17O
      1001.80c 5.8115e-2                                            $H
 mt1  lwtr.20t                                                      $kernel
c
c    For m2:
