...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 14 is two boraflex plates above Tank #2, then void to Tank #1
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top boraflex plate
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  15 1.05309867e-1                    -96 +6   -95 $boraflex, 2-plate
...
c     the relative spacings do not change.
  71  pz   51.96459  $(s96+3.87604), bottom of Tank #1
  72  pz   52.93258  $(s71+0.96799), Tank #1 bottom plate
  73  pz   61.83325  $(s72+8.90067), Tank #1 internal height
  74  pz   62.79464  $(s73+0.96139), top of Tank #1
  81  pz   52.63464  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   60.25464  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   50.09464  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for two boraflex plates (above Tank #2)
  95  cz   35.13836  $(70.27672/2), boraflex plate radius
  96  pz   48.08855  $(s6+2*0.20828), top of two boraflex plates
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   62.79464  $extra z-plane for possible upper reflector/top of model
