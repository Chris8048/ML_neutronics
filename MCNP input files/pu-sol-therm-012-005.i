PU-SOL-THERM-012.5, rev2, 9/30/2000, 18.88a% Pu240, 13.2 g Pu/l
c
...
c
    1    1  1.00306483e-1  (+3 -4   +13 -14   +23 -24)           $Solution
c
...
c
 ...
 24     pz     66.15   $  end solution
 25     pz     86.15   $+z limit for reflector (s24 + 20.0, or s36 + 1.0)
...
c
 ...
 35     pz     67.15   $+z limit for bottom of lucoflex box (s24 + 1.0)
 36     pz     85.15   $-z limit for    top of lucoflex box (s35 + 18.0)
c ______________________________________________________________________________
...
c
c
c    For m1 (1.00306483e-1): (solution)
c     - natN  may be converted to isoN  (1.37165e-3)
c     - natO  may be converted to isoO  (3.53011e-2)  (16+18O = 16O)
c     - natCr may be converted to isoCr (1.14431e-6)
c     - natFe may be converted to isoFe (3.55846e-6)
c     - natNi may be converted to isoNi (8.11038e-7)
c     - poly.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 2.47132e-5  94240.80c 6.26195e-6  94241.80c 1.85624e-6
        94242.80c 3.74965e-7  95241.80c 2.01156e-7                      $Pu, Am
         1001.80c 6.35948e-2                                            $H
         7014.80c 1.36660e-3   7015.80c 5.04767e-6                      $isoN
         8016.80c 3.52877e-2   8017.80c 1.34144e-5                      $isoO
        24050.80c 4.97203e-8  24052.80c 9.58806e-7  24053.80c 1.08721e-7
        24054.80c 2.70629e-8                                            $isoCr
        26054.80c 2.07992e-7  26056.80c 3.26503e-6  26057.80c 7.54038e-8
        26058.80c 1.00349e-8                                            $isoFe
        28058.80c 5.52130e-7  28060.80c 2.12679e-7  28061.80c 9.24502e-9
        28062.80c 2.94772e-8  28064.80c 7.50697e-9                      $isoNi
 mt1     lwtr.20t                                                       $S(a,b)
c
