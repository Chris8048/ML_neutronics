PU-SOL-THERM-032.16, rev0, 9/30/2005,9.95a% Pu240, 35.3 g Pu/l
c
...
c
c  This deck is case 16 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00294561e-1  -3 +2  -14 +13                  $Solution
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   48.9                $  End solution (ICSBEP Hc - 0.1)
...
c
c
c    For m1 (1.00294561e-1): solution
c     - natN  may be converted to isoN  (1.5436e-3)
c     - natO  may be converted to isoO  (3.5579e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (5.8229e-7)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94238.80c 4.4650e-8  94239.80c 7.8806e-5  94240.80c 8.8201e-6
        94241.80c 1.1288e-6  94242.80c 7.9040e-8                       $Pu
         1001.80c 6.3083e-2                                            $H
         7014.80c 1.5379e-3   7015.80c 5.6804e-6                       $isoN
         8016.80c 3.5565e-2   8017.80c 1.3520e-5                       $isoO
        26054.80c 3.4035e-8  26056.80c 5.3427e-7  26057.80c 1.2339e-8
        26058.80c 1.6421e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
