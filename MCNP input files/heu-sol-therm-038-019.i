...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 19 is BP-2 above Tank #2
...
c
c     - case 19 is hot-rolled steel above Tank #1
  91  18 8.51396450e-2                    -99 +74  -98 $hot-rolled steel
...
c     the relative spacings do not change.
  71  pz   54.82717  $(s96+5.93090), bottom of Tank #1
  72  pz   55.79516  $(s71+0.96799), Tank #1 bottom plate
  73  pz   64.69583  $(s72+8.90067), Tank #1 internal height
  74  pz   65.65722  $(s73+0.96139), top of Tank #1
  81  pz   55.49722  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   63.11722  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   52.95722  $(s82-10.16),                  bottom of support bars E & F
c
...
c
c   - radius and height for Hot-Rolled Steel (above Tank #1)
  98  cz   35.21710  $(70.43420/2), hot-rolled steel radius
  99  pz   66.25158  $(s74+0.59436), top of hot-rolled steel
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   66.25158  $extra z-plane for possible upper reflector/top of model
