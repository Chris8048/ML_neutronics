...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 8 is BP-6 above Tank #2
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top bp-6
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  13 1.08686111e-1                    -96 +6   -95 $bp-6 plate
  84   0                 -12 +11 -14 +13  -96 +6   +95 $void
c
c     - case 8 is POLY-2 above Tank #1
...
c     the relative spacings do not change.
  71  pz   56.08447  $(s96+5.84454), bottom of Tank #1
  72  pz   57.05246  $(s71+0.96799), Tank #1 bottom plate
  73  pz   65.95313  $(s72+8.90067), Tank #1 internal height
  74  pz   66.91452  $(s73+0.96139), top of Tank #1
  81  pz   56.65452  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   64.37452  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   54.21452  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for BP-6 (above Tank #2)
  95  cz   35.85464  $(71.70928/2), bp-6 plate radius
  96  pz   50.23993  $(s6+2.56794), top of bp-6 plate
c
c   - radius and height for POLY-2 (above Tank #1)
  98  cz   34.29508  $(68.59016/2), poly-2 radius
  99  pz   71.62368  $(s74+4.70916), top of poly-2
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   71.62368  $extra z-plane for possible upper reflector/top of model
