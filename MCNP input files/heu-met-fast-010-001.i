...
c
c   Surface cards (case 1)
c
  1    cy   0.6            $source radius and lower HEU groove
  2    c/y  0.0 1.54 0.6   $upper HEU groove
...
c
 ...
 23    pz   1.34           $(s24-0.2), bottom of reflector support plate
 24    pz   1.54           $(s22+1.54), reflector support plate
 25    pz  12.54           $(s24+11.0), top of model
 26    pz  -0.15           $(s22-0.15), lower reflector boundary
 27    pz   1.69           $(s24+0.15), upper reflector boundary
c
 ...
 37    sz   1.54  7.55     $IR for movable HEU shell
 38    sz   1.54  8.35     $OR for movable HEU shell
 39    sz   1.54  9.15     $OR for movable boron shell
 40    sz   1.54 11.00     $OR for movable reflector shell
c
...
c     - natFe may be converted to isoFe                    (5.1049e-5)
 m2    4009.80c 1.2107e-1                                            $Be
       6000.80c 1.0042e-4                                            $C
       8016.80c 8.2210e-5   8017.80c 3.1252e-8                       $isoO
      26054.80c 2.9838e-6  26056.80c 4.6839e-5  26057.80c 1.0817e-6
      26058.80c 1.4396e-7                                            $isoFe
...
c m2    4009.80c 6.7675e-2                                            $Be
c       8016.80c 6.7649e-2   8017.80c 2.5717e-5                       $isoO
c mt2   be-o.20t o-be.20t                                             $BeO kernel
c
