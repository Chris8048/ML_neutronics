...
c  -  u=2 == fuel rodded cell:
   ...
   25    3  1.00168915e-1  +73  -43 +42  -53 +52  -36  u=2  $water
   26    5  5.122e-5       +73  -43 +42  -53 +52  +36  u=2  $air
   27    3  1.00168915e-1  +73 (+43:-42 : +53:-52) 
                                ((-36 +63):-62)        u=2  $water
...
c  -  u=3 == empty cell, just show water or air and grid:
   31    3  1.00168915e-1  -43 +42  -53 +52  -36  u=3  $water
   32    5  5.122e-5       -43 +42  -53 +52  +36  u=3  $air
   33    3  1.00168915e-1 (+43:-42 : +53:-52) 
                           ((-36 +63):-62)        u=3  $water
...
c  -  other structure:
  101    2  6.03983807e-2  -2     -38 +31
                          (+1:-32)          $Al tank
  102    4  1.00168915e-1  -1     -33 +32   $Lower axial water
  103    2  6.03983807e-2  -1     -34 +33   $Lower axial baseplate
  104    4  1.00168915e-1  -1     -36 +34
...
c - global z coordinates (per Figure 13)
   ...
   36  pz  120.64  $(s34+H), water height
...
c
c  m3 (1.00168915e-1, Case 2):
c  Unit cell H2O
c     - natO converted to 16,17O (where 16 = 16+18) (3.3417e-2, Case 7)
c     - lwtr.20t is ENDF71SaB kernel
  m3   1001.80c 6.6711e-2                                            $1H
       8016.80c 3.3404e-2   8017.80c 1.2698e-5                       $(16+18),17O
       5010.80c 8.2022e-6   5011.80c 3.3015e-5                       $10,11B
  mt3 lwtr.20t
c
c  m4 (1.00168915e-1, Case 2):
c  other H2O
c     - natO converted to 16,17O (where 16 = 16+18) (3.3417e-2, Case 7)
c     - lwtr.20t is ENDF71SaB kernel
  m4   1001.80c 6.6711e-2                                            $1H
       8016.80c 3.3404e-2   8017.80c 1.2698e-5                       $(16+18),17O
       5010.80c 8.2022e-6   5011.80c 3.3015e-5                       $10,11B
  mt4 lwtr.20t
c
