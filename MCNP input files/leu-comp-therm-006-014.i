Leu-Comp-Therm-006.14, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 14, N=15, pitch=2.293):
 101   px  -47.1975  $(s102-30.0), model boundary
 102   px  -17.1975  $(-N*pitch/2), start lattice
 103   px   17.1975  $( N*pitch/2),   end lattice
 104   px   47.1975  $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -47.1975  $(s152-30.0), model boundary
 152   py  -17.1975  $(-N*pitch/2), start lattice
 153   py   17.1975  $( N*pitch/2),   end latticeh)
 154   py   47.1975  $(s153+30.0), model boundary
c
