PU-SOL-THERM-032.14, rev0, 9/30/2005, 9.95a% Pu240, 45.1 g Pu/l
c
...
c
c  This deck is case 14 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00217755e-1  -3 +2  -14 +13                  $Solution
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   36.9                $  End solution (ICSBEP Hc - 0.1)
...
c
c
c    For m1 (1.00217755e-1): solution
c     - natN  may be converted to isoN  (1.6729e-3)
c     - natO  may be converted to isoO  (3.5751e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (7.5483e-7)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94238.80c 5.7046e-8  94239.80c 1.0069e-4  94240.80c 1.1269e-5
        94241.80c 1.4422e-6  94242.80c 1.0098e-7                       $Pu
         1001.80c 6.2680e-2                                            $H
         7014.80c 1.6667e-3   7015.80c 6.1563e-6                       $isoN
         8016.80c 3.5737e-2   8017.80c 1.3585e-5                       $isoO
        26054.80c 4.4120e-8  26056.80c 6.9259e-7  26057.80c 1.5995e-8
        26058.80c 2.1286e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
