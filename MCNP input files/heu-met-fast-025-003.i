...
c
  2    2  7.14642789e-2    -1  (    (-12 +11):   $lower core V
                                    (-33 +32))   $upper core V
c
...
c
  9    pz   0.02   $Hcr
c
 11    pz  -9.000  $bottom of lower V reflector
 12    pz  -5.000  $bottom of lower core
 13    pz  -1.000  $lower core, solid HEU boundary
 14    pz  -0.000  $lower core, upper boundary
c
 31    pz   0.020  $bottom of upper core
 32    pz   4.000  $   top of upper core
 33    pz   8.000  $   top of upper V reflector
c
 61    cz   9.995  $diaphragm inner radius
 62    cz  12.0
 63    cz  13.0
 64    pz   0.02   $bottom of diaphragm (=Hcr)
 65    pz   0.22   $s64 + 0.2
 66    pz   0.82   $s64 + 0.8
c
 71    cz  12.5
...
c
c    For m2: (Case 3 V, 7.14642789e-2)
c     - natN  may be converted to isoN  (1.2954e-5)
c     - natO  may be converted to isoO  (9.6396e-5)
c     - natSi may be converted to isoSi (1.6797e-4)
c     - natFe may be converted to isoFe (2.3717e-5)
 m2   23050.80c 1.77638e-4 23051.80c 7.08774e-2                      $isoV
       1001.80c 3.6004e-5                                            $H
       6000.80c 3.3234e-5                                            $C
       7014.80c 1.29063e-5  7015.80c 4.76707e-8                      $isoN
       8016.80c 9.63594e-5  8017.80c 3.66305e-8                      $isoO
      13027.80c 3.9004e-5                                            $Al
      14028.80c 1.54918e-4 14029.80c 7.86637e-6 14030.80c 5.18557e-6 $isoSi
      26054.80c 1.38626e-6 26056.80c 2.17613e-5 26057.80c 5.02563e-7
      26058.80c 6.68819e-8                                           $isoFe
c
