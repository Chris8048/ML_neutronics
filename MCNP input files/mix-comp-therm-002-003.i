Benchmark Model for Pu02 - MIX-COMP-THERM-002-003 (Experiment PNL-32)
C
C  Soluble boron concentration this trial = 0.9 ppm (M 4000)    DONE
C  Pin pitch this trial = 2.20914 cm                (S 301/302)       
C  Water reflector height this trial = 5.72 cm      (S 212)     DONE
C  Water reflector radius this trial = 60 cm        (S 092)     DONE
C  "Dimension A" of eggcrate = 0.08128 cm           (S 300)
C  "Dimension B" of eggcrate = 1.5621 cm            (S 300)
C  Map                                              (C 800)   
C  K(bmk)                                            (end)   
C
C
...
800       0                -301       LAT=1  U=9 IMP:n=1   $ 1 = Fuel, 2 = Water only
       ...
       2 2 2 2 2 2 2 2 1 2 1 2 1 2 1 2 2 2 2 2 2  
       2 2 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 2 2 
       2 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 2  
       ...
       2 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 2  
       2 2 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 1 2 2 2 
       2 2 2 2 2 2 1 2 1 2 1 2 1 2 2 2 2 2 2 2 2 
...
212  PZ 130.7160  $ Top of water reflector
C
299  RPP -0.74041 0.74041 -0.74041 0.74041 122.3925 124.9325  $ Top 'Eggcrate' boundary    
300  RPP -0.74041 0.74041 -0.74041 0.74041  33.1750  35.7150  $ Bottom 'Eggcrate' boundary
301  RPP -0.78105 0.78105 -0.78105 0.78105  32.8575 125.8215  $ Single unit lattice box [PITCH/2]
302  RPP -16.40205 16.40205 -16.40205 16.40205 32.8575 125.8215  $ Total lattice box [PITCH*(ROWS/2)]    
...
M4000   1001.80c  6.6706e-2 $ Borated water
        8016.80c  3.3353e-2 $ Density 0.997766 g/cc
        5010.80c  9.9034e-9
        5011.80c  4.0114e-8 
MT4000  lwtr.20t
