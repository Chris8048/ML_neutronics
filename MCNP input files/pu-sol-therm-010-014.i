Pu-Sol-Therm-010.14 (12-4), rev1, 9/30/2004, 2.9a% 240Pu, 31.14 g Pu/l
c
...
c
 ...
 14     pz   33.4264    $  End solution/Start tamper tank
 15     pz   33.5839    $Start tamper water (s14 + 0.1575)
 16     pz   64.0639    $  End tamper water (s15 + 30.48)
 17     pz   64.2214    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01192670e-1):
c     - natN  may be converted to isoN  (1.1072e-3)
c     - natO  may be converted to isoO  (3.5285e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.6498e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 7.6172e-5  94240.80c 2.2655e-6                       $239,240Pu
         1001.80c 6.4720e-2                                            $H
         7014.80c 1.1031e-3   7015.80c 4.0745e-6                       $N
         8016.80c 3.5272e-2   8017.80c 1.3408e-5                       $O
        26054.80c 9.6431e-8  26056.80c 1.5138e-6  26057.80c 3.4959e-8
        26058.80c 4.6524e-9                                            $Fe
 mt1     lwtr.20t                                                      $S(a,b) 
c
...
c
c    For m3 (9.99026540e-2):
c     - natO  may be converted to isoO  (3.3301e-2)  (16+18O = 16O)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m3      1001.80c 6.6602e-2                                            $H
         8016.80c 3.3288e-2   8017.80c 1.2654e-5                       $O
 mt3     lwtr.20t                                                      $S(a,b)
c
c
c ******************************************************************************
