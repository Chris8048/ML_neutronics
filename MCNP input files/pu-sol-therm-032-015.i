PU-SOL-THERM-032.15, rev0, 9/30/2005, 9.95a% Pu240, 40.25 g Pu/l
c
...
c
c  This deck is case 15 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00352370e-1  -3 +2  -14 +13                  $Solution
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   41.3                $  End solution (ICSBEP Hc - 0.1)
...
c
c
c    For m1 (1.00352370e-1): solution
c     - natN  may be converted to isoN  (1.5998e-3)
c     - natO  may be converted to isoO  (3.5686e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (6.7934e-7)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94238.80c 5.0912e-8  94239.80c 8.9857e-5  94240.80c 1.0057e-5
        94241.80c 1.2871e-6  94242.80c 9.0123e-8                       $Pu
         1001.80c 6.2965e-2                                            $H
         7014.80c 1.5939e-3   7015.80c 5.8873e-6                       $isoN
         8016.80c 3.5672e-2   8017.80c 1.3561e-5                       $isoO
        26054.80c 3.9707e-8  26056.80c 6.2332e-7  26057.80c 1.4395e-8
        26058.80c 1.9157e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
