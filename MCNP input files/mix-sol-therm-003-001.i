Benchmark Model for Pu/U - MIX-SOL-THERM-003-001
C
C  CASE DATA:
C    Vessel internal radius: 12.7125 cm
C    Vessel internal height: 107.0 cm
C    Vessel side wall thickness: 0.20 cm
C    Solution height:   56.31 cm
C    Solution type: A, at rho = 0.998332
C
C
C -------
C  CELLS
C -------
10 1001 0.0998332     +20 -04 -01                    IMP:n=1 $ Solution 
...
C --------
C
01 CZ   12.7125  $ Vessel internal radius 
02 PZ   107.0    $ Vessel internal height
03 CZ   12.9125  $ Vessel outer radius (internal radius + wall thickness)
04 PZ   56.31    $ Height of solution
C
05 CZ   17.9125  $ Flange radius (outer radius + 5 cm)
06 CZ   12.5125  $ Inner radius of poly plug (inner radius - 0.2 cm)
07 PZ   56.627   $ Top of SS on poly plug (solution height + .317)
08 PZ   71.627   $ Top of poly plug (solution height + 15.317)
C
