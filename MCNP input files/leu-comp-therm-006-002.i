Leu-Comp-Therm-006.2, rev1, 9/30/1998.
c
...
c
   1   px   -0.9245  $local x-origin
   2   px    0.9245  $fuel rod unit cell
  11   py   -0.9245  $local y-origin
  12   py    0.9245  $fuel rod unit cell
c
...
c
c
c - global x coordinates (Case 2, N=20, pitch=1.849):
 101   px  -48.4900  $(s102-30.0), model boundary
 102   px  -18.4900  $(-N*pitch/2), start lattice
 103   px   18.4900  $( N*pitch/2),   end lattice
 104   px   48.4900  $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -48.4900  $(s152-30.0), model boundary
 152   py  -18.4900  $(-N*pitch/2), start lattice
 153   py   18.4900  $( N*pitch/2),   end latticeh)
 154   py   48.4900  $(s153+30.0), model boundary
c
