...
c Oil Level -11.7 mm from Top of Plutonium Hemisphere
c ------------------------------------------------------------------------
c
c CELL CARDS ****************************************************************
1     1 0.05122542      1 -2         imp:n=1 $ Plutonium Hemisphere
2     2 0.106743        (-1:2) -3 -4 5 imp:n=1 $ Surrounding Oil Medium
3     3 0.0000414621114 (-1:2) -3 4 -6 imp:n=1 $ Ambient Air
4     0                 3:-5:6       imp:n=0 $ The Great Void
