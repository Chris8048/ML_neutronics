PU-SOL-THERM-032.5, rev0, 9/30/2005, 9.95a% Pu240, 40.25 g Pu/l
c
...
c
c  This deck is case 5 (detailed, i.e., slanted bottom, model).
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   35.91               $  End solution (ICSBEP Hc - 0.1)
