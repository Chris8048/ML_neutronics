Pu-Sol-Therm-010.9 (11-6), rev1, 9/30/2004, 2.9a% 240Pu, 63.99 g Pu/l
c
...
c
  1     1  1.01875188e-1   -14 +13  -5                      $Solution
c
...
c
 ...
 14     pz   22.8092    $  End solution/Start tamper tank
 15     pz   22.9667    $Start tamper water (s14 + 0.1575)
 16     pz   53.4467    $  End tamper water (s15 + 30.48)
 17     pz   53.6042    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01875188e-1):
c     - natN  may be converted to isoN  (1.1762e-3)
c     - natO  may be converted to isoO  (3.5687e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (3.2134e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.5653e-4  94240.80c 4.6553e-6                       $239,240Pu
         1001.80c 6.4848e-2                                            $H
         7014.80c 1.1719e-3   7015.80c 4.3284e-6                       $N
         8016.80c 3.5673e-2   8017.80c 1.3561e-5                       $O
        26054.80c 1.8782e-7  26056.80c 2.9484e-6  26057.80c 6.8092e-8
        26058.80c 9.0618e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
