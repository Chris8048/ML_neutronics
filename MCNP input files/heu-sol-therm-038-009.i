...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 9 is BP-6 and BP-2 above Tank #2, then void to Tank #1
  81   0                 -61 +60 -14 +13  -96 +94   +95 $top bp-2 to bottom bp-2
  82   0                 -61 +60 -14 +13  -94 +83   +93 $top bp-6 to bottom E,F
  83   0                 -61 +60 -14 +13  -71 +96       $bottom tank #1 to top bp-2
  84  12 1.06463444e-1                    -96 +94   -95 $bp-2
  85  13 1.08686111e-1                    -94  +6   -93 $bp-6
  86   0                 -12 +11 -14 +13  -83  +6   +93 $void
c
c     - case 9 is POLY-2 above Tank #1
  91   9 1.17271000e-1                    -99 +74  -98 $poly-2
  92   0                 -12 +11 -14 +13  -99 +74  +98 $void
c
...
c     the relative spacings do not change.
  71  pz   51.85029  $(s96+0.38608), bottom of Tank #1
  72  pz   52.81828  $(s71+0.96799), Tank #1 bottom plate
  73  pz   61.71895  $(s72+8.90067), Tank #1 internal height
  74  pz   62.68034  $(s73+0.96139), top of Tank #1
  81  pz   52.52034  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   60.14034  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   49.98034  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for BP-6 (above Tank #2)
  93  cz   35.85464  $(71.70928/2), bp-6 plate radius
  94  pz   50.23993  $(s6+2.56794), top of bp-6 plate
  95  cz   35.85464  $(71.70420/2), bp-2 plate radius
  96  pz   51.46421  $(s94+1.22428), top of bp-2 plate
c
c   - radius and height for POLY-2 (above Tank #1)
  98  cz   34.29508  $(68.59016/2), poly-2 radius
  99  pz   67.38950  $(s74+4.70916), top of poly-2
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   67.38950  $extra z-plane for possible upper reflector/top of model
