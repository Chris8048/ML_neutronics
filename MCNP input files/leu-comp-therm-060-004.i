LCT60-N4-RBMK-DET - UNIFORM DRY CASE, 2% ENRICHED FUEL
c
c *** ack mods:
...
c    -- CELL CARDS --
c    FUEL PIN
1     1  6.92055461e-2 -1 -6 7 imp:n=1 u=1 $ fuel
...
76    4  8.42916231e-2  37 31  u=7 imp:n=1 $ graphite
...
90    0 -32 33 -34 35 imp:n=1 lat=1 u=15 fill=0:17 0:17 0:0
             ...
             12 12 12 12 12 12 12  7  7  7  7  7 12 12 12 12 12 12
             12 12 12 12 12 12 12  7  7  7  7  7 12 12 12 12 12 12
             12 12 12 12 11 12 12 12 12 12  7  7 12 12 56 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
...
c   -- DATA CARDS --
c    Material 1 - fuel U(1.8)O2 (Table 17), N=6.92055461e-2
c    - data are case dependent
c      - natO  converted to 16,17O (where 16 = 16+18) (4.6568e-2)
c      - natSi may be converted to isoSi              (1.5278e-6)
c      - natCr may be converted to isoCr              (8.2524e-7)
c      - natFe may be converted to isoFe              (2.8538e-6)
c      - natNi may be converted to isoNi              (2.0889e-7)
 m1  92234.80c 3.6266e-6   92235.80c 4.5811e-4   92236.80c 3.5824e-6   $  
     92238.80c 2.2160e-2                                               $
      8016.80c 4.65503e-2   8017.80c 1.76958e-5                        $isoO
     13027.80c 6.8156e-6                                               $Al
     14028.80c 1.40909e-6  14029.80c 7.15499e-8  14030.80c 4.71662e-8  $isoSi
     24050.80c 3.58567e-8  24052.80c 6.91460e-7  24053.80c 7.84061e-8  $
     24054.80c 1.95169e-8                                              $isoCr
     26054.80c 1.66805e-7  26056.80c 2.61848e-6  26057.80c 6.04720e-8  $
     26058.80c 8.04772e-9                                              $isoFe
     28058.80c 1.42206e-7  28060.80c 5.47774e-8  28061.80c 2.38114e-9  $
     28062.80c 7.59211e-9  28064.80c 1.93349e-9                        $isoNi
c
...
c    N(core) = 8.42916231e-2
c    - data are case dependent
c      - natMg may be converted to isoMg (2.5410e-7)
c      - natSi may be converted to isoSi (1.8024e-7)
c      - natFe may be converted to isoFe (3.8071e-8)
c      - natCu may be converted to isoCu (1.1153e-8)
c      - natCd may be converted to isoCd (1.3330e-9)
c      - grph.20t is ENDF71SaB kernel
 mt4  grph.20t
 m4   6000.80c 8.4291e-2                                               $natC
      5010.80c 5.2740e-9    5011.80c 2.1229e-8                         $10,11B
     12024.80c 2.00714e-7  12025.80c 2.54100e-8  12026.80c 2.79764e-8  $isoMg
     13027.80c 1.0882e-7                                               $Al
     14028.80c 1.66235e-7  14029.80c 8.44100e-9  14030.80c 5.56437e-9  $isoSi
     25055.80c 2.9117e-9                                               $Mn
     26054.80c 2.22525e-9  26056.80c 3.49317e-8  26057.80c 8.06724e-10 $
     26058.80c 1.07360e-10                                             $isoFe
     29063.80c 7.71453e-9  29065.80c 3.43847e-9                        $isoCu
     48106.80c 1.66625e-11 48108.80c 1.18637e-11 48110.80c 1.66492e-10 $
     48111.80c 1.70624e-10 48112.80c 3.21653e-10 48113.80c 1.62893e-10 $
     48114.80c 3.82971e-10 48116.80c 9.98417e-11                       $isoCd
c
