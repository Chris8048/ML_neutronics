Benchmark Model for Pu/U - MIX-SOL-THERM-003-004
C
C  CASE DATA:
C    Vessel internal radius: 25.360 cm
C    Vessel internal height: 91.5  cm
C    Vessel side wall thickness: 0.25 cm
C    Solution height:   16.05 cm
...
C --------
C
01 CZ   25.360   $ Vessel internal radius 
02 PZ   91.5     $ Vessel internal height
03 CZ   25.61    $ Vessel outer radius (internal radius + wall thickness)
04 PZ   16.05    $ Height of solution
05 CZ   40.61    $ Flange radius (outer radius + 5 cm)
06 CZ   25.16    $ Inner radius of poly plug (inner radius - 0.2 cm)
07 PZ   16.367   $ Top of SS on poly plug (solution height + .317)
08 PZ   31.367   $ Top of poly plug (solution height + 15.317)
C
