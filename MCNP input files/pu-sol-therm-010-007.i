Pu-Sol-Therm-010.7 (11-4), rev1, 9/30/2004, 2.9a% 240Pu, 41.73 g Pu/l
c
...
c
 ...
 14     pz   32.6390    $  End solution/Start tamper tank
 15     pz   32.7965    $Start tamper water (s14 + 0.1575)
 16     pz   63.2765    $  End tamper water (s15 + 30.48)
 17     pz   63.4340    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.00444768e-1):
c     - natN  may be converted to isoN  (2.0881e-3)
c     - natO  may be converted to isoO  (3.6370e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (2.7497e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.0213e-4  94240.80c 2.9835e-6                       $239,240Pu
         1001.80c 6.1879e-2                                            $H
         7014.80c 2.0804e-3   7015.80c 7.6842e-6                       $N
         8016.80c 3.6356e-2   8017.80c 1.3821e-5                       $O
        26054.80c 1.6072e-7  26056.80c 2.5230e-6  26057.80c 5.8266e-8
        26058.80c 7.7542e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b) 
c
...
c
c    For m3 (9.99186560e-2):
c     - natO  may be converted to isoO  (3.3306e-2)  (16+18O = 16O)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m3      1001.80c 6.6613e-2                                            $H
         8016.80c 3.3293e-2   8017.80c 1.2656e-5                       $O
 mt3     lwtr.20t                                                      $S(a,b)
c
c
c ******************************************************************************
