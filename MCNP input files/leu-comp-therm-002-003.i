Leu-Comp-Therm-002.3, rev0, 3/31/1995.
c
...
c
c - A 8 x 16 cluster plus 3 rods:
   22    0                 -105 +104  -153 +152  -204 +203
                           fill=11(0.00 0.00 +17.84)             $8x16 cluster
   23    0                 -105 +109  -155 +153  -204 +203
                           fill=11(0.00 0.00 +17.84)             $partial row
c
...
c   center of center cluster is x=0.
  101   px  -40.16  $left  model boundary (s104 - 30.0)
  104   px  -10.16  $left  boundary (-0.5*8*2.54)
  105   px   10.16  $right boundary ( 0.5*8*2.54)
  108   px   42.70  $right model boundary (s109 + 30.0)
  109   px    2.54  $boundary for partial row (s105-3*2.54)
c
c - global y coordinates:
c   center of center cluster is y=0.
  151   py  -50.32  $model   boundary (s152 - 30.0)
  152   py  -20.32  $cluster boundary (-0.5*16*2.54)
  153   py   20.32  $cluster boundary ( 0.5*16*2.54)
  154   py   52.86  $model   boundary (s155 + 30.0)
  155   py   22.86  $boundary for partial row (s153+2.54)
c
