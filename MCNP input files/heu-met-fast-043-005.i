...
c
  1    1  4.76679167e-2  -4    ((-26 +25):
                                ...
                                (-52 +53 +1):
                                (-53 +54))            $HEU (two zones)
  2    7  8.45068840e-2  -4    ((-27 +26):(-54 +55))  $axial reflector
c
...
c
 ...
 27    pz  23.720  $(s26+19.74),     top upper zone axial reflector (case 5)
c
 51    pz  -0.60   $(s21-0.6), top support ring thickness
 52    pz  -0.47   $(s21-0.47), Hcr
 53    pz  -1.470  $(s52-1.000),  first lower zone HEU
 54    pz  -5.445  $(s52-4.975), bottom lower zone HEU
 55    pz -25.365  $(s54-19.92), bottom lower zone axial reflector (case 5)
c
...
c
c    For m7: (St10, axial reflector, case 5, 8.45068840e-2)
c     - natSi may be converted to isoSi (4.5071e-4)
c     - natCr may be converted to isoCr (6.7625e-5)
c     - natFe may be converted to isoFe (8.3152e-2)
 m7    6000.80c 4.0985e-4                                            $C
      14028.80c 4.15688e-4 14029.80c 2.11077e-5 14030.80c 1.39143e-5 $isoSi
      24050.80c 2.93831e-6 24052.80c 5.66623e-5 24053.80c 6.42505e-6
      24054.80c 1.59933e-6                                           $isoCr
      25055.80c 4.2669e-4                                            $Mn
      26054.80c 4.86023e-3 26056.80c 7.62953e-2 26057.80c 1.76199e-3
      26058.80c 2.34489e-4                                           $isoFe
c
