LCT60-N3-RBMK-DET - UNIFORM FLOODED CASE, 2% ENRICHED FUEL
c
c *** ack mods:
c     *** turn on sdef and si cards;
c     *** modify m# to use generic (.80c) isotopic cross sections;
c         *** causes small change in material number densities
c             that are made to the cell cards.
c     *** modify mt# to use e71 continuous energy kernels;
c
c    -- CELL CARDS --
c    FUEL PIN
1     1  6.92263836e-2 -1 -6 7 imp:n=1 u=1 $ fuel
...
501   5  1.00142985e-1  4 24  imp:n=1 u=1 $ outside top cap
...
9    10  9.75011323e-2 -42  u=4 imp:n=1 $ grid spacer
10    5  1.00142985e-1  42  u=4 imp:n=1 $ above bottom grid spacer
...
24   12  6.27914259e-2 -10 11 22  u=6 imp:n=1 $ terminal grid, 150 g, and tails
25    5  1.00142985e-1  24 -11  u=6 imp:n=1  $ below frame tube and terminal grid
...
56   15  8.40795281e-2  5 -12 -29 23  u=7 imp:n=1  $ top coupling element
57   13  1.22221282e-2  12 -17 -29 23 u=7 imp:n=1  $ top coupling element
58   13  1.22221282e-2  17 -3 -84 23 u=7 imp:n=1  $ top coupling element above water
59    7  4.95969571e-5  -23 5 -3 u=7 imp:n=1 $ axial hole in top coupling element
60   14  8.58688335e-2  14 -13 -29 24 u=7 imp:n=1  $ bottom coupling element
61   14  8.58688335e-2  -14 -84 15 24 u=7 imp:n=1  $ bottom coupling element
62    8  4.32017578e-2  -24 15 -13 u=7 imp:n=1  $ caudal bolt inside bottom cplng elem
63    5  1.00142985e-1  5 -12 29 -36 u=7 imp:n=1     $ inside channel tube
64    7  4.95969571e-5  12 -17 29 -36 u=7 imp:n=1    $ inside channel tube
65    7  4.95969571e-5  17 -3 84 -36 u=7 imp:n=1  $ inside channel tube
66    5  1.00142985e-1  -5 29 13 -36 u=7 imp:n=1    $ inside channel tube
67    5  1.00142985e-1  14 -13 29 -36 u=7 imp:n=1   $ inside channel tube
68    5  1.00142985e-1  -14 15 84 -36 u=7 imp:n=1   $ inside channel tube
69    6  5.97853734e-2  36 -37 -91 38 u=7 imp:n=1 $ channel tube
70    0 -96 -80 3 fill=8 u=7 imp:n=1  $ transition details and clutch
71    0 80 -36 -91 fill=9 u=7 imp:n=1  $ hanger and tube
72    9  7.89570102e-2  91 93 -37 u=7 imp:n=1  $ lip of glass
73    7  4.95969571e-5 91 -93  u=7 imp:n=1  $ air at top of glass
74    7  4.95969571e-5  96 -80 3 -36 u=7 imp:n=1  $ inside channel tube
75    8  4.32017578e-2  -15 18 -21 u=7 imp:n=1  $ combined caudal nut and bolt
76    5  1.00142985e-1  -15 18 21 -36 u=7 imp:n=1  $ inside channel tube outside nut,bolt
77    5  1.00142985e-1  -18 38 -36 u=7 imp:n=1  $ air in channel below caudal bolt
78    4  8.42776230e-2  37 31  u=7 imp:n=1 $ graphite
79    6  5.97853734e-2  -38 -37 89  u=7 imp:n=1  $ channel bottom
80    5  1.00142985e-1  -38 -89  u=7 imp:n=1  $ axial hole in channel bottom
81    0  37 -31  fill=10 u=7 imp:n=1  $ steel below graphite
c
...
89   20  8.45826253e-2  37 31  imp:n=1  u=12 $ graphite
c
...
90    0 -32 33 -34 35 imp:n=1 lat=1 u=15 fill=0:17 0:17 0:0
             ...
             12 12 12 12 12 12 12  7  7  7  7 12 12 12 12 12 12 12
             12 12 12 12 12 12 12  7  7  7  7 12 12 12 12 12 12 12
             12 12 12 12 11 12 12 12 12 12 12 12 12 12 56 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
...
313  20  8.45826253e-2  37 31  imp:n=1  u=56 $ graphite
c
...
326  20  8.45826253e-2  37 31  imp:n=1  u=11 $ graphite
...
12  pz  365.2         $ top surface of water
...
c   -- DATA CARDS --
c    Material 1 - fuel U(1.8)O2 (Table 17), N=6.92263836e-2
c    - data are case dependent
c      - natO  converted to 16,17O (where 16 = 16+18) (4.6603e-2)
c      - natSi may be converted to isoSi              (1.5275e-6)
c      - natCr may be converted to isoCr              (8.2507e-7)
c      - natFe may be converted to isoFe              (2.8532e-6)
c      - natNi may be converted to isoNi              (2.0885e-7)
 m1  92234.80c 3.6263e-6   92235.80c 4.5807e-4   92236.80c 3.5821e-6   $  
     92238.80c 2.2152e-2                                               $
      8016.80c 4.65853e-2   8017.80c 1.77091e-5                        $isoO
     13027.80c 6.8143e-7                                               $Al
     14028.80c 1.40881e-6  14029.80c 7.15359e-8  14030.80c 4.71570e-8  $isoSi
     24050.80c 3.58493e-8  24052.80c 6.91318e-7  24053.80c 7.83899e-8  $
     24054.80c 1.95129e-8                                              $isoCr
     26054.80c 1.66770e-7  26056.80c 2.61793e-6  26057.80c 6.04593e-8  $
     26058.80c 8.04602e-9                                              $isoFe
     28058.80c 1.42179e-7  28060.80c 5.47669e-8  28061.80c 2.38068e-9  $
     28062.80c 7.59065e-9  28064.80c 1.93312e-9                        $isoNi
c
...
c    N(core) = 8.42776230e-2
c    - data are case dependent
c      - natMg may be converted to isoMg (2.5406e-7)
c      - natSi may be converted to isoSi (1.8021e-7)
c      - natFe may be converted to isoFe (3.8064e-8)
c      - natCu may be converted to isoCu (1.1151e-8)
c      - natCd may be converted to isoCd (1.3328e-9)
c      - grph.20t is ENDF71SaB kernel
 mt4  grph.20t
 m4   6000.80c 8.4277e-2                                               $natC
      5010.80c 5.2731e-9    5011.80c 2.1225e-8                         $10,11B
     12024.80c 2.00682e-7  12025.80c 2.54060e-8  12026.80c 2.79720e-8  $isoMg
     13027.80c 1.0880e-7                                               $Al
     14028.80c 1.66207e-7  14029.80c 8.43959e-9  14030.80c 5.56344e-9  $isoSi
     25055.80c 2.9112e-9                                               $Mn
     26054.80c 2.22484e-9  26056.80c 3.49252e-8  26057.80c 8.06576e-10 $
     26058.80c 1.07340e-10                                             $isoFe
     29063.80c 7.71315e-9  29065.80c 3.43785e-9                        $isoCu
     48106.80c 1.66600e-11 48108.80c 1.18619e-11 48110.80c 1.66467e-10 $
     48111.80c 1.70598e-10 48112.80c 3.21605e-10 48113.80c 1.62868e-10 $
     48114.80c 3.82913e-10 48116.80c 9.98267e-11                       $isoCd
c
...
c      - lwtr.20t is ENDF71SaB kernel (not used in air case!)
 ...
 m10 26054.80c 6.66564e-4  26056.80c 1.04636e-2  26057.80c 2.41651e-4  $
     ...
     28062.80c 5.66691e-5  28064.80c 1.44320e-5                        $isoNi
      1001.80c 5.3920e-2                                               $H (water)
      6000.80c 2.2857e-5                                               $natC
      8016.80c 2.69498e-2   8017.80c 1.02448e-5                        $isoO (water)
c     7014.80c 3.14578e-6   7015.80c 1.16192e-8                        $isoN (air)
c     8016.80c 8.47978e-6   8017.80c 3.22354e-9                        $isoO (air)
...
c      homogenized with   air:  N = 2.83635214e-6
...
c      - lwtr.20t is ENDF71SaB kernel (not used in dry case!)
 ...
 m12 40090.80c 1.43237e-2  40091.80c 3.12365e-3  40092.80c 4.77456e-3  $
     40094.80c 4.83859e-3  40096.80c 7.79520e-4                        $isoZr
      1001.80c 2.2963e-2                                               $H (water)
      8016.80c 1.14776e-2   8017.80c 4.36316e-6                        $isoO (water)
c     7014.80c 1.33965e-5   7015.80c 4.94813e-8                        $isoN (air)
c     8016.80c 3.61133e-6   8017.80c 1.37283e-9                        $isoO (air)
...
c      - lwtr.20t is ENDF71SaB kernel (not used in dry case!)
 ...
 m14 40090.80c 5.44753e-3  40091.80c 1.18797e-3  40092.80c 1.81584e-3  $
     40094.80c 1.84019e-3  40096.80c 2.96464e-4                        $isoZr
      1001.80c 5.0025e-2                                               $H (water)
      8016.80c 2.50035e-2   8017.80c 9.50494e-6                        $isoO (water)
c     7014.80c 2.91852e-5   7015.80c 1.07798e-7                        $isoN (air)
c     8016.80c 7.86721e-6   8017.80c 2.99068e-9                        $isoO (air)
...
c
c    Material 15 - Top coupling element, water (Table 29)
c    N = 8.40795281e-2
c    - same for all cases
c      - natZr may be converted to isoZr (1.1876e-2)
c      - natO  converted to 16,17O (where 16 = 16+18) (2.3964e-2)
c      - natFe may be converted to isoFe (1.7932e-6)
c      - natNi may be converted to isoNi (1.0428e-6)
c      - natHf may be converted to isoHf (1.2468e-6)
c      - lwtr.20t is ENDF71SaB kernel
 mt15 lwtr.20t
 m15 40090.80c 6.11020e-3  40091.80c 1.33249e-3  40092.80c 2.03673e-3  $
     40094.80c 2.06405e-3  40096.80c 3.32528e-4                        $isoZr
      1001.80c 4.7929e-2                                               $H
      8016.80c 2.39549e-2   8017.80c 9.10632e-6                        $isoO
     13027.80c 1.0310e-6                                               $Al
     26054.80c 1.04813e-7  26056.80c 1.64533e-6  26057.80c 3.79979e-8  $
     26058.80c 5.05682e-9                                              $isoFe
     28058.80c 7.09906e-7  28060.80c 2.73454e-7  28061.80c 1.18869e-8  $
...
c    0.46 times nominal impurities, homogenized with gaps
c    N(refl) = 8.45826253e-2
c    - data are case dependent
c      - natMg may be converted to isoMg (2.5498e-7)
c      - natSi may be converted to isoSi (1.8086e-7)
c      - natFe may be converted to isoFe (3.8202e-8)
c      - natCu may be converted to isoCu (1.1191e-8)
c      - natCd may be converted to isoCd (1.3376e-9)
c      - grph.20t is ENDF71SaB kernel
 mt20 grph.20t
 m20  6000.80c 8.4582e-2                                               $natC
      5010.80c 5.2922e-9    5011.80c 2.1302e-8                         $10,11B
     12024.80c 2.01409e-7  12025.80c 2.54980e-8  12026.80c 2.80733e-8  $isoMg
     13027.80c 1.0919e-7                                               $Al
     14028.80c 1.66807e-7  14029.80c 8.47004e-9  14030.80c 5.58351e-9  $isoSi
     25055.80c 2.9218e-9                                               $Mn
     26054.80c 2.23291e-9  26056.80c 3.50519e-8  26057.80c 8.09500e-10 $
     26058.80c 1.07730e-10                                             $isoFe
     29063.80c 7.74081e-9  29065.80c 3.45019e-9                        $isoCu
     48106.80c 1.67200e-11 48108.80c 1.19046e-11 48110.80c 1.67066e-10 $
     48111.80c 1.71213e-10 48112.80c 3.22763e-10 48113.80c 1.63455e-10 $
     48114.80c 3.84292e-10 48116.80c 1.00186e-10                       $isoCd
c
