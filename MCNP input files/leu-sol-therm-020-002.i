Leu-Sol-Therm-020.2 (case 217), rev.1, 9/30/2002.
c
c  Benchmark model keff is 0.9996(10).
c
c  This deck is case 2.
c
c  Cell specifications:
c
 1   1 9.93894732e-2   -7 +6  -1        $solution
...
c
c    For m1:
c     - natN may be converted to 14,15N                    (1.7265e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.6384e-2)
c     - lwtr.20t is ENDF71SaB kernel
 m1  92234.80c 4.6419e-7  92235.80c 5.7602e-5  92236.80c 5.7531e-8  $234,235,236U
     92238.80c 5.1307e-4                                            $238U
      7014.80c 1.7201e-3   7015.80c 6.3535e-6                       $14,15N
      8016.80c 3.6370e-2   8017.80c 1.3826e-5                       $16,17O
      1001.80c 6.0708e-2                                            $H
 mt1  lwtr.20t                                                      $kernel
c
c    For m2:
