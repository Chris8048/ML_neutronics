...
c
  ...
  2    2  1.17892000e-1  -13 +12     u=1                $poly
  3    3  8.41565612e-2  -12         u=1                $st10
c
  4    0                 -14 +11       u=2 fill=1 lat=1 $lower core unit cell
  5    like 4 but trcl=(0.0 0.0 1.355) u=3        lat=1 $upper core unit cell
c
 11    0                 -2     -15 +11  fill=2         $lower core
 12    1  4.76887170e-2  -2 +1  -16 +15                 $lower core HEU with source hole
...
c
 ...
 13    pz   2.46  $unit cell poly/HEU
 14    pz   3.455  $top of unit cell
 15    pz  17.275  $begin last lower core HEU
 16    pz  18.270  $top of lower core HEU
c
 21    pz  18.630  $begin upper core (pz16 + Hcr)
 22    pz  35.905  $  end upper core
 23    pz  18.830  $St10 diaphragm height (pz21 + 0.2)
 24    pz  19.430  $St10 diaphragm height (pz21 + 0.8)
c
...
c m2    6000.80c 3.9325e-02  1001.80c 7.8650e-02                      $C, H (case 1)
 m2    6000.80c 3.9297e-02  1001.80c 7.8595e-02                      $C, H (case 2)
 m2t   poly.20t
c
