...
c Cell cards:
c
  1   1 9.98145228e-2  -1 -4  $partially filled sphere
...
c
  1   so  18.4281  $Solution radius [R]
  2   so  18.5041  $Heresite liner outer radius (R + 0.076)
  3   so  18.6311  $Container outer radius (s2 + 0.127)
  4   pz  10.5659  $Solution height ([H] - [R])
c ------------------------------------------------------------------------------
...
c
c
c    For m1 (9.98145228e-2):
c     - natN may be converted to 14,15N                    (3.0781e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.3905e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
 m1   92232.80c 8.6487e-10  92233.80c 1.2983e-4   92234.80c 1.3876e-6
      92235.80c 3.4310e-8   92236.80c 1.3140e-9   92238.80c 1.8059e-6  $U
       1001.80c 6.5467e-2                                              $H
       7014.80c 3.06677e-4   7015.80c 1.13274e-6                       $N
       8016.80c 3.38921e-2   8017.80c 1.28839e-5                       $O
      90232.80c 1.6692e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
