Leu-Comp-Therm-017.11, rev1, 9/30/1998.
c
...
c
   35    9 8.51239172e-2   -112 +111  -211 +201               $Pb, deplU or steel
...
c   center of center cluster is x=0.
  101   px  -98.850  $left   model boundary (s102 - 30.5)
  102   px  -68.350  $left   cluster, left  boundary (s103 - 19*2.032)
  103   px  -29.742  $left   cluster, right boundary (s104 - 10.438)
  104   px  -19.304  $center cluster, left  boundary (-0.5*19*2.032)
  105   px   19.304  $center cluster, right boundary ( 0.5*19*2.032)
  106   px   29.742  $right  cluster, left  boundary (s105 + 10.438)
  107   px   68.350  $right  cluster, right boundary (s106 + 19*2.032)
  108   px   98.850  $right  model boundary (s107 + 30.5)
c - coordinates for lead, deplU or steel reflecting walls
  111   px  -73.65   $left  edge of reflecting wall (-82.00, -76.15, -73.65)
  112   px   73.65   $right edge of reflecting wall (+82.00, +76.15, +73.65)
c
...
c   surfaces 152 and 153, respectively.
  161   py  -34.766  $s162 - [10.2(lead), 7.65(deplU) or 17.85(steel)]
  162   py  -16.916  $s152 - 0.66 cm separation
  163   py   16.916  $
  164   py   34.766  $
c
