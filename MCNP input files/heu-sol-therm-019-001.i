HST019.1, 9/30/1998 (Rev. 2)
c
c  Heu-Sol-Therm-019 case 1 (cylindrical, reflected homogenous solution).
c  Benchmark model keff is 0.9991(41).
c
c   Cell cards
c
  1   1 9.73162479e-2   -5  +4   -1           $solution
...
c
  ...
  3   pz   56.6  $H3, solution tank bottom
  4   pz   57.0  $H4, solution bottom
  5   pz   79.6  $H5, solution height
 ...
 15   pz   78.6  $H6, reflector water height
...
c     m2   = steel tank
c
c    For m1 (9.73162479e-2):
c     - natN may be converted to 14,15N                    (2.6196e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.7719e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - hh2o.20t is rem continuous kernel 
   m1 92234.80c 1.0474e-5   92235.80c 1.0204e-3   92236.80c 2.5106e-6  $
      92238.80c 1.1123e-4                                              $U
       7014.80c 2.60996e-3   7015.80c 9.64013e-6                       $14,15N
       8016.80c 3.77047e-2   8017.80c 1.43332e-5                       $16,17O
       1001.80c 5.5833e-2                                              $H
  mt1  lwtr.20t
c
