...
c           3: St10 diaphragm
c           4: D16 upper support ring
c           5: D16 lower support ring
c       11-13: Hcr gap, lower core source hole and upper core void regions
c       21-28: other voids
c          99: outside world
c
  1    1  4.76056203e-2    -1  (    (-13 +12):   $lower core solid HEU
                                (+2  -14 +13):   $lower core HEU w/ source gap
                                (+3  -32 +31))   $upper core HEU
c
  2    2  7.21703250e-2    -1  (    (-12 +15):   $lower core inner V
                                    (-34 +32))   $upper core inner V
c
...
c
  6    5  7.15578160e-2    -1  (    (-15 +11):   $lower core outer V
                                    (-33 +34))   $upper core outer V
c
 11    0                   -1        -31 +14     $Hcr gap within fuel stack
c
 12    0                   -2        -14 +13     $source hole in lower core
c
 13    0                   -3        -32 +31     $plug hole in upper core
c
...
c
  9    pz   0.40   $Hcr
c
 11    pz -25.000  $bottom of lower V reflector
 12    pz  -5.000  $bottom of lower core
 13    pz  -1.000  $lower core, solid HEU boundary
 14    pz  -0.000  $lower core, upper boundary
 15    pz -15.000  $lower reflector V interface
c
 31    pz   0.400  $bottom of upper core
 32    pz   4.380  $   top of upper core
 33    pz  24.380  $   top of upper V reflector
 34    pz  14.380  $upper reflector V interface
c
 61    cz   9.995  $diaphragm inner radius
 62    cz  12.0
 63    cz  13.0
 64    pz   0.40   $bottom of diaphragm (=Hcr)
 65    pz   0.60   $s64 + 0.2
 66    pz   1.20   $s64 + 0.8
c
 71    cz  12.5
...
c     m5   = more V alloy.
c
c    For m1 (Case 3 & 5 HEU, 4.76056203e-2):
c     - natFe may be converted to isoFe (1.7941e-5)
c     - natW  may be converted to isoW  (9.0831e-7)
 m1   92234.80c 5.6109e-4  92235.80c 4.5444e-2  92238.80c 1.3277e-3  $U
       6000.80c 7.4151e-5                                            $C
      13027.80c 1.7983e-4                                            $Al
      26054.80c 1.04865e-6 26056.80c 1.64616e-5 26057.80c 3.80170e-7
      26058.80c 5.05936e-8                                           $isoFe
      74180.80c 1.08997e-9
      74182.80c 2.40702e-7 74183.80c 1.29979e-7 74184.80c 2.78306e-7
      74186.80c 2.58233e-7                                           $isoW
c
c    For m2: (Cases 4 & 5 V, 7.21703250e-2)
c            (axially for the innermost top and bottom 10")
...
c
c    For m5: (Case 5 V, 7.15578160e-2)
c            (axially for the outermost top and bottom 10")
c     - natN  may be converted to isoN  (1.2971e-5)
c     - natO  may be converted to isoO  (9.6522e-5)
c     - natSi may be converted to isoSi (1.6819e-4)
c     - natFe may be converted to isoFe (2.3748e-5)
 m5   23050.80c 1.77870e-4 23051.80c 7.09701e-2                      $isoV
       1001.80c 3.6052e-5                                            $H
       6000.80c 3.3278e-5                                            $C
       7014.80c 1.29233e-5  7015.80c 4.77333e-8                      $isoN
       8016.80c 9.64853e-5  8017.80c 3.66784e-8                      $isoO
      13027.80c 3.9055e-5                                            $Al
      14028.80c 1.55121e-4 14029.80c 7.87667e-6 14030.80c 5.19236e-6 $isoSi
      26054.80c 1.38807e-6 26056.80c 2.17897e-5 26057.80c 5.03220e-7
      26058.80c 6.69694e-8                                           $isoFe
c
c
print -175

C    k(bmk) = 0.9991 +- 0.0016
