...
c
c  This deck is case 5 (detailed).
c
c Cell cards:
c
  1   1 9.95009213e-2  (-1 -3) :              $partially filled sphere
                       (+1 -4 -3 +14)         $solution in fill pipe
  2   2 1.00025970e-1  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
...
c
  ...
  3   pz   8.7975  $solution height ([A] - s1)
...
c
c
c    For m1 (9.95009213e-2):
c     - natN may be converted to 14,15N                    (6.5863e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4523e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 1.8506e-9   92233.80c 2.7779e-4   92234.80c 2.9690e-6
      92235.80c 7.3414e-8   92236.80c 2.8117e-9   92238.80c 3.8641e-6  $U
       1001.80c 6.4031e-2                                              $H
       7014.80c 6.56206e-4   7015.80c 2.42376e-6                       $N
       8016.80c 3.45099e-2   8017.80c 1.31187e-5                       $O
      90232.80c 3.5717e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (1.00025970e-1)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3342e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6684e-2                                              $H
       8016.80c 3.33293e-2   8017.80c 1.26700e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
