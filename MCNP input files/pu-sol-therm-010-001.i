Pu-Sol-Therm-010.1 (9-1), rev1, 9/30/2004, 2.9a% 240Pu, 99.09 g Pu/l
c
...
c
 ...
 14     pz   30.7086    $  End solution/Start tamper tank
 15     pz   30.8661    $Start tamper water
 16     pz   61.3461    $  End tamper water
 17     pz   61.5036    $  End tamper tank
...
c
c
c    For m1 (1.02475095e-1):
c     - natN  may be converted to isoN  (1.3257e-3)
c     - natO  may be converted to isoO  (3.6174e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (4.0760e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 2.4251e-4  94240.80c 7.0846e-6                       $239,240Pu
         1001.80c 6.4722e-2                                            $H
         7014.80c 1.3208e-3   7015.80c 4.8786e-6                       $N
         8016.80c 3.6160e-2   8017.80c 1.3746e-5                       $O
        26054.80c 2.3824e-7  26056.80c 3.7399e-6  26057.80c 8.6370e-8
        26058.80c 1.1494e-8                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b) 
c
...
c
c    For m3 (9.99416590e-2):
c     - natO  may be converted to isoO  (3.3314e-2)  (16+18O = 16O)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m3      1001.80c 6.6628e-2                                            $H
         8016.80c 3.3301e-2   8017.80c 1.2659e-5                       $O 
 mt3     lwtr.20t                                                      $S(a,b)
c
c
c ******************************************************************************
