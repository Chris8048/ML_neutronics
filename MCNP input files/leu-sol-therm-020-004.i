Leu-Sol-Therm-020.4 (case 226), rev.1, 9/30/2002.
c
c  Benchmark model keff is 0.9998(12).
c
c  This deck is case 4.
c
c  Cell specifications:
c
 1   1 9.94398332e-2   -7 +6  -1        $solution
 2   2 4.94235258e-5   -8 +7  -1        $air above solution
...
c  Surface cards:
  ...
  3   cz  56.815   $reflector outer radius
  4   pz -32.06    $reflector bottom
  5   pz  -2.06    $container bottom
  6   pz   0.00    $solution bottom
  7   pz  81.09    $solution height
  8   pz 149.71    $internal container height
  9   pz 152.64    $top of container
 10   pz 172.64    $top of reflector
c ------------------------------------------------------------------------------
...
c
c    For m1:
c     - natN may be converted to 14,15N                    (1.5715e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.6060e-2)
c     - lwtr.20t is ENDF71SaB kernel
 m1  92234.80c 3.9873e-7  92235.80c 4.9479e-5  92236.80c 4.9418e-8  $234,235,236U
     92238.80c 4.4072e-4                                            $238U
      7014.80c 1.5657e-3   7015.80c 5.7831e-6                       $14,15N
      8016.80c 3.6046e-2   8017.80c 1.3703e-5                       $16,17O
      1001.80c 6.1318e-2                                            $H
 mt1  lwtr.20t                                                      $kernel
c
c    For m2:
