...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 18 is a bp-2 plate above Tank #2, then void to Tank #1
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top bp-2 plate
...
c     the relative spacings do not change.
  71  pz   53.51145  $(s96+4.61518), bottom of Tank #1
  72  pz   54.47944  $(s71+0.96799), Tank #1 bottom plate
  73  pz   63.32463  $(s72+8.90067), Tank #1 internal height
  74  pz   64.28602  $(s73+0.96139), top of Tank #1
  81  pz   54.18150  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   61.80150  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   51.64150  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for BP-2 plate (above Tank #2)
...
c     reflector is present, or top of uppermost reflector.
 999  pz   64.28602  $extra z-plane for possible upper reflector/top of model
