...
c
c  This deck is case 6 (detailed).
c
c Cell cards:
c
  1   1 1.00265785e-1   -1 :                  $filled sphere
                       (+1 -4 -21 +14) :      $solution in fill pipe
                       (+1 -6 -3 +21)         $solution in overflow pipe
  2   2 1.00012968e-1  (+21 -16 +2 +7 -11) :  $reflector water (above sphere midplane)
                       (-21 +13 +2 +5 -11)    $reflector water (below sphere midplane)
c 3   0                (-1 +3)                $void above solution & within the sphere
...
c
  1   so  11.8755  $sphere (solution) inner radius [B]
  2   so  12.0025  $sphere outer radius (s1 + 0.127)
  3   pz  16.8645  $solution height ([A] - s1)
...
c
c
c    For m1 (1.00265785e-1):
c     - natN may be converted to 14,15N                    (5.6740e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4590e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1 92232.80c 1.5942e-9   92233.80c 2.3931e-4   92234.80c 2.5578e-6
      92235.80c 6.3246e-8   92236.80c 2.4222e-9   92238.80c 3.3289e-6  $U
       1001.80c 6.4860e-2                                              $H
       7014.80c 5.65312e-4   7015.80c 2.08803e-6                       $N
       8016.80c 3.45769e-2   8017.80c 1.31442e-5                       $O
      90232.80c 3.0770e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
c    For m2:  (1.00012968e-1)
c     - natO converted to 16,17O (where 16 = 16+18) (3.3338e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m2  1001.80c 6.6675e-2                                              $H
       8016.80c 3.33253e-2   8017.80c 1.26684e-5                       $O
  mt2  lwtr.20t                                                        $h-h2o
c
