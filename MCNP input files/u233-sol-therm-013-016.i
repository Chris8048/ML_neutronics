...
c Cell cards:
c
  1   1 9.98491034e-2  -1 -4  $partially filled sphere
...
c
  1   so  15.7983  $Solution radius [R]
  2   so  15.8743  $Heresite liner outer radius (R + 0.076)
  3   so  16.0013  $Container outer radius (s2 + 0.127)
  4   pz  11.1767  $Solution height ([H] - [R])
c ------------------------------------------------------------------------------
...
c
c
c    For m1 (9.98491034e-2):
c     - natN may be converted to 14,15N                    (4.9738e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4307e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
 m1   92232.80c 1.3975e-9   92233.80c 2.0977e-4   92234.80c 2.2421e-6
      92235.80c 5.5441e-8   92236.80c 2.1232e-9   92238.80c 2.9181e-6  $U
       1001.80c 6.4827e-2                                              $H
       7014.80c 4.95550e-4   7015.80c 1.83036e-6                       $N
       8016.80c 3.42940e-2   8017.80c 1.30367e-5                       $O
      90232.80c 2.6972e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
