...
c          99: outside world
c
  1    1  4.75994226e-2    -1  (    (-13 +12):   $lower core solid HEU
                                (+2  -14 +13):   $lower core HEU with source gap
                                (+3  -32 +31))   $upper core HEU
c
  2    2  7.14753493e-2    -1  (    (-12 +11):   $lower core V
                                    (-33 +32))   $upper core V
c
...
c
  9    pz   0.15   $Hcr
c
 11    pz  -7.000  $bottom of lower V reflector
 12    pz  -5.000  $bottom of lower core
 13    pz  -1.000  $lower core, solid HEU boundary
 14    pz  -0.000  $lower core, upper boundary
c
 31    pz   0.150  $bottom of upper core
 32    pz   5.125  $   top of upper core
 33    pz   7.125  $   top of upper V reflector
c
 61    cz   9.995  $diaphragm inner radius
 62    cz  12.0
 63    cz  13.0
 64    pz   0.15   $bottom of diaphragm (=Hcr)
 65    pz   0.35   $s64 + 0.2
 66    pz   0.95   $s64 + 0.8
c
 71    cz  12.5
...
c     m4   = D16 duralumin.
c
c    For m1 (Case 2 HEU, 4.75994226e-2):
c     - natFe may be converted to isoFe (1.7945e-5)
c     - natW  may be converted to isoW  (9.0853e-7)
 m1   92234.80c 5.6123e-4  92235.80c 4.5455e-2  92238.80c 1.3280e-3  $U
       6000.80c 7.4169e-5                                            $C
      13027.80c 1.6217e-4                                            $Al
      26054.80c 1.04889e-6 26056.80c 1.64653e-5 26057.80c 3.80255e-7
      26058.80c 5.06049e-8                                           $isoFe
      74180.80c 1.09024e-9
      74182.80c 2.40760e-7 74183.80c 1.30011e-7 74184.80c 2.78374e-7
      74186.80c 2.58295e-7                                           $isoW
c
c    For m2: (Case 2 V, 7.14753493e-2)
c     - natN  may be converted to isoN  (1.2956e-5)
c     - natO  may be converted to isoO  (9.6412e-5)
c     - natSi may be converted to isoSi (1.6800e-4)
c     - natFe may be converted to isoFe (2.3721e-5)
 m2   23050.80c 1.77665e-4 23051.80c 7.08883e-2                      $isoV
       1001.80c 3.6010e-5                                            $H
       6000.80c 3.3240e-5                                            $C
       7014.80c 1.29083e-5  7015.80c 4.76781e-8                      $isoN
       8016.80c 9.63754e-5  8017.80c 3.66366e-8                      $isoO
      13027.80c 3.9010e-5                                            $Al
      14028.80c 1.54946e-4 14029.80c 7.86778e-6 14030.80c 5.18650e-6 $isoSi
      26054.80c 1.38649e-6 26056.80c 2.17650e-5 26057.80c 5.02648e-7
      26058.80c 6.68932e-8                                           $isoFe
c
