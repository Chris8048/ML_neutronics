...
c   Cell cards
c
    1   5 9.72505864e-2    -21       -7 +6           $inner solution
...
c   4   3 9.93150622e-2    -23 +22   -8 +4           $middle tank solution (cases 6-13)
    4   4 9.95822349e-2    -23 +22   -8 +4           $middle tank solution (cases 14-18)
...
c
    ...
    7 pz  72.9  $H7, top of inner  tank solution (case dependent)
    8 pz  72.8  $H8, top of middle tank solution (case dependent)
    9 pz  90.8  $H9, top of outer  tank reflector (case dependent)
...
c     - hh2o.20t is rem continuous kernel 
   m5 92234.80c 9.3661e-6   92235.80c 9.1252e-4   92236.80c 2.2451e-6  $
      92238.80c 9.9470e-5                                              $HEU
       1001.80c 5.6439e-2                                              $H
       8016.80c 3.73488e-2   8017.80c 1.41979e-5                       $16,17O
       7014.80c 2.39396e-3   7015.80c 8.84230e-6                       $14,15N
      64152.80c 4.43700e-8  64154.80c 4.83633e-7  64155.80c 3.28338e-6 $
      64156.80c 4.54127e-6  64157.80c 3.47195e-6  64158.80c 5.51075e-6 $
      64160.80c 4.84964e-6                                             $isoGd
c
...
c
 ...
 fs01  +7 +4         $ but restrict edit to solution axial limits
 e01   6.250e-7 150.
 c01   0.0 1.0
c
 fc11  Axial leakage
 f11:n +4 +7         $ axial current across top and bottom solution surfaces ...
