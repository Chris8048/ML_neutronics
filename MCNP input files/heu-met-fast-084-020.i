...
c - the reflector material is Mo.
c - the benchmark eigenvalue is 0.9995(25).
c
c Cell cards
c      1: HEU metal
c      2: Reflector
...
c
  2    2  6.40720000e-2  -2  -22 +21  (+1:+12:-11)  $reflector
c
...
c
 ...
 12    pz  17.06779  $  end axial HEU
 21    pz  -1.27     $start axial reflector (s11-1.27)
 22    pz  18.33779  $  end axial reflector (s12+1.27)
...
c
c    For m2:
c     Case 8 & 20 = Mo, 6.40720000e-2:
  m2  42092.80c 9.5083e-3  42094.80c 5.9267e-3  42095.80c 1.0200e-2  $
      42096.80c 1.0687e-2  42097.80c 6.1189e-3  42098.80c 1.5461e-2  $
      42100.80c 6.1701e-3                                            $isoMo
c
c
print -175

C    k(bmk) = 0.9995 +- 0.0025
