Pu-Sol-Therm-010.4 (11-1), rev1, 9/30/2004, 2.9a% 240Pu, 54.43 g Pu/l
c
...
c
  1     1  1.01408849e-1   -14 +13  -5                      $Solution
c
...
c
 ...
 14     pz   25.6032    $  End solution/Start tamper tank
 15     pz   25.7607    $Start tamper water (s14 + 0.1575)
 16     pz   56.2407    $  End tamper water (s15 + 30.48)
 17     pz   56.3982    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01408849e-1):
c     - natN  may be converted to isoN  (1.1655e-3)
c     - natO  may be converted to isoO  (3.5493e-2)  (16+18O = 16O)
...
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.3321e-4  94240.80c 3.8915e-6                       $239,240Pu
         1001.80c 6.4610e-2                                            $H
         7014.80c 1.1612e-3   7015.80c 4.2890e-6                       $N
         8016.80c 3.5480e-2   8017.80c 1.3487e-5                       $O
