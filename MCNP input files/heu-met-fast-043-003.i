...
c
  1    1  4.76679178e-2  -4    ((-26 +25):
                                ...
                                (-52 +53 +1):
                                (-53 +54))            $HEU (two zones)
  2    7  8.43533960e-2  -4    ((-27 +26):(-54 +55))  $axial reflector
c
...
c
 ...
 55    pz  -9.685  $(s54-3.96),  bottom lower zone axial reflector (case 3)
c
...
c
c    For m7: (St10, axial reflector, case 3, 8.43533960e-2)
c     - natSi may be converted to isoSi (4.4990e-4)
c     - natCr may be converted to isoCr (6.7503e-5)
c     - natFe may be converted to isoFe (8.3001e-2)
 m7    6000.80c 4.0911e-4                                            $C
      ...
      26054.80c 4.85141e-3 26056.80c 7.61567e-2 26057.80c 1.75879e-3
      26058.80c 2.34063e-4                                           $isoFe
c
