Heu-Met-Fast-078.39, rev.0, 9/30/2006.
c
...
c
c   This deck is case 39.
c
c   Cell cards:
c
  1    1  4.58309000e-2   -2 +1  -3  $core cylinder
c
 11    2  8.5736e-2      -11 +2  -3  $upper reflector
c
...
c
  ...
  2    pz    5.9505  $   top of core plane
  3    cz   19.05    $core radius
c
 11    pz   41.5105  $   top of upper axial reflector (s2 + 35.56)
...
c      if graphite density = 1.79 c/cm3, then 8.9747e-2 a/bn-cm.
   m2  6000.80c 8.5736e-2                                            $graphite
  mt2  grph.20t
c
c
print -175

C    k(bmk) = 0.9989 +- 0.0021
