...
c          99: outside world
c
  1    1  4.76679167e-2  -4    ((-26 +25):
                                (-25 +21 +2):
                                (-52 +53 +1):
                                (-53 +54))            $HEU (two zones)
  2    7  8.47304135e-2  -4    ((-27 +26):(-54 +55))  $axial reflector
c
...
c
 ...
 26    pz   3.980  $(s21+3.980),     top upper zone HEU
 27    pz  13.960  $(s26+9.98),      top upper zone axial reflector (case 4)
c
 51    pz  -0.60   $(s21-0.6), top support ring thickness
 52    pz  -0.45   $(s21-0.45), Hcr
 53    pz  -1.450  $(s52-1.000),  first lower zone HEU
 54    pz  -5.425  $(s52-4.975), bottom lower zone HEU
 55    pz -15.405  $(s54-9.98),  bottom lower zone axial reflector (case 4)
c
...
c
c    For m1: (HEU, cases 4 & 5, 4.76679167e-2)
c     - natFe may be converted to isoFe (1.8029e-5)
c     - natW  may be converted to isoW  (9.1277e-7)
 m1   92234.80c 5.6396e-4  92235.80c 4.5676e-2  92238.80c 1.3345e-3  $U
       6000.80c 7.4515e-5                                            $C
      26054.80c 1.05380e-6 26056.80c 1.65423e-5 26057.80c 3.82035e-7
      26058.80c 5.08418e-8                                           $isoFe
      74180.80c 1.09532e-9
      74182.80c 2.41884e-7 74183.80c 1.30617e-7 74184.80c 2.79673e-7
      74186.80c 2.59501e-7                                           $isoW
c
c    For m7: (St10, axial reflector, case 4, 8.47304135e-2)
c     - natSi may be converted to isoSi (4.5190e-4)
c     - natCr may be converted to isoCr (6.7804e-5)
c     - natFe may be converted to isoFe (8.3372e-2)
 m7    6000.80c 4.1094e-4                                            $C
      14028.80c 4.16786e-4 14029.80c 2.11634e-5 14030.80c 1.39511e-5 $isoSi
      24050.80c 2.94608e-6 24052.80c 5.68123e-5 24053.80c 6.44206e-6
      24054.80c 1.60356e-6                                           $isoCr
      25055.80c 4.2782e-4                                            $Mn
      26054.80c 4.87309e-3 26056.80c 7.64971e-2 26057.80c 1.76665e-3
      26058.80c 2.35109e-4                                           $isoFe
c
