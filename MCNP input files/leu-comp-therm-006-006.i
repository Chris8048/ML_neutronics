Leu-Comp-Therm-006.6, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 6, N=19, pitch=1.956):
 101   px  -48.582   $(s102-30.0), model boundary
 102   px  -18.582   $(-N*pitch/2), start lattice
 103   px   18.582   $( N*pitch/2),   end lattice
 104   px   48.582   $(s103+30.0), model boundary
c
