...
c   Cell cards:
c
  1    1  4.76845708e-2          -31           u=1               $Lower unit cell HEU
  2    7  3.26969780e-2          +31           u=1               $Lower unit cell lead
  3    0                              -32 +14  u=2 fill=1 lat=1  $Lower core unit cell
c
 11    8  3.26969780e-2          -42           u=3               $Upper unit cell lead
 12    1  4.76845708e-2          +42           u=3               $Upper unit cell HEU
 13    0                              -43 +41  u=4 fill=3 lat=1  $Upper core unit cell at the origin
c
 21    0                          -2  -15 +14      fill=2        $Lower core
 22    0                          -2  -21 +20      fill=4        $Upper core
 23    1  4.76845708e-2  (-2 +1)  ((-16 +15):(-20 +18))          $HEUs with source hole
c
...
c
 ...
 44    0                 (-2       -12 +11):
                         (-5 +3    -23 +22)               $other axial gaps
 45    0                  -3 +2    -23 +11                $radial gap before radial reflector
 46    0                 (-6:-7)  (-22 +11)               $holes in radial lead
c
 51    4  3.25950300e-2   -2       -14 +13                $Lower axial lead reflector
 52    5  3.25980520e-2   -2       -23 +21                $Upper axial lead reflector
 53    6  3.27469780e-2  (-4 +3  ((-17 +11):(-22 +19))):  $Radial lead (minus St10
                         (-5 +4    -22 +11  (+6 +7))      $support plate and holes)
c
...
c
 ...
 12    pz    5.200    $Start lower axial plate steel
 13    pz    6.200    $  End lower axial plate steel/ start lower axial lead reflector
 14    pz   24.700    $Start lower HEU unit cell
 15    pz   42.945    $  End lower HEU unit cell/Start lower HEU source hole
 16    pz   43.940    $  End lower HEU source hole
 ...
 21    pz   69.130    $  End upper HEU unit cell
 22    pz   85.100    $  End reflector lead reflector
 23    pz   87.365    $  End upper axial lead reflector
c
 31    pz   26.690    $Lower HEU slab height
 32    pz   30.450    $Lower unit cell height
c
 41    pz   46.130    $Start upper unit cell lead
 42    pz   49.890    $Upper unit cell lead height
 43    pz   51.880    $Upper unit cell height
c
...
c
c    For m1: (HEU, 4.76845708e-2, case 3)
c     - natFe may be converted to isoFe (1.8039e-5)
c     - natW  may be converted to isoW  (9.1329e-7)
 m1  92234.80c 5.6416e-4  92235.80c 4.5692e-2  92238.80c 1.3349e-3  $U
      6000.80c 7.4558e-5                                            $C
     26054.80c 1.0544e-6  26056.80c 1.6552e-5  26057.80c 3.8225e-7
     26058.80c 5.0870e-8                                            $isoFe
     74180.80c 1.09595e-9
     74182.80c 2.42022e-7 74183.80c 1.30692e-7 74184.80c 2.79832e-7
     74186.80c 2.59648e-7                                           $isoW
c
...
c
c    For m5: (Upper Axial Lead, 3.25980520e-2, case 3)
c     - natPb may be converted to isoPb (3.2598e-2)
 m5   82204.80c 4.56372e-4
      82206.80c 7.85612e-3 82207.80c 7.20416e-3 82208.80c 1.70814e-2 $isoPb
c
c    For m6: (Radial Reflector Lead, 3.27469780e-2, case 3)
c     - natPb may be converted to isoPb (3.2747e-2)
 m6   82204.80c 4.58458e-4
      82206.80c 7.89203e-3 82207.80c 7.23709e-3 82208.80c 1.71594e-2 $isoPb
c
c    For m7: (Lower Unit Cell Lead, 3.26969780e-2, case 3)
c     - natPb may be converted to isoPb (3.2697e-2)
 m7   82204.80c 4.57758e-4
      82206.80c 7.87998e-3 82207.80c 7.22604e-3 82208.80c 1.71332e-2 $isoPb
c
c    For m8: (Upper Unit Cell Lead, 3.26969780e-2, case 3)
c     - natPb may be converted to isoPb (3.2697e-2)
 m8   82204.80c 4.57758e-4
      82206.80c 7.87998e-3 82207.80c 7.22604e-3 82208.80c 1.71332e-2 $isoPb
c
c
print -175
