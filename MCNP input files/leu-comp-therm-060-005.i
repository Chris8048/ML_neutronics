LCT60-N5-RBMK-DET - UNIFORM FLOODED CASE, 2.4% ENRICHED FUEL
c
c *** ack mods:
...
c    -- CELL CARDS --
c    FUEL PIN
1     1  6.78466483e-2 -1 -6 7 imp:n=1 u=1 $ fuel
...
78    4  8.41586222e-2  37 31  u=7 imp:n=1 $ graphite
...
90    0 -32 33 -34 35 imp:n=1 lat=1 u=15 fill=0:17 0:17 0:0
             ...
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
             12 12 12 12 56 12 12  7  7  7  7 12 12 12 11 12 12 12
             12 12 12 12 12 12 12 12  7  7  7 12 12 12 12 12 12 12
             12 12 12 12 12 12 12 12  7  7  7 12 12 12 12 12 12 12
             12 12 12 12 12 12 12 12  7  7  7  7 12 12 12 12 12 12
...
313  20 8.45876253E-02  37 31  imp:n=1  u=56 $ graphite
c
...
c   -- DATA CARDS --
c    Material 1 - fuel U(1.8)O2 (Table 17), N=6.78466483e-2
c    - data are case dependent
c      - natO  converted to 16,17O (where 16 = 16+18) (4.5534e-2)
c      - natSi may be converted to isoSi              (3.2244e-6)
c      - natCr may be converted to isoCr              (4.6445e-7)
c      - natFe may be converted to isoFe              (1.8378e-6)
c      - natNi may be converted to isoNi              (5.1434e-7)
 m1  92234.80c 4.4087e-6   92235.80c 5.4182e-4   92236.80c 3.3757e-6   $  
     92238.80c 2.1757e-2                                               $
      8016.80c 4.55167e-2   8017.80c 1.73029e-5                        $isoO
     14028.80c 2.97385e-6  14029.80c 1.51005e-7  14030.80c 9.95437e-8  $isoSi
     24050.80c 2.01804e-8  24052.80c 3.89158e-7  24053.80c 4.41274e-8  $
     24054.80c 1.09842e-8                                              $isoCr
     26054.80c 1.07419e-7  26056.80c 1.68626e-6  26057.80c 3.89430e-8  $
     26058.80c 5.18260e-9                                              $isoFe
     28058.80c 3.50147e-7  28060.80c 1.34876e-7  28061.80c 5.86296e-9  $
     28062.80c 1.86937e-8  28064.80c 4.76073e-9                        $isoNi
c
...
c    N(core) = 8.41586222e-2
c    - data are case dependent
c      - natMg may be converted to isoMg (2.5370e-7)
c      - natSi may be converted to isoSi (1.7996e-7)
c      - natFe may be converted to isoFe (3.8010e-8)
c      - natCu may be converted to isoCu (1.1135e-8)
c      - natCd may be converted to isoCd (1.3309e-9)
c      - grph.20t is ENDF71SaB kernel
 mt4  grph.20t
 m4   6000.80c 8.4158e-2                                               $natC
      5010.80c 5.2657e-9    5011.80c 2.1195e-8                         $10,11B
     12024.80c 2.00398e-7  12025.80c 2.53700e-8  12026.80c 2.79324e-8  $isoMg
     13027.80c 1.0865e-7                                               $Al
     14028.80c 1.65977e-7  14029.80c 8.42789e-9  14030.80c 5.55573e-9  $isoSi
     25055.80c 2.9071e-9                                               $Mn
     26054.80c 2.22168e-9  26056.80c 3.48757e-8  26057.80c 8.05432e-10 $
     26058.80c 1.07188e-10                                             $isoFe
     29063.80c 7.70208e-9  29065.80c 3.43292e-9                        $isoCu
     48106.80c 1.66363e-11 48108.80c 1.18450e-11 48110.80c 1.66229e-10 $
     48111.80c 1.70355e-10 48112.80c 3.21146e-10 48113.80c 1.62636e-10 $
     48114.80c 3.82368e-10 48116.80c 9.96844e-11                       $isoCd
c
