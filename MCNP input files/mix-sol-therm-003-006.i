Benchmark Model for Pu/U - MIX-SOL-THERM-003-006
C
C  CASE DATA:
C    Vessel internal radius: 18.995 cm
C    Vessel internal height: 107.0 cm
C    Vessel side wall thickness: 0.25 cm
C    Solution height:   28.24 cm
C    Solution type: B, at rho = 0.1010398
C
C
C -------
C  CELLS
C -------
10 1002 0.1010398     +20 -04 -01                    IMP:n=1 $ Solution 
...
04 PZ   28.24    $ Height of solution
05 CZ   24.245   $ Flange radius (outer radius + 5 cm)
06 CZ   18.795   $ Inner radius of poly plug (inner radius - 0.2 cm)
07 PZ   28.557   $ Top of SS on poly plug (solution height + .317)
08 PZ   43.557   $ Top of poly plug (solution height + 15.317)
C
