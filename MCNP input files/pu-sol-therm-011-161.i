Pu-Sol-THERM-011, 16-inch sphere, case 1, rev 0, 8/31/1996
c
c Benchmark model keff is 1.0000(52) for all cases.
c
c This deck is for an 16-inch sphere, case 1.
c
c Cell cards:
c
 1    1  1.00630501e-1    -1  $Solution
...
c
c
c    For m1 (1.00630501e-1):
c     - natN  may be converted to isoN  (1.0140e-3)
c     - natO  may be converted to isoO  (3.4983e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.1215e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
   m1  94239.80c 8.4397e-5  94240.80c 3.6572e-6                       $239,240Pu
        1001.80c 6.4544e-2                                            $H
        7014.80c 1.0103e-3   7015.80c 3.7315e-6                       $N
        8016.80c 3.4970e-2   8017.80c 1.3294e-5                       $O
       26054.80c 6.5552e-8  26056.80c 1.0290e-6  26057.80c 2.3765e-8
       26058.80c 3.1626e-9                                            $isoFe
  mt1   lwtr.20t                                                      $S(a,b) 
c
