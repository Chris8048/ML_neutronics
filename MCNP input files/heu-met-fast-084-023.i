...
c - the reflector material is CH2.
c - the benchmark eigenvalue is 0.9993(24).
c
c Cell cards
c      1: HEU metal
c      2: Reflector
...
c
  2    2  1.18623000e-1  -2  -22 +21  (+1:+12:-11)  $reflector
c
...
c
 ...
 12    pz  17.88639  $  end axial HEU
 21    pz  -1.27     $start axial reflector (s11-1.27)
 22    pz  19.15639  $  end axial reflector (s12+1.27)
...
c     Case 11 & 23 = CH2, 1.18623000e-1:
  m2   1001.80c 7.9082e-2  $H
       6000.80c 3.9541e-2  $C
 mt2   poly.20t
c
c
print -175

C    k(bmk) = 0.9993 +- 0.0024
