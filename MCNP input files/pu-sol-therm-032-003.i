PU-SOL-THERM-032.3, rev0, 9/30/2005, 9.95a% Pu240, 50.55 g Pu/l
c
...
c
c  This deck is case 3 (detailed, i.e., slanted bottom, model).
c
...
c
 12     4  5.44376405e-5  (-1       -15 +13) :            $Central Air
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   31.18               $  End solution (ICSBEP Hc - 0.1)
