Leu-Comp-Therm-006.18, rev1, 9/30/1998.
c
...
c
   1   px   -1.1465  $local x-origin
   2   px    1.1465  $fuel rod unit cell
  11   py   -1.1465  $local y-origin
  12   py    1.1465  $fuel rod unit cell
c
...
c
c
c - global x coordinates (Case 18, N=19, pitch=2.293):
 101   px  -51.7835  $(s102-30.0), model boundary
 102   px  -21.7835  $(-N*pitch/2), start lattice
 103   px   21.7835  $( N*pitch/2),   end lattice
 104   px   51.7835  $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -51.7835  $(s152-30.0), model boundary
 152   py  -21.7835  $(-N*pitch/2), start lattice
 153   py   21.7835  $( N*pitch/2),   end latticeh)
 154   py   51.7835  $(s153+30.0), model boundary
c
...
c
 ...
 si4      0.1  75.0  $Full length guessis too crude; truncate at 75 cm.
c
c
