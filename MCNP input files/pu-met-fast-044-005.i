...
c 4    6  5.9324e-2      +3 -4        $Al Tamper (case 44.4)
  4    7  8.6272e-2      +3 -4        $graphite Tamper (case 44.5)
  5    0                 +4 -5        $void
c 6    8  1.19010e-1     +5 -6        $CH2 reflector (case 44.1)
...
c 6   11  1.20684e-1     +5 -9        $CH2 reflector (case 44.4)
  6   12  1.19268e-1     +5 -10       $CH2 reflector (case 44.5)
c 7    0                 +6           $case 44.1
c 7    0                 +7           $case 44.2
c 7    0                 +8           $case 44.3
c 7    0                 +9           $case 44.4
