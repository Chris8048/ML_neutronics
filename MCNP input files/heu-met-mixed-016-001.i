...
c          99: outside world
c
   1    1  4.77162004e-2   -2  ((-24 +23):     $HEU72
                                (-28 +27):     $HEU73
                                (-32 +31 +1):  $HEU74 w/o plug
                                (-55 +54):     $HEU75
                                (-59 +58))     $HEU76
c
   2    2  7.14411531e-2   -3  ((-26 +25):     $V1
                                (-30 +29):     $V2
                                (-53 +52):     $V6
                                (-57 +56))     $V4
c
  11    3  1.17519000e-1   -4  ((-25 +24):     $CH2 (103+2)
                                (-27 +26):     $CH2 (105+1)
                                (-29 +28):     $CH2 (104+14)
                                (-31 +30):     $CH2 (101+3)
                                (-52 +51):     $CH2 (108+4)
...
c
  13    4  1.17930000e-1   -5   (-60 +59)      $upper axial CH2 refl
c
...
c
  41    0                   -2      -51 +32              $Hcr gap
  42    0                   -1      -32 +31              $HEU source hole void
  43    0                   -9 +11  -73 +72              $diaphgragm/refl void
  44    0                  -11  +2  
                                  ((-60 +72):(-71 +75))  $core/reflector void
  45    0                  -11      -74 +60              $radial void, above refl
  46    0                  -15 +13  -74 +75              $radial void, beyond refl
  47    0                   -2  +6  -21 +75              $void below plate
  48    0                  -14  +6  -75 +76              $void below core in line with platen
c
  99    0                  +15:-76:+74                   $Outside world
...
c
 ...
 25    pz  13.655  $(s24+1.48),  CH2 (103+2)
 26    pz  14.155  $(s25+0.50),  V1
 27    pz  15.635  $(s26+1.48),  CH2 (105+1)
 28    pz  16.635  $(s27+1.00),  HEU73
 29    pz  18.115  $(s28+1.48),  CH2 (104+14)
 30    pz  18.615  $(s29+0.50),  V2
 31    pz  20.095  $(s30+1.48),  CH2 (101+3)
 32    pz  21.095  $(s31+1.00),  HEU74
 51    pz  21.805  $(s38+0.71),  gap, start upper core
 52    pz  23.285  $(s51+1.48),  CH2 (108+4)
 53    pz  23.785  $(s52+0.50),  V6
 54    pz  25.265  $(s53+1.48),  CH2 (106+6)
 55    pz  26.260  $(s56+0.995), HEU75
 56    pz  27.740  $(s57+1.48),  CH2 (110+7)
 57    pz  28.240  $(s58+0.50),  V4
 58    pz  29.720  $(s59+1.48),  CH2 (107+8)
 59    pz  30.715  $(s60+0.995), HEU76
 60    pz  40.695  $(s61+9.98),  end upper CH2 axial reflector (532+502)
c
c - other axial planes, derived from core stackup.
c
 71    pz  21.805  $(s51), bottom of upper core diaphragm
 72    pz  22.005  $(s71+0.20), diaphragm thickness
 73    pz  22.405  $(s71+0.60), diaphragm thickness
 74    pz  44.855  $(s71+23.05),    top of radial CH2 reflector
 75    pz -12.025  $(s71-33.83), bottom of radial CH2 reflector
 76    pz -14.625  $(s75-2.6), bottom of platen
c
...
c     - natW  may be converted to isoW  (9.0841e-7)
  m1  92234.80c 5.6115e-4  92235.80c 4.5449e-2  92238.80c 1.3278e-3  $U
       6000.80c 7.4159e-5                                            $C
      13027.80c 2.8524e-4                                            $Al
      26054.80c 1.04877e-6 26056.80c 1.64634e-5 26057.80c 3.80212e-7
      26058.80c 5.05993e-8                                           $isoFe
      74180.80c 1.09009e-9
      74182.80c 2.40729e-7 74183.80c 1.29993e-7 74184.80c 2.78337e-7
      74186.80c 2.58261e-7                                           $isoW
c
c    For m1: (HEU, 4.76200957e-2), Case 2.
c     - natFe may be converted to isoFe (1.7929e-5)
c     - natW  may be converted to isoW  (9.0768e-7)
c  m1  92234.80c 5.6069e-4  92235.80c 4.5412e-2  92238.80c 1.3267e-3  $U
c       6000.80c 7.4099e-5                                            $C
c      13027.80c 2.2777e-4                                            $Al
c      26054.80c 1.04795e-6 26056.80c 1.64506e-5 26057.80c 3.79916e-7
c      26058.80c 5.05598e-8                                           $isoFe
c      74180.80c 1.08922e-9
c      74182.80c 2.40535e-7 74183.80c 1.29889e-7 74184.80c 2.78113e-7
c      74186.80c 2.58053e-7                                           $isoW
c
...
c     - natV  may be converted to isoV  (7.1032e-2)
c  m2  23000.70c 7.1032e-2                                            $natV
  m2  23050.80c 1.77580e-4 23051.80c 7.08544e-2                      $isoV
       1001.80c 3.5993e-5                                            $H
       6000.80c 3.3224e-5                                            $C
       7014.80c 1.29023e-5  7015.80c 4.76560e-8                      $isoN
       8016.80c 9.63284e-5  8017.80c 3.66187e-8                      $isoO
      13027.80c 3.8991e-5                                            $Al
      14028.80c 1.54872e-4 14029.80c 7.86403e-6 14030.80c 5.18403e-6 $isoSi
      26054.80c 1.38585e-6 26056.80c 2.17549e-5 26057.80c 5.02415e-7
      26058.80c 6.68622e-8                                           $isoFe
c
...
c     - natV  may be converted to isoV  (7.0909e-2)
c   m2  23000.70c 7.0909e-2                                            $natV
c  m2  23050.80c 1.77273e-4 23051.80c 7.07317e-2                      $isoV
c       1001.80c 3.5931e-5                                            $H
c       6000.80c 3.3166e-5                                            $C
c       7014.80c 1.28804e-5  7015.80c 4.75750e-8                      $isoN
c       8016.80c 9.61614e-5  8017.80c 3.65552e-8                      $isoO
c      13027.80c 3.8924e-5                                            $Al
c      14028.80c 1.54605e-4 14029.80c 7.85045e-6 14030.80c 5.17507e-6 $isoSi
c      26054.80c 1.38345e-6 26056.80c 2.17173e-5 26057.80c 5.01546e-7
c      26058.80c 6.67466e-8                                           $isoFe
c
...
c     - hch2.20t is continuous energy kernel (ack).
  m3    6000.80c 3.9173e-02  1001.80c 7.8346e-02                      $C, H
  mt3   poly.20t
c
...
c     - poly.10t is from endf70sab.
c     - hch2.20t is continuous energy kernel (ack).
c m3   6000.80c 3.9192e-02  1001.80c 7.8383e-02                      $C, H
c mt3  poly.20t
c
c
