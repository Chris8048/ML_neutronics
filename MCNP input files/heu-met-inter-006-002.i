...
c
c - HEU and graphite:
  1    1  4.81759700e-2  ((-7 +3) ((-53 +52):              $unit  1 HEU
                                   (-56 +55))):            $unit  2 HEU
                         ( -7     ((-59 +58):              $unit  3 HEU
                                   (-62 +61):              $unit  4 HEU
                                   (-65 +64):              $unit  5 HEU
                                   ...
                                   (-77 +76)))             $unit  9 HEU
c
  2    2  8.58210000e-2  ((-7 +3) ((-52 +51):(-54 +53):    $unit  1 graphite
                                   (-55 +54):(-57 +56))):  $unit  2 graphite
                         ( -7     ((-58 +57):(-60 +59):    $unit  3 graphite
...
c  31  pz 123.03760   $configuration 1, top of upper reflector
   23  pz  24.24384   $configuration 2, bottom of platen
   24  pz  30.59384   $configuration 2, bottom of lower reflector
   25  pz  45.02104   $configuration 2, start lower HEU "unit cell"
   27  pz  57.70880   $configuration 2, end   lower HEU with alignment tube hole
   29  pz 102.11596   $configuration 2, end   upper HEU
   30  pz 102.89540   $configuration 2, start upper reflector
   31  pz 117.32260   $configuration 2, top of upper reflector
...
c     - configuration 2:
   51  pz  45.02104
   52  pz  48.04312  $(s51+4.02944)
   53  pz  48.34284  $(s52+0.29972)
   54  pz  51.36492  $(s53+4.02944), end unit 1
   55  pz  54.38700  $(s54+4.02944)
   56  pz  54.68672  $(s55+0.29972)
   57  pz  57.70880  $(s56+4.02944), end unit 2
   58  pz  60.73088  $(s57+4.02944)
   59  pz  61.03060  $(s58+0.29972)
   60  pz  64.05268  $(s59+4.02944), end unit 3
   61  pz  67.07476  $(s60+4.02944)
   62  pz  67.37448  $(s61+0.29972)
   63  pz  70.39656  $(s62+4.02944), end unit 4
   64  pz  73.41864  $(s63+4.02944)
   65  pz  73.71836  $(s64+0.29972)
   66  pz  76.74044  $(s65+4.02944), end unit 5
   67  pz  79.76252  $(s66+4.02944)
   68  pz  80.06224  $(s67+0.29972)
   69  pz  83.08432  $(s68+4.02944), end unit 6
   70  pz  86.10640  $(s69+4.02944)
   71  pz  86.40612  $(s70+0.29972)
   72  pz  89.42820  $(s71+4.02944), end unit 7
   73  pz  92.45028  $(s72+4.02944)
   74  pz  92.75000  $(s73+0.29972)
   75  pz  95.77208  $(s74+4.02944), end unit 8
   76  pz  98.79416  $(s75+4.02944)
   77  pz  99.09388  $(s76+0.29972)
   78  pz 102.11596  $(s77+4.02944), end unit 9
c
c     - configuration 3:
c  51  pz  40.39216
...
c si3     24.3 107.8  $Configuration 1
 si3     45.1 102.1  $Configuration 2
...
c    For m1 (configuration 2): (HEU, 4.81759700e-2)
   m1 92234.80c 4.9576e-4  92235.80c 4.4941e-2  92236.80c 1.5931e-4
      92238.80c 2.5799e-3                                            $HEU
c
