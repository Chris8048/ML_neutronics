Pu-Sol-Therm-010.13 (12-3), rev1, 9/30/2004, 2.9a% 240Pu, 36.52 g Pu/l
c
...
c
 ...
 14     pz   28.4734    $  End solution/Start tamper tank
 15     pz   28.6309    $Start tamper water (s14 + 0.1575)
 16     pz   59.1109    $  End tamper water (s15 + 30.48)
 17     pz   59.2684    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01479369e-1):
c     - natN  may be converted to isoN  (1.0402e-3)
c     - natO  may be converted to isoO  (3.5305e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.7361e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 8.9332e-5  94240.80c 2.6569e-6                       $239,240Pu
         1001.80c 6.5040e-2                                            $H
         7014.80c 1.0364e-3   7015.80c 3.8279e-6                       $N
         8016.80c 3.5292e-2   8017.80c 1.3416e-5                       $O
        26054.80c 1.0148e-7  26056.80c 1.5929e-6  26057.80c 3.6788e-8
        26058.80c 4.8958e-9                                            $Fe
 mt1     lwtr.20t                                                      $S(a,b)
c
...
c
c    For m3 (9.99266570e-2):
c     - natO  may be converted to isoO  (3.3309e-2)  (16+18O = 16O)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m3      1001.80c 6.6618e-2                                            $H
         8016.80c 3.3296e-2   8017.80c 1.2657e-5                       $O
 mt3     lwtr.20t                                                      $S(a,b)
c
c
c ******************************************************************************
