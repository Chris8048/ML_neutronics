...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 5 is SS plate above Tank #2, then void to Tank #1
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top SS plate
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  17 8.66362741e-2                    -96 +6   -95 $SS plate
...
c     the relative spacings do not change.
  71  pz   57.57545  $(s96+9.26592), bottom of Tank #1
  72  pz   58.54344  $(s71+0.96799), Tank #1 bottom plate
  73  pz   67.44411  $(s72+8.90067), Tank #1 internal height
  74  pz   68.40550  $(s73+0.96139), top of Tank #1
  81  pz   58.24550  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   65.86550  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   55.70550  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for SS (above Tank #2)
  95  cz   38.09619  $(76.19238/2), ss plate radius
  96  pz   48.30953  $(s6+0.63754), top of ss plate
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   68.40550  $extra z-plane for possible upper reflector/top of model
