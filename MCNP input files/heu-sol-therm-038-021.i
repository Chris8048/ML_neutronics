...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 21 is a poly-1, hot-rolled steel and poly-3 plate above Tank #2,
c       then void to Tank #1
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top poly-3 plate
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  10 1.18817000e-1                    -96 +94  -95 $poly-3 plate
  84   0                 -12 +11 -14 +13  -96 +94  +95 $void
  85  18 8.51396450e-2                    -94 +92  -93 $hot-rolled steel plate
  86   0                 -12 +11 -14 +13  -94 +92  +93 $void
...
c     the relative spacings do not change.
  71  pz   56.08701  $(s96+5.22224), bottom of Tank #1
  72  pz   57.05500  $(s71+0.96799), Tank #1 bottom plate
  73  pz   65.95567  $(s72+8.90067), Tank #1 internal height
  74  pz   66.91706  $(s73+0.96139), top of Tank #1
  81  pz   56.75706  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   64.37706  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   54.21706  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for POLY-1, Hot-Rolled Steel and POLY-3 plates
c     (above Tank #2)
  91  cz   35.42605  $(70.36816/2), poly-1 plate radius
  92  pz   48.97247  $(s6+1.30048), top of poly-1 plate
  93  cz   35.21710  $(70.43420/2), hot-rolled steel radius
  94  pz   49.56683  $(s92+0.59436), top of hot-rolled steel
  95  cz   35.17392  $(70.34784/2), poly-3 plate radius
  96  pz   50.86477  $(s94+1.29794), top of poly-3 plate
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   66.91706  $extra z-plane for possible upper reflector/top of model
