Benchmark Model for Pu02 - MIX-COMP-THERM-003-002
C
C
C  --------------------
C
...
C
125 3000 -0.998877 -020 +214 +108 -010 #100 #104 #110   U=1 IMP:n=1  $ Main water
126   0            -020 +214 +010 -204 #100 #104 #110   U=1 IMP:n=1
C
150 3000 -0.998877 -150 +100 -102      U=0 IMP:n=1  $ Lower reflector
152 4000 -2.69     -150 +102 -104      U=0 IMP:n=1  $ Al slab
154 3000 -0.998877 -150 +104 -106      U=0 IMP:n=1  $ Water
156 4000 -2.69     -150 +106 -108      U=0 IMP:n=1  $ Al plate
C
158 3000 -0.998877 -150 +026 +108 -010 U=0 IMP:n=1
...
300   0          -20              FILL=1  LAT=1  U=2  IMP:n=1
301   0          -26 +108 -204    FILL=2         U=0  IMP:n=1
C
999   0          (+150:-100:+204)                U=0  IMP:n=0

C
10  PZ   125.265                                $ Water level {height + 43.97}
20  RPP -0.7112  0.7112 -0.7112 0.7112 0.0 0.0  $ Single unit boundary {pitch/2}
22  C/Z -0.7112 -0.7112  0.24511                $ Water hole, middle grid plate
23  C/Z  0.7112 -0.7112  0.24511                $ Water hole, middle grid plate
24  C/Z -0.7112  0.7112  0.24511                $ Water hole, middle grid plate
25  C/Z  0.7112  0.7112  0.24511                $ Water hole, middle grid plate
26  RPP  -13.5128 13.5128 -13.5128 13.5128 0.0 0.0
C
C STRUCTURAL MATERIALS
C
...
M3000  1001.80c  6.6781e-2   $ Water
       8016.80c  3.3390e-2  
MT3000 lwtr.20t
