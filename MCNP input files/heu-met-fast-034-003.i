...
c 3    3  5.76469000e-2  (-13 +12):+14  u=1             $Ti   (case 1)
c 3    4  5.98150800e-2  (-13 +12):+14  u=1             $Al   (case 2)
  3    5  8.41565612e-2  (-13 +12):+14  u=1             $St10 (case 3)
c
  4    0                 -15 +11       u=2 fill=1 lat=1 $lower core unit cell
  5     like 4 but trcl=(0.0 0.0 1.26) u=3        lat=1 $upper core unit cell
c
...
c
 21    pz  22.35   $begin upper core (pz18 + Hcr)
 22    pz  43.58   $  end upper core (pz21 + 21.23)
 23    pz  22.55   $St10 diaphragm height (pz21 + 0.2)
 24    pz  23.15   $St10 diaphragm height (pz21 + 0.8)
c
