Leu-Comp-Therm-006.7, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 7, N=20, pitch=1.956):
 101   px  -49.560   $(s102-30.0), model boundary
 102   px  -19.560   $(-N*pitch/2), start lattice
 103   px   19.560   $( N*pitch/2),   end lattice
 104   px   49.560   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -49.560   $(s152-30.0), model boundary
 152   py  -19.560   $(-N*pitch/2), start lattice
 153   py   19.560   $( N*pitch/2),   end latticeh)
 154   py   49.560   $(s153+30.0), model boundary
c
