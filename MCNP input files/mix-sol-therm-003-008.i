Benchmark Model for Pu/U - MIX-SOL-THERM-003-008
C
C  CASE DATA:
C    Vessel internal radius: 18.995 cm
C    Vessel internal height: 107.0 cm
C    Vessel side wall thickness: 0.25 cm
C    Solution height:   72.86 cm
C    Solution type: C, at rho = 0.1003036 
C
C
C -------
C  CELLS
C -------
10 1003 0.1003036     +20 -04 -01                    IMP:n=1 $ Solution 
...
C --------
C
01 CZ   18.995   $ Vessel internal radius 
02 PZ   107.0    $ Vessel internal height
03 CZ   19.245   $ Vessel outer radius (internal radius + wall thickness)
04 PZ   72.86    $ Height of solution
05 CZ   24.245   $ Flange radius (outer radius + 5 cm)
06 CZ   18.795   $ Inner radius of poly plug (inner radius - 0.2 cm)
07 PZ   73.177   $ Top of SS on poly plug (solution height + .317)
08 PZ   88.177   $ Top of poly plug (solution height + 15.317)
C
