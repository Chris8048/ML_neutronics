Leu-Comp-Therm-027.3, rev1, 9/30/2000.
c
...
c 21   pz    0.00  $ local z-origin
  ...
  29   pz   76.19  $ (Hc + s25 = 78.33, 75.07, 76.19 or 84.43)
...
c   1, 2, 3 & 4.  Some surfaces (112 & 115, for case 1) are redundant.
 ...
 111   px  -47.80  $bottom, left  lead (s103+e-60.0)
 112   px   12.20  $                   (s111  +60.0)
 113   px   42.20  $bottom, right lead (s112  +30.0)
 114   px   47.80  $   top, right lead (s102-e+60.0)
 115   px  -12.20  $                   (s114  -60.0)
 116   px  -42.20  $   top,  left lead (s115  -30.0)
c
...
c   1, 2, 3 & 4.  Some surfaces (162 & 164, for case 1) are redundant.
 ...
 161   py  -42.20  $bottom, left  lead (s152-e-30.0)
 162   py  -12.20  $                   (s161  +30.0)
 163   py  -47.80  $bottom, right lead (s153+e-60.0)
 164   py   12.20  $                   (s163  +60.0)
 165   py   42.20  $   top, right lead (s164  +30.0)
 166   py   47.80  $   top,  left lead (s162  +60.0)
c
...
c   per Table 1:  Hc = 75.13, 71.87, 72.99 & 81.23 for cases 1, 2, 3 & 4.
 ...
 204   pz   95.19  $water height (Hc + 3.2 + s203 = 97.33, 94.07, 95.19, 103.43)
