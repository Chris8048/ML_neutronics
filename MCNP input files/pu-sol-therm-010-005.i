Pu-Sol-Therm-010.5 (11-2), rev1, 9/30/2004, 2.9a% 240Pu, 47.21 g Pu/l
c
...
c
  1     1  1.01060584e-1   -14 +13  -5                      $Solution
c
...
c
 ...
 14     pz   28.1686    $  End solution/Start tamper tank
 15     pz   28.3261    $Start tamper water (s14 + 0.1575)
 16     pz   58.8061    $  End tamper water (s15 + 30.48)
 17     pz   58.9636    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.01060584e-1):
c     - natN  may be converted to isoN  (1.1363e-3)
c     - natO  may be converted to isoO  (3.5320e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (2.9654e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.1554e-4  94240.80c 3.3753e-6                       $239,240Pu
         1001.80c 6.4482e-2                                            $H
         7014.80c 1.1321e-3   7015.80c 4.1816e-6                       $N
         8016.80c 3.5307e-2   8017.80c 1.3422e-5                       $O
        26054.80c 1.7333e-7  26056.80c 2.7209e-6  26057.80c 6.2837e-8
        26058.80c 8.3624e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
