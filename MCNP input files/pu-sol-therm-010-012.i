Pu-Sol-Therm-010.12 (12-2), rev1, 9/30/2004, 2.9a% 240Pu, 42.29 g Pu/l
c
...
c
 ...
 14     pz   25.2476    $  End solution/Start tamper tank
 15     pz   25.4051    $Start tamper water (s14 + 0.1575)
 16     pz   55.8851    $  End tamper water (s15 + 30.48)
 17     pz   56.0426    $  End tamper tank  (s16 + 0.1575)
...
c
c
c    For m1 (1.00577431e-1):
c     - natN  may be converted to isoN  (1.2296e-3)
c     - natO  may be converted to isoO  (3.5271e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (1.8763e-6)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94239.80c 1.0345e-4  94240.80c 3.0766e-6                       $239,240Pu
         1001.80c 6.3968e-2                                            $H
         7014.80c 1.2251e-3   7015.80c 4.5249e-6                       $N
         8016.80c 3.5258e-2   8017.80c 1.3403e-5                       $O
        26054.80c 1.0967e-7  26056.80c 1.7216e-6  26057.80c 3.9759e-8
        26058.80c 5.2912e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
...
c
c    For m3 (9.98796510e-2):
c     - natO  may be converted to isoO  (3.3293e-2)  (16+18O = 16O)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m3      1001.80c 6.6587e-2                                            $H
         8016.80c 3.3280e-2   8017.80c 1.2651e-5                       $O
 mt3     lwtr.20t                                                      $S(a,b)
c
c
c ******************************************************************************
