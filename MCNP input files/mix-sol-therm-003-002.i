Benchmark Model for Pu/U - MIX-SOL-THERM-003-002
C
C  CASE DATA:
C    Vessel internal radius: 15.310 cm
C    Vessel internal height: 107.0 cm
C    Vessel side wall thickness: 0.25 cm
C    Solution height:   29.89 cm
...
C --------
C
01 CZ   15.310   $ Vessel internal radius 
02 PZ   107.0    $ Vessel internal height
03 CZ   15.56    $ Vessel outer radius (internal radius + wall thickness)
04 PZ   29.89    $ Height of solution
05 CZ   20.56    $ Flange radius (outer radius + 5 cm)
06 CZ   15.110   $ Inner radius of poly plug (inner radius - 0.2 cm)
07 PZ   30.207   $ Top of SS on poly plug (solution height + .317)
08 PZ   45.207   $ Top of poly plug (solution height + 15.317)
C
