Leu-Comp-Therm-006.1, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 1, N=19, pitch=1.849):
 101   px  -47.5655  $(s102-30.0), model boundary
 102   px  -17.5655  $(-N*pitch/2), start lattice
 103   px   17.5655  $( N*pitch/2),   end lattice
 104   px   47.5655  $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -47.5655  $(s152-30.0), model boundary
 152   py  -17.5655  $(-N*pitch/2), start lattice
 153   py   17.5655  $( N*pitch/2),   end latticeh)
 154   py   47.5655  $(s153+30.0), model boundary
c
