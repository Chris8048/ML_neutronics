Leu-Comp-Therm-006.15, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 15, N=16, pitch=2.293):
 101   px  -48.344   $(s102-30.0), model boundary
 102   px  -18.344   $(-N*pitch/2), start lattice
 103   px   18.344   $( N*pitch/2),   end lattice
 104   px   48.344   $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -48.344   $(s152-30.0), model boundary
 152   py  -18.344   $(-N*pitch/2), start lattice
 153   py   18.344   $( N*pitch/2),   end latticeh)
 154   py   48.344   $(s153+30.0), model boundary
c
