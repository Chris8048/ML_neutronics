Leu-Sol-Therm-004.2 (run 29), rev1, 9/30/2000.
c
c  Benchmark model keff is 0.9999(9).
c
c  This deck is case 2 (run 29).
c
c  Cell specifications:
c
 1   1 9.86160319e-2   -7 +6  -1        $solution
...
c
c    For m1:
c     - natN may be converted to 14,15N                    (2.8141e-3)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.7850e-2)
c     - lwtr.20t is ENDF71SaB kernel
 m1  92234.80c 5.9778e-7  92235.80c 7.4181e-5  92236.80c 7.4088e-8  $234,235,236U
     92238.80c 6.6074e-4                                            $238U
      7014.80c 2.8037e-3   7015.80c 1.0356e-5                       $14,15N
      8016.80c 3.7836e-2   8017.80c 1.4383e-5                       $16,17O
      1001.80c 5.7216e-2                                            $H
 mt1  lwtr.20t                                                      $kernel
c
c    For m2:
