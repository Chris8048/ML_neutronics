Leu-Comp-Therm-007.2, rev3, 9/30/2006.
c
...
c   - This deck created using lct27.1, then lct7.1 as a template.
c
c
c Cell cards:
c
    1  0                 -105 +104  -155 +154  -209 +203  
                         fill=11(-12.80 -13.60 +20.00)   $core
c
...
c 21   pz    0.00  $ local z-origin/start conical bottom plug
  ...
  30   pz   75.33  $ (s25+Hc),    water height
...
c cone centered in the unit cell, starting at z=s21 and is 0.8 cm tall.
  48   trc   0.80 0.80 0.00  0.00 0.00 0.80  0.00 0.47  $conical bottom plug
c
c cylinders within the unit cell:
c
  51   c/z  0.800 0.800 0.3946 $fuel OR
  52   c/z  0.800 0.800 0.410  $clad IR
  53   c/z  0.800 0.800 0.470  $clad OR
  54   c/z  0.800 0.800 0.500  $grid hole radius
c
c
c - global x coordinates:
 ...
 104   px  -12.80  $left  array boundary
 105   px   12.80  $right array boundary
...
c - global y coordinates:
 ...
 154   py  -13.60  $left  array boundary
 155   py   13.60  $right array boundary
...
c   (Water height, s206, is 20.00 cm greater than specified on s30).
 ...
 206   pz   95.33  $water height           (s203+1.8+Hc)
