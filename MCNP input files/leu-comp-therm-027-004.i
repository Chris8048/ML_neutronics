Leu-Comp-Therm-027.4, rev1, 9/30/2000.
c
...
c     - MCNP warning messages about these conditions are
c       normal and can be ignored.
c
c
c Cell cards:
c
...
c
c - LCT7 (rev3, 9/30/2006) model approximation.  The bottom plug is 1.8 cm
c   long, consisting of a 1.0 cm long cylindrical piece plus a 0.8 cm long
c   conical piece.  In LCT7, the conical piece is squared off so that the
c   0.8 section consists of a full diameter by 0.27 cm tall plug plus 0.53 cm
c   of water.  This approximation is used here even though it is not specified
c   in the rev1 (9/30/2000) LCT27 evaluation.  There is no additional keff
c   bias associated with this approximation.
c
...
c
  ...
  114  2  6.02034930e-2   -53 ((+52  -33 +25):
                               (     -34 +33):
                               (     -25 +24))   u=11  $clad & plugs
  116  3  1.00062675e-1   +53 ((     -26 +25):
                               (-54  -27 +26):
                               (     -29 +27))   u=11  $unit cell water
  119  5  1.00062675e-1             (-24 +23):         $water below squared off rod
                         (+53        -25 +24)    u=11  $water beyond squared off rod
...
c
  ...
  134  2  6.02034930e-2   -53 ((+52  -33 +25):
                               (     -34 +33):
                               (     -25 +24))   u=12  $clad & plugs
  136  3  1.00062675e-1   +53 ((     -26 +25):
                               (-54  -27 +26):
                               (     -28 +27):
                               (+55  -29 +28))   u=12  $unit cell water
  139  5  1.00062675e-1             (-24 +23):         $water below squared off rod
                         (+53        -25 +24)    u=12  $water beyond squared off rod
...
c
  ...
  154  2  6.02034930e-2   -53 ((+52  -33 +25):
                               (     -34 +33):
                               (     -25 +24))   u=13  $clad & plugs
  156  3  1.00062675e-1  (+53 ((     -26 +25):
                               (-54  -27 +26):
                               (     -29 +27)))
                          +41 +42                u=13  $unit cell water
  159  5  1.00062675e-1 (           (-24 +23):         $water below squared off rod
                         (+53        -25 +24))
                          +41 +42                u=13  $water beyond squared off rod
...
c
  ...
  174  2  6.02034930e-2   -53 ((+52  -33 +25):
                               (     -34 +33):
                               (     -25 +24))   u=14  $clad & plugs
  176  3  1.00062675e-1  (+53 ((     -26 +25):
                               (-54  -27 +26):
                               (     -29 +27)))
                         (+43:+42)               u=14  $unit cell water
  179  5  1.00062675e-1 (           (-24 +23):         $water below squared off rod
                         (+53        -25 +24))
                         (+43:+42)               u=14  $water beyond squared off rod
...
c
  ...
  194  2  6.02034930e-2   -53 ((+52  -33 +25):
                               (     -34 +33):
                               (     -25 +24))   u=15  $clad & plugs
  196  3  1.00062675e-1  (+53 ((     -26 +25):
                               (-54  -27 +26):
                               (     -29 +27)))
                         (+41:+44)               u=15  $unit cell water
  199  5  1.00062675e-1 (           (-24 +23):         $water below squared off rod
                         (+53        -25 +24))
                         (+41:+44)               u=15  $water beyond squared off rod
...
c - Lead reflecting wall (Figure 9):
  801  8  3.25230420e-2   ((-205 +203) ((-112 +111  -162 +161):   $bottom, left Pb
                                        (-113 +112  -164 +163):   $bottom, right Pb
                                        (-114 +115  -165 +164):   $top, right Pb
                                        (-115 +116  -166 +162)))  $top, left Pb
c
c
...
c
c - Lower axial water
  912  5  1.00062675e-1  -104 +101  -154 +151  -202 +201          $
  913  5  1.00062675e-1  -301                  -203 +202
c
c - Support plate
  914  6  8.50719000e-2  -104 +101  -154 +151  -203 +202  +301    $
c
c - Radial air (beyond lead walls, to model boundary)
  915  0                  ((-205 +204) ((-112 +101  -161 +151):
                                        (-113 +112  -163 +151):
                                        (-104 +113  -164 +151):
                                        (-104 +114  -165 +164):
                                        (-104 +115  -154 +165):
                                        ...
                                        (-111 +101  -162 +161)))
c
c - Upper axial air (ex-core)
  916  0                  ((-206 +205) (-104 +101  -154 +151)
                                       (-102:+103 : -152:+153))
c
...
c 21   pz    0.00  $ local z-origin
  ...
  23   pz    1.40  $ (s22+0.4),    end bottom plate/start conical plug
  24   pz    1.93  $ (s23+0.53), start squared-off plug
  ...
  29   pz   84.43  $ (Hc + s25 = 78.33, 75.07, 76.19 or 84.43)
  ...
  34   pz  101.40  $ (s33+1.3),    end top plug
  35   pz  106.60  $ (s36-0.4),  start top plate
c 36   pz  107.00  $ (s21+107.),   end top plate/top of unit cell
  41   px    0.20  $ corner brace plane
  42   py    0.20  $ corner brace plane
  43   px    0.40  $ corner brace plane
  44   py    0.40  $ corner brace plane
c
...
c   1, 2, 3 & 4.  Some surfaces (112 & 115, for case 1) are redundant.
 ...
 111   px  -47.30  $bottom, left  lead (s103+e-60.0)
 112   px   12.70  $                   (s111  +60.0)
 113   px   42.70  $bottom, right lead (s112  +30.0)
 114   px   47.30  $   top, right lead (s102-e+60.0)
 115   px  -12.70  $                   (s114  -60.0)
 116   px  -42.70  $   top,  left lead (s115  -30.0)
c
...
c   1, 2, 3 & 4.  Some surfaces (162 & 164, for case 1) are redundant.
 ...
 161   py  -42.70  $bottom, left  lead (s152-e-30.0)
 162   py  -12.70  $                   (s161  +30.0)
 163   py  -47.30  $bottom, right lead (s153+e-60.0)
 164   py   12.70  $                   (s163  +60.0)
 165   py   42.70  $   top, right lead (s164  +30.0)
 166   py   47.30  $   top,  left lead (s162  +60.0)
c
...
c   per Table 1:  Hc = 75.13, 71.87, 72.99 & 81.23 for cases 1, 2, 3 & 4.
 ...
 204   pz  103.43  $water height (Hc + 3.2 + s203 = 97.33, 94.07, 95.19, 103.43)
...
c
 mode n
 imp:n 1 55r 0             $case 1 is 1 53r 0; cases 2, 3 &4 are 1 55r 0
 totnu
