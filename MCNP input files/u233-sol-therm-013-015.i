...
c Cell cards:
c
  1   1 9.98408940e-2  -1 -4  $partially filled sphere
...
c
  ...
  4   pz  10.9607  $Solution height ([H] - [R])
c ------------------------------------------------------------------------------
...
c
c
c    For m1 (9.98408940e-2):
c     - natN may be converted to 14,15N                    (5.9393e-4)
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.4503e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab.
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
 m1   92232.80c 1.6688e-9   92233.80c 2.5050e-4   92234.80c 2.6774e-6
      92235.80c 6.6204e-8   92236.80c 2.5355e-9   92238.80c 3.4845e-6  $U
       1001.80c 6.4484e-2                                              $H
       7014.80c 5.91744e-4   7015.80c 2.18566e-6                       $N
       8016.80c 3.44899e-2   8017.80c 1.31111e-5                       $O
      90232.80c 3.2209e-6                                              $Th
  mt1  lwtr.20t                                                        $h-h2o
c
