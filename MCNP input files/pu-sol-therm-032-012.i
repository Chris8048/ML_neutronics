PU-SOL-THERM-032.12, rev0, 9/30/2005, 9.95a% Pu240, 23.95 g Pu/l
c
c  Annular volume is air (cases 1-12) or water (cases 13-17).
c
c  Benchmark keff is 1.0000(19) for all cases.
c
c  This deck is case 12 (detailed, i.e., slanted bottom, model).
c
  1     1  1.00291373e-1  -3 +2  -14 +13                  $Solution
c
...
c 13     pz    0.0                $Start solution (flat tank bottom)
 14     pz   72.3                $  End solution (ICSBEP Hc - 0.1)
...
c
c
c    For m1 (1.00291373e-1): solution
c     - natN  may be converted to isoN  (1.4171e-3)
c     - natO  may be converted to isoO  (3.5380e-2)  (16+18O = 16O)
c     - natFe may be converted to isoFe (5.1220e-7)
c     - lwtr.20t is ENDF71SaB kernel
c     - lwtr.10t is from endf70sab
c     - hh2o.20t is Bob MacFarlane's new continuous energy kernel
 m1     94238.80c 3.0294e-8  94239.80c 5.3468e-5  94240.80c 5.9842e-6
        94241.80c 7.6585e-7  94242.80c 5.3626e-8                       $Pu
         1001.80c 6.3433e-2                                            $H
         7014.80c 1.4119e-3   7015.80c 5.2149e-6                       $isoN
         8016.80c 3.5367e-2   8017.80c 1.3444e-5                       $isoO
        26054.80c 2.9938e-8  26056.80c 4.6996e-7  26057.80c 1.0854e-8
        26058.80c 1.4444e-9                                            $isoFe
 mt1     lwtr.20t                                                      $S(a,b)
c
