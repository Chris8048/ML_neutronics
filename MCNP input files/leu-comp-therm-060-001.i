LCT60-N1-RBMK-DET - UNIFORM FLOODED CASE, 1.8% ENRICHED FUEL
c
c *** ack mods:
...
c    -- CELL CARDS --
c    FUEL PIN
1     1  6.74057901e-2 -1 -6 7 imp:n=1 u=1 $ fuel
...
57   13  1.22221282e-2  12 -17 -29 23 u=7 imp:n=1  $ bot of top coupling element above water
58   13  1.22221282e-2  17 -3 23 -84 u=7 imp:n=1  $ top of top coupling element
...
78    4  8.42866231e-2  37 31  u=7 imp:n=1 $ graphite
...
89   20  8.45876253e-2  37 31  imp:n=1  u=12 $ graphite
c
...
90    0 -32 33 -34 35 imp:n=1 lat=1 u=15 fill=0:17 0:17 0:0
             ...
             12 12 12 12 12 12 12  7  7  7  7  7 12 12 12 12 12 12
             12 12 12 12 12 12 12  7  7  7  7  7 12 12 12 12 12 12
             12 12 12 12 11 12 12 12 12  7  7  7 12 12 56 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
             12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12 12
...
313  20  8.45876253e-2  37 31  imp:n=1  u=56 $ graphite
c
...
326  20  8.45876253e-2  37 31  imp:n=1  u=11 $ graphite
...
3   pz  368.0    $ top of top coupling element (not yet changed)
4   pz  363.6    $ middle of top cap of fuel pin
...
c   -- DATA CARDS --
c    Material 1 - fuel U(1.8)O2 (Table 17), N=6.74057901e-2
c    - data are case dependent
c      - natO  converted to 16,17O (where 16 = 16+18) (4.5456e-2)
c      - natSi may be converted to isoSi              (1.6945e-6)
c      - natCr may be converted to isoCr              (8.0087e-7)
c      - natFe may be converted to isoFe              (6.3912e-6)
c      - natNi may be converted to isoNi              (2.0272e-7)
 m1  92234.80c 3.0787e-6   92235.80c 3.9771e-4   92236.80c 1.4111e-6   $  
     92238.80c 2.1535e-2                                               $
      8016.80c 4.54387e-2   8017.80c 1.72733e-5                        $isoO
     13027.80c 3.5277e-6                                               $Al
     14028.80c 1.56283e-6  14029.80c 7.93568e-8  14030.80c 5.23126e-8  $isoSi
     24050.80c 3.47978e-8  24052.80c 6.71041e-7  24053.80c 7.60907e-8  $
     24054.80c 1.89406e-8                                              $isoCr
     26054.80c 3.73566e-7  26056.80c 5.86418e-6  26057.80c 1.35430e-7  $
     26058.80c 1.80232e-8                                              $isoFe
     28058.80c 1.38005e-7  28060.80c 5.31595e-8  28061.80c 2.31081e-9  $
     28062.80c 7.36786e-9  28064.80c 1.87638e-9                        $isoNi
c
...
c    N(core) = 8.42866231e-2
c    - data are case dependent
c      - natMg may be converted to isoMg (2.5408e-7)
c      - natSi may be converted to isoSi (1.8023e-7)
c      - natFe may be converted to isoFe (3.8068e-8)
c      - natCu may be converted to isoCu (1.1152e-8)
c      - natCd may be converted to isoCd (1.3329e-9)
c      - grph.20t is ENDF71SaB kernel
 mt4  grph.20t
 m4   6000.80c 8.4286e-2                                               $natC
      5010.80c 5.2737e-9    5011.80c 2.1227e-8                         $10,11B
     12024.80c 2.00698e-7  12025.80c 2.54080e-8  12026.80c 2.79742e-8  $isoMg
     13027.80c 1.0881e-7                                               $Al
     14028.80c 1.66226e-7  14029.80c 8.44053e-9  14030.80c 5.56406e-9  $isoSi
     25055.80c 2.9116e-9                                               $Mn
     26054.80c 2.22507e-9  26056.80c 3.49289e-8  26057.80c 8.06661e-10 $
     26058.80c 1.07352e-10                                             $isoFe
     29063.80c 7.71384e-9  29065.80c 3.43861e-9                        $isoCu
     48106.80c 1.66613e-11 48108.80c 1.18628e-11 48110.80c 1.66479e-10 $
     48111.80c 1.70611e-10 48112.80c 3.21629e-10 48113.80c 1.62880e-10 $
     48114.80c 3.82942e-10 48116.80c 9.98342e-11                       $isoCd
c
...
c      homogenized with   air:  N = 1.66327279e-6
...
c    0.46 times nominal impurities, homogenized with gaps
c    N(refl) = 8.45876253e-2
c    - data are case dependent
c      - natMg may be converted to isoMg (2.5499e-7)
c      - natSi may be converted to isoSi (1.8088e-7)
c      - natFe may be converted to isoFe (3.8204e-8)
c      - natCu may be converted to isoCu (1.1192e-8)
c      - natCd may be converted to isoCd (1.3377e-9)
c      - grph.20t is ENDF71SaB kernel
 mt20 grph.20t
 m20  6000.80c 8.4587e-2                                               $natC
      5010.80c 5.2926e-9    5011.80c 2.1303e-8                         $10,11B
     12024.80c 2.01417e-7  12025.80c 2.54990e-8  12026.80c 2.80744e-8  $isoMg
     13027.80c 1.0920e-7                                               $Al
     14028.80c 1.66825e-7  14029.80c 8.47097e-9  14030.80c 5.58413e-9  $isoSi
     25055.80c 2.9220e-9                                               $Mn
     26054.80c 2.23302e-9  26056.80c 3.50537e-8  26057.80c 8.09543e-10 $
     26058.80c 1.07735e-10                                             $isoFe
