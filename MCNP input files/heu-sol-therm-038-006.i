...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 6 is POLY-2 above Tank #2
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top poly-2
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83   9 1.17271000e-1                    -96 +6   -95 $poly-2 plate
  84   0                 -12 +11 -14 +13  -96 +6   +95 $void
c
c     - case 6 is SS above Tank #1
  91  17 8.66362741e-2                    -99 +74  -98 $ss
...
c     the relative spacings do not change.
  71  pz   55.46217  $(s96+3.08102), bottom of Tank #1
  72  pz   56.43016  $(s71+0.96799), Tank #1 bottom plate
  73  pz   65.33083  $(s72+8.90067), Tank #1 internal height
  74  pz   66.29222  $(s73+0.96139), top of Tank #1
  81  pz   56.13222  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   63.75222  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   53.59222  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for POLY-2 (above Tank #2)
  95  cz   34.29508  $(68.59016/2), poly-2 plate radius
  96  pz   52.38115  $(s6+4.70916), top of poly-2 plate
c
c   - radius and height for SS (above Tank #1)
  98  cz   38.09619  $(76.19238/2), ss radius
  99  pz   66.92976  $(s74+0.63754), top of ss
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   66.92976  $extra z-plane for possible upper reflector/top of model
