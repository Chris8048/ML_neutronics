...
c
c     - case 7 is POLY-2 above Tank #1
...
c     the relative spacings do not change.
  71  pz   61.13399  $(s96+12.23772), bottom of Tank #1
  72  pz   62.10198  $(s71+0.96799), Tank #1 bottom plate
  73  pz   71.00265  $(s72+8.90067), Tank #1 internal height
  74  pz   71.96404  $(s73+0.96139), top of Tank #1
  81  pz   61.80404  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   69.42404  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   59.26404  $(s82-10.16),                  bottom of support bars E & F
c
...
c   - radius and height for POLY-2 (above Tank #1)
  ...
  99  pz   76.67320  $(s74+4.70916), top of poly-2
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   76.67320  $extra z-plane for possible upper reflector/top of model
