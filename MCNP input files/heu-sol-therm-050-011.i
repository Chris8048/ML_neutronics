HST050.11, 9/30/2005 (Rev. 0)
c
c  Heu-Sol-Therm-050 case 11 (cylindrical, bare homogenous solution).
c  Benchmark model keff is 0.9964(89).
c
c   Cell cards
c
 1   1 9.96934552e-2   -7 +6  -1           $solution
...
c   Surface cards
c
 1   cz   25.3238  $solution radius
 2   cz   25.4     $heresite liner radius
 3   cz   25.55875 $container outer radius
 4   pz   -1.3462  $container bottom
 5   pz   -0.0762  $heresite liner
 6   pz    0.00    $solution bottom
 7   pz   14.8     $solution (and tank) height
...
c     m3   = 2S aluminum
c
c    For m1 (9.96934552e-2):
c     - natO may be converted to 16,17O (where 16 = 16+18) (3.3540e-2)
c     - lwtr.20t is ENDF71SaB kernel
c     - hh2o.20t is rem continuous kernel 
   m1 92234.80c 1.0606e-5   92235.80c 8.6343e-4   92238.80c 5.1774e-5  $HEU
       1001.80c 6.3376e-2                                              $H
       8016.80c 3.35273e-2   8017.80c 1.27452e-5                       $16,17O
       9019.80c 1.8516e-3                                              $19F
  mt1  lwtr.20t
c
