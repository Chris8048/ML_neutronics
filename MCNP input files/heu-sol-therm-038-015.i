...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 15 is three boraflex plates above Tank #2, then void to Tank #1
  81   0                 -12 +11 -14 +13  -83 +96 $bottom E,F to top boraflex plate
  82   0                 -61 +60 -14 +13  -71 +83 $bottom tank #1 to bottom E,F
  83  15 1.05309867e-1                    -96 +6   -95 $boraflex, 3-plates
...
c     the relative spacings do not change.
  71  pz   50.97653  $(s96+2.67970), bottom of Tank #1
  72  pz   51.94452  $(s71+0.96799), Tank #1 bottom plate
  73  pz   60.84519  $(s72+8.90067), Tank #1 internal height
  74  pz   61.80658  $(s73+0.96139), top of Tank #1
  81  pz   51.64658  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   59.26658  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   49.10658  $(s82-10.16),                  bottom of support bars E & F
c
c   - radius and height for three boraflex plates (above Tank #2)
  95  cz   35.13836  $(70.27672/2), boraflex plate radius
  96  pz   48.29683  $(s6+3*0.20828), top of three boraflex plates
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   61.80658  $extra z-plane for possible upper reflector/top of model
