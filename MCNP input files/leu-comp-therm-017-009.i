Leu-Comp-Therm-017.9, rev1, 9/30/1998.
c
...
c   center of center cluster is x=0.
  101   px  -96.232  $left   model boundary (s102 - 30.5)
  102   px  -65.732  $left   cluster, left  boundary (s103 - 19*2.032)
  103   px  -27.124  $left   cluster, right boundary (s104 - 7.82)
  104   px  -19.304  $center cluster, left  boundary (-0.5*19*2.032)
  105   px   19.304  $center cluster, right boundary ( 0.5*19*2.032)
  106   px   27.124  $right  cluster, left  boundary (s105 + 7.82)
  107   px   65.732  $right  cluster, right boundary (s106 + 19*2.032)
  108   px   96.232  $right  model boundary (s107 + 30.5)
...
c   surfaces 152 and 153, respectively.
  161   py  -34.582  $s162 - [10.2(lead), 7.65(deplU) or 17.85(steel)]
  162   py  -26.932  $s152 - 10.676 cm separation
  163   py   26.932  $
  164   py   34.582  $
c
