...
c Cell cards:
c
  1   1 9.92411506e-2  (-3  +2  -1) :                $soln in primary cylinder
...
c -- primary solution & cylinder
  1    cz   12.719   $Primary solution radius
  2    pz  257.35925 $Bottom of solution in primary cylinder (s24 + 48.26 + "e")
  3    pz  282.01025 $   Top of solution in primary cylinder (s2  + 24.651)
  4    cz   12.846   $Primary cylinder OR (s1 + 0.127)
  ...
  8    cz   15.24    $Primary cylinder top cap
c
c -- fill tube cylinder
 11   c/z    9.82975 0.00 2.62509  $Fill tube IR
 12   c/z    9.82975 0.00 3.01625  $Fill tube OR
c
...
c     - hh2o.20t is MacFarlane continuous energy h-h2o kernel.
   m1                       92233.80c 5.1416e-4   92234.80c 5.4954e-6
      92235.80c 1.3588e-7   92236.80c 5.2040e-9   92238.80c 7.1522e-6  $U
       1001.80c 6.2102e-2                                              $H
       7014.80c 1.12744e-3   7015.80c 4.16429e-6                       $N
       8016.80c 3.54605e-2   8017.80c 1.34801e-5                       $O
      90232.80c 6.6175e-6                                              $Th
c
