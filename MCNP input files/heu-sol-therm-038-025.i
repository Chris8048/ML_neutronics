...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 25 is BP-2 above Tank #2
...
c
c     - case 25 is lead above Tank #1
  91  19 3.34960040e-2                    -99 +74  -98 $lead plate
...
c     the relative spacings do not change.
  71  pz   53.97881  $(s96+5.08254), bottom of Tank #1
  72  pz   54.94680  $(s71+0.96799), Tank #1 bottom plate
  73  pz   63.84747  $(s72+8.90067), Tank #1 internal height
  74  pz   64.80886  $(s73+0.96139), top of Tank #1
  81  pz   54.64886  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   62.26886  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   52.10886  $(s82-10.16),                  bottom of support bars E & F
c
...
c
c   - radius and height for Lead (above Tank #1)
  98  cz   36.36518  $(72.73036/2), lead radius
  99  pz   65.12636  $(s74+0.31750), top of lead
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   65.12636  $extra z-plane for possible upper reflector/top of model
