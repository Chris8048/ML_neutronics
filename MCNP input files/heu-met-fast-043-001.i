...
c          99: outside world
c
  1    1  4.76667947e-2  -4    ((-26 +25):
                                (-25 +21 +2):
                                (-52 +53 +1):
                                (-53 +54))            $HEU (two zones)
  2    7  8.42090692e-2  -4    ((-27 +26):(-54 +55))  $axial reflector
c
...
c
 ...
 27    pz   5.965  $(s26+0.99),      top upper zone axial reflector (case 1)
c
 51    pz  -0.60   $(s21-0.6), top support ring thickness
 52    pz  -0.63   $(s21-0.63), Hcr
 53    pz  -1.630  $(s52-1.000),  first lower zone HEU
 54    pz  -6.600  $(s52-5.970), bottom lower zone HEU
 55    pz  -7.590  $(s54-0.99),  bottom lower zone axial reflector (case 1)
c
...
c
c    For m1: (HEU, case 1, 4.76667947e-2)
c     - natFe may be converted to isoFe (1.8029e-5)
c     - natW  may be converted to isoW  (9.1275e-7)
 m1   92234.80c 5.6394e-4  92235.80c 4.5675e-2  92238.80c 1.3344e-3  $U
       6000.80c 7.4513e-5                                            $C
      26054.80c 1.05380e-6 26056.80c 1.65423e-5 26057.80c 3.82035e-7
      26058.80c 5.08418e-8                                           $isoFe
      74180.80c 1.09530e-9
      74182.80c 2.41879e-7 74183.80c 1.30615e-7 74184.80c 2.79667e-7
      74186.80c 2.59495e-7                                           $isoW
c
c    For m7: (St10, axial reflector, case 1, 8.42090692e-2)
c     - natSi may be converted to isoSi (4.4913e-4)
c     - natCr may be converted to isoCr (6.7387e-5)
c     - natFe may be converted to isoFe (8.2859e-2)
 m7    6000.80c 4.0841e-4                                            $C
      14028.80c 4.14231e-4 14029.80c 2.10337e-5 14030.80c 1.38655e-5 $isoSi
      24050.80c 2.92797e-6 24052.80c 5.64629e-5 24053.80c 6.40244e-6
      24054.80c 1.59370e-6                                           $isoCr
      25055.80c 4.2519e-4                                            $Mn
      26054.80c 4.84311e-3 26056.80c 7.60264e-2 26057.80c 1.75578e-3
      26058.80c 2.33662e-4                                           $isoFe
c
