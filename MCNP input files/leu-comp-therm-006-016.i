Leu-Comp-Therm-006.16, rev1, 9/30/1998.
c
...
c
c
c - global x coordinates (Case 16, N=17, pitch=2.293):
 101   px  -49.4905  $(s102-30.0), model boundary
 102   px  -19.4905  $(-N*pitch/2), start lattice
 103   px   19.4905  $( N*pitch/2),   end lattice
 104   px   49.4905  $(s103+30.0), model boundary
c
c - global y coordinates:
 151   py  -49.4905  $(s152-30.0), model boundary
 152   py  -19.4905  $(-N*pitch/2), start lattice
 153   py   19.4905  $( N*pitch/2),   end latticeh)
 154   py   49.4905  $(s153+30.0), model boundary
c
