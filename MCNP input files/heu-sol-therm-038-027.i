...
c
  ...
  36   0                      +43  -81 +71
                          -61 +60  -14 +13    $
c
c     - case 27 is BP-2 above Tank #2
...
c
c     - case 27 is deplU plates above Tank #1
  91  21 4.81920000e-2  (((-102 +101) (-113 +112)):
                         ((-104 +103) (-112 +111))) (-99 +74)     $deplU plates
...
c     the relative spacings do not change.
  71  pz   54.30393  $(s96+5.40766), bottom of Tank #1
  72  pz   55.27192  $(s71+0.96799), Tank #1 bottom plate
  73  pz   64.17259  $(s72+8.90067), Tank #1 internal height
  74  pz   65.13398  $(s73+0.96139), top of Tank #1
  81  pz   54.97398  $(s71+0.67005), bottom of side plates A,B,C,D; top of E & F
  82  pz   62.59398  $(s81+7.62),       top of side plates A,B,C,D
  83  pz   52.43398  $(s82-10.16),                  bottom of support bars E & F
c
...
c
c   - x,y,z planes for deplU (above Tank #1)
  99  pz   65.44640  $(s74+0.31242), top of deplU (both plates)
 101  px  -36.82365  $(-73.6473/2)
 102  px   36.82365  $(+73.6473/2)
 103  px  -36.91890  $(-73.8378/2)
 104  px   36.91890  $(+73.8378/2)
 111  py  -36.91001  $(-36.91001)
 112  py    0.000    $( 0.0)
 113  py   36.67506  $(+36.67506)
c
...
c     reflector is present, or top of uppermost reflector.
 999  pz   65.44640  $extra z-plane for possible upper reflector/top of model
