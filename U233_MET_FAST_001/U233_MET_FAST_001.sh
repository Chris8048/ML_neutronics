#!/bin/bash
# Job name:
#SBATCH --job-name=U233-MET-FAST-001
#
#SBATCH --output=outputU233-MET-FAST-001
#
#SBATCH --error=ERRORS
#
# Account:
...
cd /global/home/users/christforsyth/ML_neutronics/U233-MET-FAST-001
sss2 U233-MET-FAST-001 -omp 20