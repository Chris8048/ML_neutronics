#!/bin/bash
# Job name:
#SBATCH --job-name=HEU_MET_FAST_067_001
#
#SBATCH --output=outputHEU_MET_FAST_067_001
#
#SBATCH --error=ERRORS
#
# Account:
...
cd /global/home/users/christforsyth/ML_neutronics/HEU_MET_FAST_067/HEU_MET_FAST_067_001/jeff33_scattering
